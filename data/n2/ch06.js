  ...
  parts: [
    {
      ...
      points: [
          ...
          practice: [
            {
              ...
              items: [
                {
                  q: "けがをして入院したばかりに、（　）。",
                  options: ["{親友|しんゆう}の{結婚式|けっこんしき}に出られなかった", "{治療|ちりょう}を受けて元気になった"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["すぐうちへ帰った", "たくさん{売|う}れ{残|のこ}ってしまった"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["仕事がしにくい", "{仲|なか}よくしてほしいものだ"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["{退場|たいじょう}させられてしまった", "{審判|しんぱん}に{謝|あやま}ってしまった"],
                  answer: 0,
        ...
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜ことはない」は、「〜する{必要|ひつよう}はない・〜しなくてもいい」と言いたいときに使う。アドバイスに使うことが多い。", en: "Use \"〜ことはない\" when you want to say \"there's no need to do 〜; you don't have to do 〜\". It is often used to give advice." },
          ...
          practice: [
            {
              ...
              left: ["今回のけがはそんなに{心配|しんぱい}することはありませんよ。", "インターネットで会議をすれば出張することはないだろう。", "わざわざノートを貸してあげることはないよ。", "{遊園地|ゆうえんち}にお{弁当|べんとう}を持っていくことはないんじゃない？"],
              right: ["{売店|ばいてん}で何でも売っているんだから。", "サボって遊びに行ったんだから、自分で調べればいいんだよ。", "ただのねんざで、{骨|ほね}は{折|お}れていませんから。", "そうすれば、時間も{経費|けいひ}も{節約|せつやく}できるよ。"],
              answer: [2, 3, 1, 0],
              en: ["There's no need to worry so much about this injury. It's just a sprain; no bones are broken.", "If we hold the meeting over the internet, there'll probably be no need to go on a business trip. That way we can save both time and expenses.", "There's no need to go out of your way to lend him your notes. He skipped class to go have fun, so he should look it up himself.", "Surely there's no need to take a packed lunch to the amusement park? They sell everything at the kiosks there."],
            },
          ],
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜に{比|くら}べて」は、「〜より」と同じ意味で、2つ以上のものを{比較|ひかく}し、{程度|ていど}の違いを言いたいときに使う。", en: "Use \"〜に{比|くら}べて\" when you want to compare two or more things and say how much they differ. It has the same meaning as \"〜より\"." },
          forms: ["[N] + に{比|くら}べて"],
          examples: [
              ...
              items: [
                {
                  ...
                  options: ["お父さんの言うことなんか、聞くもんか", "どんなにくやしくたって、泣くものかっていう気持ちはないのかね", "{経験|けいけん}のないお前にわかるものか"],
                  answer: 2,
      ...
      points: [
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜ばこそ」は、「〜からこそ」と同じように、「〜だから」という意味で、その理由を強く言いたいときに使う。", en: "Use \"〜ばこそ\" just like \"〜からこそ\" when you want to strongly state a reason to say \"because 〜\"." },
        ...
        },
        {
          ...
          examples: [
            ...
            { ja: "{注射|ちゅうしゃ}だから痛くないことはないでしょうけど、{看護師|かんごし}さんによって痛さが{全然|ぜんぜん}違うんですよ。", en: "It's an injection, so I suppose it can't be completely painless, but how much it hurts depends completely on the nurse." },
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["早く相手を見つけたいですね", "今は仕事に集中したいですね"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["もうちょっと後でもいいよ", "たくさん食べたいよ"],
                  answer: 0,
          ...
          practice: [
            {
              ...
              left: ["A：パン、5つも買ったの？\nB：（　）。", "A：6時なのに、帰らないの？\nB：（　）。", "A：なんでメールしたのに返事くれなかったの？\nB：（　）。", "A：インフルエンザ、{流行|はや}ってるね。\nB：（　）。"],
              right: ["だって{全然|ぜんぜん}気がつかなかったんだもん", "私は大丈夫、{予防|よぼう}{注射|ちゅうしゃ}したもん", "この仕事、{課長|かちょう}に今日中にって{頼|たの}まれちゃったんだもん", "だって{腹|はら}{減|へ}ってるんだもん"],
              answer: [3, 2, 0, 1],
              en: ["A: You bought five pieces of bread?\nB: Well, I'm starving.", "A: It's six o'clock — aren't you going home?\nB: The section chief asked me to get this job done today.", "A: Why didn't you reply even though I sent you an email?\nB: But I didn't notice it at all.", "A: The flu is going around, isn't it?\nB: I'm fine — I got a flu shot."],
            },
          ],
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「休むわけにはいかない」のように、「理由があってできない」と言いたいときに使う。また、「働かないわけにはいかない」のように、「しなければならない」と言いたいときにも使う。", en: "Use this when you want to say \"there's a reason I can't\" as in \"休むわけにはいかない\". In addition, you can also use it when you want to say \"I have to\" as in \"働かないわけにはいかない\"." },
          ...
          practice: [
            {
              ...
              labels: "abc",
              prompt: { ja: "", en: "Match each beginning (1–4) with the correct ending (a–d)." },
              left: ["{遊園地|ゆうえんち}に行ったら、", "専門学校のファッションショーのとき先生に、", "練習のときは試合のつもりで{気合|きあい}を入れて、", "妹はテレビを見ながら、"],
              right: ["人気歌手になったつもりで歌いながら{踊|おど}っている。", "モデルになったつもりで、{胸|むね}を{張|は}って歩きましょうと言われた。", "子どもに{戻|もど}ったつもりで楽しんだほうがいいよ。", "試合のときは練習のつもりでリラックスしていこう！"],
              answer: [2, 1, 3, 0],
              en: ["When you go to an amusement park, you should enjoy yourself as if you'd become a child again.", "At the vocational school's fashion show, the teacher told us to walk with our chests out, as if we were models.", "In practice, put your all into it as if it were a real match, and in the match, stay relaxed as if it were just practice!", "My little sister is watching TV, singing and dancing as if she were a popular singer."],
            },
          ],
        },
      ],
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            options: ["好きだから", "好きなのに", "好きなだけ", "好きなくらい"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["どころではありません", "わけにはいきません", "おそれがあります", "ことはありません"],
            answer: 3,
          ...
          },
          {
            ...
            options: ["わけではない", "ものではない", "わけにはいかない", "ことはない"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["{応|おう}じて", "つれて", "わたって", "{比|くら}べて"],
            answer: 3,
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          ...
          {
            script: [
              { sp: "F", v: "f", ja: "そんなに笑うことはないでしょう。" },
            ],
            en: ["There's no need to laugh that much, is there?", "But it's sad.", "But it's not funny.", "But you're dressed so weirdly."],
