// Generated by tools/merge.js from data/n2/frag/ch03-*.js — edit the fragments, not this file.
N2.register({
  "id": 3,
  "genre": {
    "ja": "説明を聞く",
  ...
  "parts": [
    {
      ...
      "sample": {
        ...
        "lines": [
          {
            "ja": "今からこのホテルの一員となる皆さんに、ホテルスタッフ**として**の{心構|こころがま}えをお話しします。",
      ...
      "points": [
        {
          ...
          "examples": [
            {
              "ja": "A：来週、出張だって？\nB：うん。シンガポール{支社|ししゃ}に{部長|ぶちょう}の{代理|だいり}として行くことになったんだ。",
              "en": "A: I hear you're going on a business trip next week?\nB: Yeah. It's been decided that I'll go to the Singapore branch on behalf of the department manager."
            },
            {
              ...
              "items": [
                {
                  ...
                  "en": "While researching economics at graduate school as a research student, I teach Thai to Japanese people three times a week as a teacher."
                },
                {
                  "q": "以前は＿＿としてこの店に来ていたが、今は＿＿として働いている。",
                  "answer": [
                    "客",
                    "スタッフ"
                  ],
                  "en": "I used to come to this shop as a customer, but now I work here as a member of staff."
                },
                {
                  "q": "ピアニストになるつもりはないが、ピアノはこれからも＿＿として続けていこうと思っている。",
                  "answer": "{趣味|しゅみ}",
                  "en": "I have no intention of becoming a pianist, but I plan to keep playing the piano as a hobby."
                }
              ]
            }
          ]
        },
        {
          ...
          "formNotes": [
            {
              "ja": "「[なA] な + {限|かぎ}り」が使われることもある。",
              "en": "The form なA + な + 限り is also sometimes used."
            }
          ],
          "examples": [
            {
              "ja": "{高齢者|こうれいしゃ}でも、働ける{限|かぎ}りは働きたいと思っている人が多い。",
              "en": "Even among elderly people, many want to keep working as long as they are able to."
            },
            {
              "ja": "練習のやり方を変えない{限|かぎ}り、{優勝|ゆうしょう}は{無理|むり}だとコーチに言われた。",
              "en": "The coach told us that unless we change the way we practice, winning the championship is impossible."
            },
            {
              "ja": "仕事をしている{限|かぎ}り、{嫌|いや}なことももちろんあるが、そこから{学|まな}ぶことも多い。",
              "en": "As long as you're working, there are of course unpleasant things too, but you also learn a lot from them."
            },
            {
              "ja": "母は「体が{丈夫|じょうぶ}な{限|かぎ}り、一人{暮|ぐ}らしを続ける」と私に言った。",
              "en": "My mother told me, “As long as I'm in good health, I'll go on living on my own.”"
            }
          ],
          "notes": [
            {
              ...
              "examples": [
                ...
                {
                  "ja": "調べた{限|かぎ}りでは、日本語を勉強するにはこの学校がいちばんいい。",
                  "en": "As far as I've been able to find out, this school is the best for studying Japanese."
                },
                {
                  "ja": "{同僚|どうりょう}から聞いた{限|かぎ}りでは、今度の部長は仕事に{厳|きび}しいらしいよ。",
                  "en": "From what I've heard from a colleague, the new department manager is apparently strict about work."
                }
              ]
            }
          ],
          ...
          "practice": [
            {
              ...
              "items": [
                {
                  "q": "すべての{書類|しょるい}が（　）{限|かぎ}り、{申請|しんせい}は受け付けないと{入管|にゅうかん}で言われた。",
                  "options": [
                    "そろう",
                    "そろわない"
                  ],
                  "answer": 1,
                  "en": "I was told at the immigration office that my application would not be accepted unless all the documents were in order."
                },
                {
                  "q": "この店で店長を（　）{限|かぎ}り、{土日|どにち}は休めない。",
                  "options": [
                    "している",
                    "していない"
                  ],
                  "answer": 0,
                  "en": "As long as I'm the manager of this shop, I can't take Saturdays and Sundays off."
                },
                {
                ...
                {
                  "q": "社長が{同意|どうい}（　）{限|かぎ}り、どんな{計画|けいかく}も{実行|じっこう}に{移|うつ}せない。",
                  "options": [
                    "する",
                    "しない"
                  ],
                  "answer": 1,
                  "en": "Unless the president agrees, no plan whatsoever can be put into action."
                }
              ]
            }
          ]
        },
        {
          ...
          "examples": [
            ...
            },
            {
              ...
              "en": "Apparently many people think they have no choice but to obey a transfer order from their company."
            },
            {
              "ja": "日本は{食料|しょくりょう}を{輸入|ゆにゅう}に{頼|たよ}らざるを{得|え}ない{状態|じょうたい}だ。",
              "en": "Japan is in a situation where it has no choice but to rely on imports for its food."
            },
            {
              "ja": "{首相|しゅしょう}の{発言|はつげん}は{国民|こくみん}{感情|かんじょう}を{無視|むし}したものと言わざるを{得|え}ない。",
          ...
          "practice": [
            {
              ...
              "prompt": {
                "ja": "",
                "en": "Match each beginning with the correct ending."
              },
              "left": [
        ...
        },
        {
          ...
          "formNotes": [
            {
              "ja": "「[なA]／[N] + というものではない」の形もある。",
              "en": "The forms なA／N + というものではない also exist."
            }
          ],
          "examples": [
            {
            ...
            },
            {
              ...
              "en": "Burglary can't necessarily be prevented just by locking your door."
            },
            {
              "ja": "日本での{就職|しゅうしょく}には日本語能力試験N1{合格|ごうかく}が{必要|ひつよう}だと思われているが、なければだめだというものでもない。",
              ...
              "items": [
                {
                  ...
                  "answer": 1,
                  "en": "After living for a week at a friend's house deep in the mountains, surrounded by nature, I learned that a convenient, comfortable city life isn't necessarily better."
                },
                {
                  "q": "{昨今|さっこん}の{就職難|しゅうしょくなん}を見ると、{資格|しかく}を取れば、仕事に{就|つ}ける（　）という{気|き}がする。",
                  "options": [
                    "というものではない",
                    "はずだ"
                  ],
                  "answer": 0,
                  "en": "Looking at how hard it is to find a job these days, I feel it's not simply the case that getting a qualification will land you a job."
                },
                {
                  "q": "安くすれば客は来る（　）と思うかもしれませんが、{商品|しょうひん}に{魅力|みりょく}がなければ安くても売れないんです。",
                  "options": [
                    "にちがいない",
                    "というものではない"
                  ],
                  "answer": 0,
                  "en": "You may think customers are sure to come if you lower prices, but if the products aren't appealing, they won't sell even if they're cheap."
                },
                {
        ...
        },
        {
          ...
          "formNotes": [
            {
              "ja": "「～かどうか」「{疑問詞|ぎもんし} + か」「動詞 + か」と一緒に使うこともある。",
              "en": "It is also used with 〜かどうか, a question word + か, or a verb + か."
            }
          ],
          "examples": [
            {
              "ja": "今の仕事は、{給料|きゅうりょう}はともかく、やりがいがあるいい仕事だと思っています。",
              "en": "Salary aside, I think my current job is a good, rewarding one."
            },
            {
              "ja": "この魚、{見|み}た{目|め}はともかく、味は最高ですから、ぜひ食べてみてください。",
              "en": "This fish may not look like much, but the taste is superb, so please do try it."
            },
            {
              "ja": "試合の{結果|けっか}はともかくとして、最後まで{全力|ぜんりょく}で{戦|たたか}うことができたので{満足|まんぞく}だ。",
              "en": "Whatever the result of the match, I was able to fight with everything I had right to the end, so I'm satisfied."
            },
            {
              "ja": "あの映画は内容はともかくとして、{出演者|しゅつえんしゃ}が有名だから{話題|わだい}になっている。",
              "en": "Whatever you think of its content, that film is getting a lot of attention because its cast is famous."
            },
            {
              "ja": "昨日見た{UFO|ユーフォー}{特集|とくしゅう}は本当かどうかはともかく、たいへん{興味深|きょうみぶか}い{番組|ばんぐみ}だった。",
              "en": "Whether or not it was true, the UFO special I watched yesterday was a very interesting program."
            }
          ],
          "deepDive": "**ともかく** (兎も角) is an adverb meaning *anyway / at any rate*. **Xはともかく** = *X aside / leaving X out of the question*: the speaker deliberately puts X on hold and focuses on the second clause. **はともかくとして** is a slightly more formal, fuller version with the same meaning.\n\nWhat gets set aside is usually something **uncertain, secondary, or not worth arguing about right now**: the price, the result, whether it's true, who did it. The main clause carries the speaker's real point. Often the two halves contrast in evaluation: 見た目はともかく、味は最高 (appearance aside, the taste is great).\n\nCommon shapes (the ＊ note):\n- **〜かどうかはともかく**: 本当かどうかはともかく *true or not*.\n- **疑問詞 + か + はともかく**: 誰がやったかはともかく, いつ行くかはともかく.\n- **Vか + はともかく**: 勝つか負けるかはともかく.\n\nContrast with neighbours:\n- **〜を問わず** (#2): *regardless of* — X is irrelevant to a rule that applies to all cases (国内外を問わず). はともかく doesn't state a rule; it just postpones discussing X. The practice drills this pair.\n- **〜はもちろん／〜はもとより** (#12): *not to mention X* — X is obviously included, the opposite direction.\n- **〜は別として**: close to はともかく, *except for / apart from*.\n\nIdiom: **冗談はともかく** *joking aside*.\n\nJLPT tip: in 問題2 (ordering), 〜かどうか + はともかく is a very frequent chunk: 〜できるかどうかはともかく、〜ことが大切だ.",
          "see": [
            2,
            12
          ],
          ...
          "practice": [
            {
              ...
              "items": [
                {
                  "q": "{健康|けんこう}のために、忙しいとき（　）、{普段|ふだん}はできるだけ食事をゆっくりとったほうがいいですよ。",
                  "options": [
                    "はともかく",
                    "を{問|と}わず"
                  ],
                  "answer": 0,
                  "en": "For your health, busy times aside, you should normally take your time over meals as much as possible."
                },
                {
                ...
                },
                {
                  ...
                  "answer": 1,
                  "en": "Both in Japan and abroad, environmentally friendly products are being developed."
                },
                {
                  ...
                  "answer": 0,
                  "en": "A: I tried making a cake for the first time. What do you think?\nB: The shape aside, it tastes good."
                }
              ]
            }
          ]
        },
        {
          ...
          "examples": [
            {
              "ja": "今のような{経営|けいえい}方法では、2、3年のうちに{倒産|とうさん}しかねない。",
              "en": "With the way the business is run now, it could go bankrupt within two or three years."
            },
            {
              "ja": "{寝不足|ねぶそく}で運転したら{事故|じこ}を起こしかねないよ。",
              "en": "If you drive without enough sleep, you could cause an accident."
            },
            {
              "ja": "お{年寄|としよ}りはちょっと{転|ころ}んだだけでも{骨折|こっせつ}しかねないから、注意が{必要|ひつよう}だ。",
              "en": "Elderly people can break a bone from even a small fall, so care is needed."
            },
            {
              "ja": "{情報|じょうほう}{管理|かんり}をきちんとしないと、{個人|こじん}{情報|じょうほう}を{悪用|あくよう}されかねない。",
          ...
          "practice": [
            {
              ...
              "items": [
                {
                  "q": "{在庫|ざいこ}がないので、今{注文|ちゅうもん}しても届くのは3か月後だ＿＿。",
                  "answer": "ということだ",
                  "en": "They say it's out of stock, so even if you order now, it won't arrive for three months."
                },
                {
                  "q": "日本料理で有名なもの＿＿、てんぷらでしょう。",
                  "answer": "といえば",
                  "en": "Speaking of famous Japanese dishes, it would have to be tempura."
                },
                {
                  "q": "彼女は歌手としてデビューしたが、最近はドラマの仕事が増えて、歌手＿＿{女優|じょゆう}として{活躍|かつやく}しています。",
                  "answer": "というより",
                  "en": "She debuted as a singer, but lately she's been doing more TV dramas and is active as an actress rather than a singer."
                },
                {
                  "q": "顔がよければ、{俳優|はいゆう}になれる＿＿。",
                  "answer": "というものではない",
                  "en": "Being good-looking doesn't automatically mean you can become an actor."
                }
              ]
            }
          ]
          ...
          "practice": [
            {
              ...
              "items": [
                ...
                },
                {
                  ...
                  "answer": 0,
                  "en": "A: Manager, please don't sleep on the job.\nB: I'm not sleeping. I'm thinking."
                }
              ]
            }
          ]
      ...
      "check": [
        {
          ...
          "items": [
            {
              "q": "{材料費|ざいりょうひ}が上がっているので、うちのパンやケーキも{値上|ねあ}げせ＿＿んです。",
              "answer": "ざるを{得|え}ない",
              "en": "Ingredient costs are going up, so we have no choice but to raise the prices of our bread and cakes too."
            },
            {
              "q": "そんな大変な仕事を{頼|たの}んだら、会社を{辞|や}めると言い＿＿よ。",
              "answer": "かねない",
              "en": "If you ask them to do such a tough job, they might well say they'll quit the company."
            },
            {
              "q": "作文はたくさん書けばいい＿＿。考えをまとめて、意味のある内容にすることが大切です。",
              "answer": "というものではありません",
              "en": "Writing compositions isn't simply a matter of writing a lot. What's important is to organize your thoughts and give it meaningful content."
            },
            {
              "q": "A：仕事、探しているんだって？\nB：うん、もう30歳だし、いつまでも{夢|ゆめ}を{追|お}いかけ＿＿からね。",
              "answer": "てはいられない",
              "en": "A: I hear you're looking for a job?\nB: Yeah, I'm already 30, so I can't keep chasing my dreams forever."
            }
          ]
        },
        {
          ...
          "items": [
            {
              "q": "{明後日|あさって}は卒業試験です。特別な{事情|じじょう}がない＿＿、{遅刻|ちこく}、{欠席|けっせき}は{認|みと}めません。",
              "answer": "{限|かぎ}り",
              "en": "The day after tomorrow is the graduation exam. Unless there are special circumstances, lateness or absence will not be permitted."
            },
            {
              "q": "この店は、味＿＿、{値段|ねだん}が安いし、{量|りょう}も多いので、大学生に人気がある。",
              "answer": "はともかく",
              "en": "Taste aside, this restaurant is cheap and the portions are big, so it's popular with university students."
            },
            {
              "q": "プロ＿＿{恥|は}ずかしくない{成績|せいせき}が{残|のこ}せるよう、がんばります。",
              "answer": "として",
              "en": "I'll do my best to achieve results I won't be ashamed of as a professional."
            },
            {
              "q": "{一口|ひとくち}サイズのおにぎりなんて、食事＿＿おやつだよ。",
              "answer": "というより",
              "en": "Bite-sized rice balls are more of a snack than a meal."
            }
          ]
        }
      ]
