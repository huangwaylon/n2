// Generated by tools/merge.js from data/n2/frag/ch04-*.js — edit the fragments, not this file.
N2.register({
  "id": 4,
  "genre": {
    "ja": "ニュースを聞く",
    "en": "Listening to the News"
  },
  "title": {
    "ja": "{台風|たいふう}{情報|じょうほう}",
    "en": "Typhoon Information"
  },
  "canDo": [
    {
      "ja": "天気{予報|よほう}、{台風|たいふう}{情報|じょうほう}などのニュースを聞いて{理解|りかい}できる。",
      "en": "Listen to and understand news such as weather forecasts and typhoon information."
    }
  ],
  "parts": [
    {
      ...
      "sample": {
        ...
        "lines": [
          {
            "ja": "次は{台風|たいふう}{関係|かんけい}のニュースをお伝えします。",
            "en": "Next, news about the typhoon."
          },
          {
          ...
          {
            "ja": "{台風|たいふう}の{接近|せっきん}**にともない**、{九州|きゅうしゅう}{南部|なんぶ}をはじめ{各|かく}{地域|ちいき}に{大雨|おおあめ}{洪水|こうずい}{注意報|ちゅういほう}が出されています。",
      ...
      "points": [
        {
          ...
          "examples": [
            {
              "ja": "クリスマスを前におもちゃ{売|う}り{場|ば}には、{喜|よろこ}ぶ子どもの顔を{思|おも}い{浮|う}かべつつ、プレゼントを選ぶお父さんの{姿|すがた}が増えています。",
              "en": "With Christmas approaching, more and more fathers can be seen in toy departments choosing presents while picturing their children's happy faces."
            },
            {
            ...
            },
            {
              ...
              "en": "In this meeting, I would like us to decide on our future policy while examining the problems in each department."
            },
            {
              "ja": "{趣味|しゅみ}の{園芸|えんげい}教室で{草花|くさばな}の育て方を{学|まな}びつつ、{仲間|なかま}とのおしゃべりを楽しんでいます。",
              "en": "At the gardening class I take as a hobby, I enjoy chatting with my friends while learning how to grow flowers."
            }
          ],
          "xref": "☞ p.223　〜つつ",
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "{台風|たいふう}で{電線|でんせん}が切れ、この町は{全域|ぜんいき}にわたって{停電|ていでん}した。",
              "en": "Power lines were cut in the typhoon, and the whole town lost power."
            },
            {
              "ja": "本日から約2週間にわたって、オリンピックが{行|おこな}われる。",
              "en": "The Olympics will be held over a period of about two weeks, starting today."
            },
            {
              "ja": "{長年|ながねん}にわたる研究が{実|みの}り、ついに{新製品|しんせいひん}が{完成|かんせい}した。",
              "en": "Many years of research have borne fruit, and the new product has finally been completed."
            },
            {
              "ja": "彼は{政治|せいじ}・{経済|けいざい}・{外交|がいこう}など{多方面|たほうめん}にわたって{活躍|かつやく}している。",
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "本日、{九州|きゅうしゅう}から{四国|しこく}{地方|ちほう}にかけて、{梅雨|つゆ}{入|い}りしました。",
              "en": "Today the rainy season began in the area from Kyushu to Shikoku."
            },
            {
              "ja": "この動物はアジアからアフリカにかけて、{群|む}れで{暮|く}らしている。",
              "en": "This animal lives in herds across the region from Asia to Africa."
            },
            {
              "ja": "12月{中旬|ちゅうじゅん}から{年末|ねんまつ}にかけて、町は買い物客でにぎわう。",
              "en": "From mid-December to the end of the year, the town is bustling with shoppers."
            },
            {
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "{本社|ほんしゃ}{移転|いてん}にともなって、最新のコンピューターシステムが{導入|どうにゅう}されることになった。",
              "en": "With the relocation of the head office, it has been decided that the latest computer system will be introduced."
            },
            {
              "ja": "{議員|ぎいん}の{任期|にんき}{満了|まんりょう}にともない、{総選挙|そうせんきょ}が{行|おこな}われた。",
              "en": "With the expiry of the members' terms of office, a general election was held."
            },
            {
              "ja": "一人{暮|ぐ}らしは自由だが、それにともない、{責任|せきにん}も{生|しょう}じる。",
              "en": "Living alone gives you freedom, but responsibility comes along with it."
            },
            {
              "ja": "{時代|じだい}の{変化|へんか}にともなって、{人々|ひとびと}の考え方も変わってきた。",
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "{噴火|ふんか}のおそれがありますので、{避難|ひなん}してください。",
              "en": "There is a risk of an eruption, so please evacuate."
            },
            {
              "ja": "この{地震|じしん}による{津波|つなみ}のおそれはありません。",
              "en": "There is no danger of a tsunami from this earthquake."
            },
            {
              "ja": "この{化粧品|けしょうひん}はアレルギーを引き起こすおそれがあるので、{販売|はんばい}中止になった。",
              "en": "Sales of this cosmetic were stopped because it may cause allergies."
            },
            {
              "ja": "{災害時|さいがいじ}には{携帯|けいたい}電話がつながらないおそれがありますから、別の{連絡|れんらく}方法を考えておいてください。",
              "en": "In a disaster, mobile phones may not get through, so please think of another way of getting in touch."
            },
            {
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "彼は{医療|いりょう}ボランティアとして{現地|げんち}の{医師|いし}とともに{日夜|にちや}病気の{治療|ちりょう}を{行|おこな}っている。",
              "en": "As a medical volunteer, he works day and night treating illness together with local doctors."
            },
            {
              "ja": "{大雨警報|おおあめけいほう}が出ています。{洪水|こうずい}とともに、{土砂崩|どしゃくず}れにも十分な注意が{必要|ひつよう}です。",
              "en": "A heavy-rain warning has been issued. Great care is needed not only for flooding but also for landslides."
            },
            {
              "ja": "{宅地|たくち}{開発|かいはつ}にはそこに住んでいる{人々|ひとびと}の生活{環境|かんきょう}を{整|ととの}えるとともに、{自然環境|しぜんかんきょう}を{守|まも}ることが{求|もと}められる。",
              "en": "Residential development requires both improving the living environment of the people who live there and protecting the natural environment."
            },
            {
              "ja": "{科学技術|かがくぎじゅつ}の{進歩|しんぽ}とともに、{宇宙|うちゅう}の{謎|なぞ}が{明|あき}らかになっていくだろう。",
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "ただ今、{全線|ぜんせん}で運転を{見|み}{合|あ}わせておりますが、{情報|じょうほう}が入り{次第|しだい}、お伝えいたします。",
              "en": "Services are currently suspended on all lines; we will let you know as soon as we receive information."
            },
            {
              "ja": "サンプルができ{次第|しだい}、お持ちしますので、ぜひご{検討|けんとう}ください。",
              "en": "I'll bring you a sample as soon as it's ready, so please do consider it."
            },
            {
              "ja": "ご{注文|ちゅうもん}の{品|しな}が{入荷|にゅうか}{次第|しだい}、お届けいたしますので、しばらくお待ちください。",
              "en": "We will deliver the item you ordered as soon as it comes in, so please wait a little while."
            },
            {
              "ja": "{現在|げんざい}{移動|いどう}中ですが、{現地|げんち}に{到着|とうちゃく}{次第|しだい}、{連絡|れんらく}を入れます。",
              "en": "I'm on my way now, but I'll get in touch as soon as I arrive there."
            }
          ],
          "xref": "☞ p.222　〜{次第|しだい}",
    ...
    },
    {
      ...
      "ex": {
        ...
        "prompt": {
          ...
          "en": "First listen to the question. Then read the choices on the question sheet; there is time to read them. Then listen to the talk and choose the best answer from 1 to 4 on the question sheet."
        },
        "items": [
          {
            ...
            "script": [
              {
                "sp": "",
                "ja": "男の人が話しています。{東西線|とうざいせん}について、正しい{情報|じょうほう}はどれですか。"
              },
              {
                "sp": "M",
                "v": "m",
                "ja": "皆様、ご{迷惑|めいわく}をおかけいたしまして、{誠|まこと}に{申|もう}し{訳|わけ}ございません。ただ今{東西線|とうざいせん}は{信号故障|しんごうこしょう}のため、{全線|ぜんせん}にわたって運転を{見合|みあ}わせております。安全が{確認|かくにん}され{次第|しだい}、運転を{再開|さいかい}いたしますので、しばらくお待ちください。"
              }
            ],
            "en": [
            ...
            "options": [
              "{地震|じしん}で{故障|こしょう}した",
              "{今|いま}、{動|うご}いていない",
              "{安全|あんぜん}が{確認|かくにん}された",
              "{運転|うんてん}を{再開|さいかい}した"
            ],
            "answer": 1,
            "why": {
              "en": "Service is suspended (運転を見合わせております) due to a signal failure, not an earthquake; it will resume only once safety is confirmed."
            }
          },
          {
            ...
            "script": [
              {
                "sp": "",
                "ja": "女の人が話しています。{東北|とうほく}地方の{日本海側|にほんかいがわ}の人は何に注意が{必要|ひつよう}だと言っていますか。"
              },
              {
                "sp": "F",
                "v": "f",
                "ja": "{東北|とうほく}地方の{日本海側|にほんかいがわ}には{大雪警報|おおゆきけいほう}が出ています。今夜から明日にかけて、強い風と{雷|かみなり}をともなって{大雪|おおゆき}になるおそれがありますので、{積雪|せきせつ}とともに、{落雷|らくらい}、{強風|きょうふう}にもご注意ください。"
              }
            ],
            "en": [
            ...
            "options": [
              "{雪|ゆき}だけ",
              "{雪|ゆき}と{雷|かみなり}",
              "{雪|ゆき}と{雷|かみなり}と{風|かぜ}",
              "{雪|ゆき}と{雷|かみなり}と{風|かぜ}と{波|なみ}"
            ],
            "answer": 2,
            "why": {
              "en": "積雪とともに、落雷、強風にも — snow, lightning and strong wind; waves are not mentioned."
            }
          },
          {
            ...
            "script": [
              {
                "sp": "",
                "ja": "女の人が話しています。このお知らせを聞いた人はどうしますか。"
              },
              {
                "sp": "F",
                "v": "f",
                "ja": "{東名高速道路|とうめいこうそくどうろ}は18日日曜日の午前0時から月曜日の午前にかけて、工事のため、{全面通行止|ぜんめんつうこうど}めになります。安全{第一|だいいち}で{作業|さぎょう}を進めますので、皆様のご{理解|りかい}とご{協力|きょうりょく}をお願いいたします。"
              }
            ],
            "en": [
            ...
            "options": [
              "{東名高速道路|とうめいこうそくどうろ}で{工事|こうじ}をする",
              "{東名高速道路|とうめいこうそくどうろ}を{通|とお}らない",
              "{安全|あんぜん}に{運転|うんてん}する",
              "{作業|さぎょう}を{手伝|てつだ}う"
            ],
            "answer": 1,
            "why": {
              "en": "The expressway is fully closed (全面通行止め), so listeners will not use it during that time."
            }
          }
        ]
      }
        ...
        "items": [
          {
            "script": [
              {
                "sp": "F",
                "v": "f",
                "ja": "先日、{問|と}い{合|あ}わせた{件|けん}ですが、その後どうなっていますか。"
              }
            ],
            "options": [
              "はい、{問|と}い{合|あ}わせをしております。",
              "ただ今調べておりますので、わかり{次第|しだい}ご{連絡|れんらく}いたします。",
              "はい、どういたしましょうか。"
            ],
            "answer": 1,
            "en": [
            ...
            "why": {
              "en": "〜次第 = as soon as: the staff member promises to get back once they find out."
            }
          }
        ]
      }
