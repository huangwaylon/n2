// Generated by tools/merge.js from data/n2/frag/ch05-*.js — edit the fragments, not this file.
N2.register({
  "id": 5,
  "genre": {
    "ja": "友達{同士|どうし}の会話",
  ...
  "canDo": [
    {
      "ja": "自分の困った{状況|じょうきょう}が友達に説明できる。",
      "en": "Explain a problematic situation you have to a friend."
    }
  ],
  "parts": [
    {
        ...
        "lines": [
          {
            "sp": "{渡辺|わたなべ}",
            "v": "f",
            "ja": "ねえ、サークルのみんなで旅行に行かない？　私もアメリカに留学しちゃったら、みんなにも{簡単|かんたん}に会えなくなるし…。去年{京都|きょうと}に行った**きり**、今年はどこへも行っていないし…。",
            "en": "Hey, why don't we all go on a trip with the club? Once I go off to study in America, I won't be able to see everyone so easily... We haven't gone anywhere this year since that trip to Kyoto last year..."
          },
          {
            "sp": "{木山|きやま}",
            "v": "m",
            "ja": "悪いけど、{就職先|しゅうしょくさき}もまだ決まらないのに、旅行**どころじゃない**よ。",
            "en": "Sorry, but I haven't even found a job yet — I'm in no position to go on a trip."
          },
          {
            "sp": "渡辺",
            "v": "f",
            "ja": "そうか…。ゲーム{会社|がいしゃ}に入りたいんだったよね。どう？",
            "en": "I see... You wanted to get into a game company, right? How's it going?"
          },
          {
            "sp": "木山",
            "v": "m",
          ...
          },
          {
            "sp": "渡辺",
            "v": "f",
            "ja": "へえ。人気の業界**にしては**、{求人|きゅうじん}少ないんだね。",
            "en": "Huh. For such a popular industry, there aren't many openings, are there?"
          },
          {
            "sp": "木山",
            "v": "m",
            "ja": "{求人|きゅうじん}があるところは全部{応募|おうぼ}して、{自己|じこ}{ＰＲ|ピーアール}何回書いた**ことか**。",
            "en": "I've applied to every place that's hiring — I can't tell you how many self-promotion statements I've written."
          }
        ]
      },
      "points": [
        {
          ...
          "formNotes": [
            {
              "ja": "話し言葉では「[V-た] + っきり」も使われる。",
              "en": "In spoken language, \"[V-た] + っきり\" is also used."
            }
          ],
          "examples": [
            {
              "ja": "彼は「ごめん」と言ったきり、{黙|だま}ってしまった。",
              "en": "He said “sorry” and then fell silent."
            },
            {
              "ja": "家には2、3回使ったきりの{健康器具|けんこうきぐ}がいくつもある。",
              "en": "At home I have several pieces of fitness equipment that I used only two or three times."
            },
            {
              "ja": "あの歌手、何年か前にテレビで見たきりだけど、今どうしているのかなあ。",
              "en": "I haven't seen that singer since I saw them on TV a few years ago — I wonder what they're doing now."
            },
            {
          ...
          "notes": [
            {
              ...
              "examples": [
                {
                  "ja": "{妻|つま}は{赤|あか}ん{坊|ぼう}の{世話|せわ}にかかりっきりなので、{掃除|そうじ}や{洗濯|せんたく}は私がしています。",
                  "en": "My wife is fully occupied looking after the baby, so I do the cleaning and laundry."
                },
                {
                  "ja": "{佐藤|さとう}さんは新入社員をつきっきりで{指導|しどう}している。",
                  "en": "Mr. Sato is training the new employee, staying by his side the whole time."
                }
              ]
            },
            {
              ...
              "examples": [
                {
                  "ja": "女性が1人きりで{夜道|よみち}を歩くのは{危険|きけん}だ。",
                  "en": "It's dangerous for a woman to walk the streets alone at night."
                },
                {
                  "ja": "彼と2人っきりでクリスマスを{過|す}ごすのが私の{夢|ゆめ}なの。",
                  "en": "My dream is to spend Christmas with him, just the two of us."
                },
                {
                  "ja": "一度きりの人生だから、{悔|く}いのないように生きようと思う。",
                  "en": "You only live once, so I intend to live without regrets."
                }
              ],
              "xref": "☞ p.221　〜きる／きり"
            }
          ...
          "practice": [
            {
              ...
              "items": [
                {
                  "q": "うっかり{眼鏡|めがね}をかけた（　）顔を洗ってしまった。",
                  "options": [
                    "まま",
                    "きり"
                  ],
                  "answer": 0,
                  "en": "I carelessly washed my face with my glasses still on."
                },
                {
        ...
        },
        {
          ...
          "formNotes": [
            {
              "ja": "「[なA]／[N]で（は）ある + ものの」の形もある。",
              "en": "There is also the form \"[なA]／[N]で(は)ある + ものの\"."
            },
            {
              "ja": "「〜ている・〜てみる」などは「〜てはいる」のように「は」が入ることが多い。",
              "en": "With forms such as 〜ている and 〜てみる, は is often inserted, as in 〜てはいる."
            }
          ],
          "examples": [
            {
              "ja": "水泳教室に通ってはいるものの、いまだに25メートルしか泳げない。",
              "en": "Although I do go to swimming classes, I still can only swim 25 meters."
            },
            {
              "ja": "この{靴|くつ}、デザインが気に入って買ったものの、{履|は}く機会が{全然|ぜんぜん}ないんだ。",
              "en": "I bought these shoes because I liked the design, but I never get a chance to wear them."
            },
            {
              "ja": "新しい{技術|ぎじゅつ}が{開発|かいはつ}されたとはいうものの、{実用化|じつようか}にはまだ時間がかかるだろう。",
              "en": "Although a new technology has been developed, it will probably still take time before it is put to practical use."
            },
            {
              "ja": "{両国間|りょうこくかん}の{関係修復|かんけいしゅうふく}は、{困難|こんなん}ではあるものの、{改善|かいぜん}に{向|む}けての{努力|どりょく}は{必要|ひつよう}だ。",
              "en": "Although repairing relations between the two countries is difficult, efforts toward improvement are necessary."
            }
          ],
              ...
              "items": [
                {
                  ...
                  "options": [
                    "{編|あ}み上げたころには春になっているかもしれない",
                    "春になったらすてきなセーターができそうだ"
                  ],
                  "answer": 0,
                ...
                },
                {
                  ...
                  "options": [
                    "なかなかいいアイデアが{浮|う}かばない",
                    "ヒット{商品|しょうひん}が生まれるかもしれない"
                  ],
                  "answer": 0,
        ...
        },
        {
          ...
          "formNotes": [
            {
              "ja": "「{驚|おどろ}いた・困った・うれしい・悲しい・{不思議|ふしぎ}な・{残念|ざんねん}な・ありがたい」などの言葉と一緒に使う。",
              "en": "It is used together with words such as 驚いた (surprised), 困った (troubled), うれしい (happy), 悲しい (sad), 不思議な (strange), 残念な (regrettable) and ありがたい (grateful)."
            }
          ],
          "examples": [
            {
              "ja": "ホテルの部屋に入ったら、{驚|おどろ}いたことに、バラの{花束|はなたば}とホテルマネージャーからの{歓迎|かんげい}メッセージがテーブルの上に置いてあった。",
              "en": "When I entered my hotel room, to my surprise, a bouquet of roses and a welcome message from the hotel manager had been placed on the table."
            },
            {
              "ja": "うれしいことに、うちの高校が{合唱|がっしょう}コンクールで{優勝|ゆうしょう}したんですよ。",
              "en": "I'm happy to say that our high school won the choir competition."
            },
            {
              "ja": "{五色沼|ごしきぬま}は{不思議|ふしぎ}なことに、5つある{沼|ぬま}の水の色が全部違うそうだ。",
              "en": "Strangely enough, at Goshikinuma the water in each of the five ponds is apparently a different color."
            },
            {
              "ja": "{残念|ざんねん}なことに、行きつけの{美容院|びよういん}が{閉店|へいてん}してしまった。",
              "en": "Sadly, the hair salon I always go to has closed down."
            }
          ],
          "xref": "☞ p.221　〜こと",
        ...
        },
        {
          ...
          "formNotes": [
            {
              "ja": "[Pl]［[なA~~だ~~]］の場合もある。",
              "en": "It can also follow [Pl] (with [なA~~だ~~])."
            }
          ],
          "examples": [
            {
              "ja": "今人気のエリナはモデルにしては{背|せ}が高いほうではない。",
              "en": "Erina, who is popular right now, isn't particularly tall for a model."
            },
            {
              "ja": "このお{弁当|べんとう}は300円にしては{量|りょう}も多いし味もいい。",
              "en": "For 300 yen, this boxed lunch has a generous portion and tastes good too."
            },
            {
              "ja": "A：そのコート、すてきね。\nB：30年前に母が着てたのなんだけど、それにしてはデザインも古くないでしょ？",
              "en": "A: That coat is lovely.\nB: It's one my mother wore 30 years ago, but the design doesn't look old for that, does it?"
            },
            {
              "ja": "そのおすし、初めて作ったにしては上手にできたじゃない。",
        ...
        },
        {
          ...
          "formNotes": [
            {
              "ja": "「[なA]／[N]である + ことか」も使われることがある。",
              "en": "\"[なA]／[N]である + ことか\" is also sometimes used."
            }
          ],
          "examples": [
            {
              "ja": "人は私のことを頭がいいと言うけど、この試験に{合格|ごうかく}するために、どれだけ勉強したことか。私の{努力|どりょく}は{誰|だれ}も知らないでしょうね。",
              "en": "People say I'm smart, but you have no idea how much I studied to pass this exam. Nobody knows how hard I worked."
            },
            {
              "ja": "子どものころ、親の{転勤|てんきん}のために{親友|しんゆう}と別れなければならなくて、どんなに悲しかったことか。",
              "en": "When I was a child, I had to part from my best friend because of my parent's job transfer — how sad I was!"
            },
            {
              "ja": "言葉が通じない外国で病気になって、どれほど{心細|こころぼそ}かったことか。あのときの{看護師|かんごし}さんには今でも{感謝|かんしゃ}しています。",
              "en": "How helpless I felt falling ill in a foreign country where I couldn't make myself understood! I'm still grateful to the nurse who looked after me then."
            },
            {
              "ja": "{週末|しゅうまつ}、台風が来そうで{心配|しんぱい}だ。運動会が中止になったら、楽しみにしている{娘|むすめ}がどんなにがっかりすることか。",
              "en": "I'm worried a typhoon might come this weekend. If the sports day is cancelled, how disappointed my daughter, who's been looking forward to it, will be!"
            }
          ],
          "xref": "☞ p.221　〜こと",
      ...
      "check": {
        ...
        "items": [
          {
            "q": "A：今日、飲みに行かない？\nB：急に部長に仕事を{頼|たの}まれちゃって、それ＿＿よ。",
            "answer": "どころじゃない",
            "en": "A: Want to go for a drink today?\nB: My manager suddenly asked me to do some work, so that's out of the question."
          },
          {
            "q": "友達にすすめられて新しいサプリメントを{試|ため}してみた＿＿、あまり{効果|こうか}がなかった。",
            "answer": "ものの",
            "en": "I tried a new supplement on a friend's recommendation, but it didn't have much effect."
          },
          {
            "q": "彼が買った車は{中古車|ちゅうこしゃ}＿＿ボディもきれいで、エンジンの{調子|ちょうし}もいい。",
            "answer": "にしては",
            "en": "For a used car, the one he bought has a clean body and the engine runs well."
          },
          {
            "q": "困った＿＿、ATMが{故障|こしょう}していてお金が下ろせない。",
            "answer": "ことに",
            "en": "Annoyingly, the ATM is broken and I can't withdraw any money."
          },
          {
          ...
          },
          {
            ...
            "answer": "ことか",
            "en": "Where were you all night without even getting in touch? You have no idea how worried I was!"
          }
        ]
      }
    },
    {
      ...
      "canDo": [
        ...
        {
          "ja": "友達の話に{共感|きょうかん}して{励|はげ}ますことができる。",
          "en": "Sympathize with what a friend says and offer encouragement."
        }
      ],
      "sample": {
        "kind": "dialogue",
        ...
        "lines": [
          {
            "sp": "{渡辺|わたなべ}",
            "v": "f",
            "ja": "難しいね。やる気**さえ**あれ**ば**、{採用|さいよう}してもらえるというものじゃないだろうし。",
            "en": "That's tough. It's probably not the case that they'll hire you just because you're motivated."
          },
          {
            "sp": "{木山|きやま}",
            "v": "m",
            "ja": "そうなんだよ。{募集|ぼしゅう}がなければがんばり**ようがない**し…。このままゲーム{会社|がいしゃ}にこだわって、さんざん{苦労|くろう}した**あげく**、どこにも{就職|しゅうしょく}できなかったらどうしようって思ったりして…。",
            "en": "Exactly. If there are no openings, there's no way I can even try… Sometimes I think, what if I keep sticking to game companies, go through all that trouble, and in the end can't get a job anywhere…"
          },
          {
            "sp": "渡辺",
            "v": "f",
            "ja": "そんなこと考える**もんじゃない**よ。{成功|せいこう}するって信じなきゃ。ゼミの{先輩|せんぱい}も、{絶対|ぜったい}だめだと思ったけど出す**だけ**出してみるって言って、{結局|けっきょく}その会社に入れたんだって。",
            "en": "You shouldn't think like that. You have to believe you'll succeed. One of the seniors from my seminar said he was sure it was hopeless but he'd at least send in an application, and in the end he got into that company."
          },
          {
            "sp": "木山",
            "v": "m",
          ...
          },
          {
            "sp": "渡辺",
            "v": "f",
            "ja": "だから、とにかくあきらめないで、最後までがんばろうよ。ね。",
            "en": "So anyway, don't give up. Let's keep at it to the end, OK?"
          }
        ]
      },
      "points": [
          ...
          "examples": [
            {
              ...
              "en": "A: Have you finished your report?\nB: Almost. I just need to write the conclusion and I'm done."
            },
            {
              "ja": "そちらのご{都合|つごう}さえよければ、{明日|あす}{伺|うかが}わせていただきます。",
              "en": "As long as it's convenient for you, I'll come and visit tomorrow."
            },
            {
              "ja": "A：あの車、すてきなデザインね。\nB：車なんて走りさえすればいいんだよ。",
              "en": "A: That car has a lovely design, doesn't it?\nB: A car just needs to run, that's all."
            },
            {
              "ja": "食べられさえすれば、味は{問|と}わないよ。",
              "en": "As long as it's edible, I don't care how it tastes."
            },
            {
              "ja": "{残念|ざんねん}だったね、さくらちゃん。転びさえしなければ1{位|い}だったのに…。",
              "en": "That's a shame, Sakura. If only you hadn't fallen, you'd have come in first…"
            },
            {
              "ja": "留学生活は大変だけど、{健康|けんこう}でさえあればどんな{困難|こんなん}も乗り切れると信じてがんばろうと思う。",
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "出張の予定だったが、{大雪|おおゆき}で{飛行機|ひこうき}が{欠航|けっこう}してしまったので行きようがない。",
              "en": "I was supposed to go on a business trip, but the flight was canceled because of heavy snow, so there's no way I can go."
            },
            {
              "ja": "A：どうして1週間も{連絡|れんらく}してくれなかったの。\nB：ごめん。{携帯|けいたい}電話をなくしちゃって、{連絡|れんらく}しようがなかったんだ。",
              "en": "A: Why didn't you get in touch with me for a whole week?\nB: Sorry. I lost my cell phone, so I had no way of contacting you."
            },
            {
              "ja": "タケダ{産業|さんぎょう}に{就職|しゅうしょく}したいが{新卒|しんそつ}の{採用|さいよう}がないので、どうしようもない。",
              "en": "I want to get a job at Takeda Industries, but they aren't hiring new graduates, so there's nothing I can do.",
              "idiom": true
            }
          ],
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "A：お父さん、私、{単位|たんい}落としちゃって、もう一度2年生をやることになっちゃったんだ。\nB：何？　遊びまわったあげくに{留年|りゅうねん}するなんて、何を考えているんだ。",
              "en": "A: Dad, I failed some credits, so I have to do second year all over again.\nB: What? You fooled around and ended up having to repeat a year? What are you thinking?"
            },
            {
              "ja": "さっきのお客さん、あれこれ{試着|しちゃく}したあげく、何も買わずに帰っちゃって…。",
              "en": "That customer just now tried on this and that, and in the end left without buying anything…"
            },
            {
              "ja": "3時間以上{迷|まよ}ったあげく、店員に初めにすすめられたパソコンを買うことにした。",
              "en": "After agonizing for more than three hours, I ended up deciding to buy the computer the salesclerk had recommended in the first place."
            }
          ],
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "{楽|らく}をしてお金をもうけようなんて考えるもんじゃない。",
              "en": "You shouldn't think about making money the easy way."
            },
            {
              "ja": "人の{悪口|わるぐち}を言うもんじゃありません。",
              "en": "You mustn't speak ill of others."
            },
            {
              "ja": "社内のことは小さいことでも、{部外者|ぶがいしゃ}に話すものではない。",
              "en": "You should not talk to outsiders about company matters, however small."
            },
            {
              "ja": "A：どうも、すみませ〜ん。\nB：何、笑ってるんだ！　{謝|あやま}るときにはへらへら笑うもんじゃない。",
              "en": "A: Sorry about that~.\nB: What are you laughing about? You don't grin like that when you're apologizing!"
            }
          ],
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "今から行っても間に合わないかもしれないけど、行くだけ行ってみようよ。",
              "en": "We might not make it even if we go now, but let's at least go and see."
            },
            {
              "ja": "A：忙しいから、休みなんてもらえないだろうなあ。\nB：今日、{課長|かちょう}{機嫌|きげん}がいいから、{頼|たの}むだけ{頼|たの}んでみたら？",
              "en": "A: We're so busy, I probably won't be able to get any time off.\nB: The section chief is in a good mood today, so why not at least ask?"
            },
            {
              "ja": "このドレス、すてきだよね。{似合|にあ}わないかもしれないけど、着るだけ着てみようかな。",
      ...
      "check": {
        ...
        "items": [
          {
            "q": "わざわざ大学病院へ行ったのに、さんざん待たされた＿＿、{診察|しんさつ}時間はたった2分だった。",
            "answer": "あげく",
            "en": "I went all the way to the university hospital, and after being kept waiting forever, the examination lasted just two minutes."
          },
          {
            "q": "A：{久|ひさ}しぶりの海外旅行だから、何か忘れていないか{心配|しんぱい}。\nB：パスポートとお金＿＿持っていけば、何とかなるよ。",
            "answer": "さえ",
            "en": "A: It's my first trip abroad in ages, so I'm worried I've forgotten something.\nB: As long as you take your passport and money, you'll manage."
          },
          {
            "q": "A：この{機械|きかい}、直していただけませんか。\nB：{部品|ぶひん}がないので、直し＿＿んですよ。",
            "answer": "ようがない",
            "en": "A: Could you repair this machine for me?\nB: We don't have the parts, so there's no way to repair it."
          },
          {
          ...
          },
          {
            ...
            "answer": "だけ",
            "en": "It's hard to get this scholarship, but I'm thinking of at least applying."
          }
        ]
      }
    }
