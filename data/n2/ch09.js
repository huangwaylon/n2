      ...
      points: [
        {
          ...
          stars: 1,
          marks: ["casual"],
          usage: { ja: "「〜のなんのって」は、「言葉でうまく説明できないくらい{非常|ひじょう}に〜だ」という気持ちを表す。", en: "\"〜のなんのって\" expresses the feeling that something \"is so extremely 〜 that I can't explain it well in words.\"" },
          forms: ["[Pl] + のなんのって\n［[なA~~だ~~]な　~~[N]だ~~］"],
          examples: [
        ...
        },
        {
          ...
          stars: 1,
          marks: ["regret", "casual"],
          usage: { ja: "{身近|みぢか}な{相手|あいて}に対して、{批判的|ひはんてき}なことを言いたいときに使う。", en: "Use this when you want to say something critical to a familiar person." },
          forms: ["[N] + ったら"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「{泥棒|どろぼう}が{窓|まど}を{壊|こわ}すとブザーが{鳴|な}るようになっている」のように、{機械|きかい}のシステムや体のメカニズムなど、何かをしたり、何かが起こったりすると、{自動的|じどうてき}に次のことが起こると説明するときに使う。", en: "Use this when you explain that a mechanical system, bodily mechanism or the like will automatically do something when something is done or occurs as in \"{泥棒|どろぼう}が{窓|まど}を{壊|こわ}すとブザーが{鳴|な}るようになっている\"." },
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「AどころかB」の形で、「雨が降るどころかすごくいい天気になった」のようにA（雨）ではなくて{反対|はんたい}のB（いい天気）だと強く言う気持ちを表す。また、「漢字どころかひらがなもわからない」のようにA（漢字がわからない）よりもっと{程度|ていど}がすごいB（ひらがなもわからない）と言うときにも使う。Aには相手の言ったことや自分が初めに思ったことなどが入ることが多い。", en: "As in \"雨が降るどころかすごくいい天気になった\", the \"AどころかB\" form expresses a feeling that strongly says \"it's not A (rainy weather), it's the opposite, B (fine weather).\" In addition, as in \"漢字どころかひらがなも読めない\", it is also used when you say \"it's not A (not able to read kanji), it's something much more, B (not able to even read hiragana).\" A is often something the listener said or something the speaker has just thought of." },
          forms: ["[Pl] + どころか\n［[なA~~だ~~]　[N~~だ~~]］"],
          examples: [
              ...
              items: [
                {
                  ...
                  options: ["{騒音|そうおん}がひどいんですよ", "とても便利ですよ"],
                  answer: 0,
    ...
    },
    {
      ...
      points: [
        ...
        },
        {
          ...
          stars: 1,
          marks: ["regret"],
          usage: { ja: "「〜に{限|かぎ}って…」は、「〜の{立場|たちば}の人は{一般的|いっぱんてき}に（…の{傾向|けいこう}がある）」と{批判的|ひはんてき}に言いたいときに使う。", en: "Use \"〜に{限|かぎ}って…\" when you want to criticize that \"people in 〜 position generally (tend to …)\"." },
          forms: ["[N] + に{限|かぎ}って"],
          examples: [
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜ことだ」は、「〜すべきだ、〜したほうがいい」という{話者|わしゃ}の{判断|はんだん}を表す。アドバイスに使われることが多い。", en: "\"〜ことだ\" expresses the judgment of the speaker, as in \"you should 〜; you ought to 〜\". It is often used to give advice." },
          forms: ["[V-る]／[V-ない] + ことだ"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「1時間待つくらいならほかの店に行こう」のように、「AくらいならB」の形で、「Aする（1時間待つ）のは{嫌|いや}だから、Bも一番いいとは言えないがB（ほかの店に行く）を選ぶ」と言いたいときに使う。「ほかの店に行ったほうがよかった」のように{後悔|こうかい}するときにも使う。", en: "As in \"1時間待つくらいならほかの店に行こう\", use the \"AくらいならB\" form when you want to say \"I don't like to do A (wait an hour), so I choose B (to go to another store) although I can't say B is the best.\" You can also use this to express regret as in \"ほかの店に行ったほうがよかった\"." },
          forms: ["[V-る] + くらいなら"],
          examples: [
          ...
          practice: [
            {
              ...
              left: ["{材料費|ざいりょうひ}を1,000円も出すくらいなら、", "疲れて学校休むくらいなら、", "{上司|じょうし}と飲みに行くくらいなら、", "すぐに別れるくらいなら、"],
              right: ["{残業|ざんぎょう}のほうがいいよ。", "{手作|てづく}りするより、買ったほうがいいんじゃない？", "最初から付き合わなければよかったのに…。", "アルバイトなんてやめなさい。"],
              answer: [1, 3, 0, 2],
              en: ["If it costs as much as 1,000 yen for materials, wouldn't it be better to buy one than make it yourself?", "If you're going to be so tired you miss school, quit that part-time job.", "Rather than go drinking with my boss, I'd prefer overtime.", "If you were going to break up so soon, you shouldn't have started going out in the first place…"],
            },
          ],
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「まし」は、「ほかのものと{比|くら}べてみて、いいとは言えないが、一番悪いわけではない」と言いたいときに使う。「〜ほうが・〜より・〜だけ・まだ・ずっと」などと一緒に使われることが多い。", en: "Use \"まし\" when you want to say \"I can't say it's good when compared to something else, but it's not the worst.\" It is often used together with \"〜ほうが・〜より・〜だけ・まだ・ずっと\", etc." },
          forms: [],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["うちが{燃|も}えた", "{命|いのち}が助かった"],
                  answer: 1,
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            options: ["に{反|はん}して", "くらいなら", "はもとより", "どころか"],
            answer: 3,
          ...
          },
          {
            ...
            options: ["ことはないだろう", "ところだった", "ところではなかった", "ばかりだった"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["ほうがましだ", "ところだった", "ことだ", "おそれがある"],
            answer: 0,
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "{今朝|けさ}、電車に荷物忘れるところだったよ。" },
            ],
            en: ["This morning I almost left my bag on the train.", "What? What did you forget?", "Oh? Good thing you noticed.", "What? Then shall we contact the station?"],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "こんな{簡単|かんたん}な{書類|しょるい}が書けないようでは仕事にならないよ。" },
            ],
            en: ["If you can't even fill out a simple document like this, you won't be able to do the job.", "Yes, I'm sorry.", "Yes, because it's work.", "Yes, it seems I can't write it."],
