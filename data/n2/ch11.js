  ...
  parts: [
    {
      ...
      sample: {
        ...
        lines: [
          ...
          { cont: true, ja: "ラーメンは中国のめん料理を{起源|きげん}にしていると言われますが、外国人にとってラーメンは日本料理**にほかならない**のです。", en: "Ramen is said to have originated from Chinese noodle dishes, but for foreigners ramen is nothing other than Japanese cuisine." },
          ...
          { cont: true, ja: "ラーメンはめんやスープの作り方に{工夫|くふう}ができる**{上|うえ}**に、めんにのせる{具|ぐ}にもバリエーションがつけやすいのです。", en: "With ramen, not only can you get creative with how the noodles and soup are made, but on top of that it is easy to vary the toppings you put on the noodles." },
          { cont: true, ja: "そのため、ラーメン**といっても**、最近はイタリア料理のトマトソースを使ったもの、サラダ{感覚|かんかく}で食べられるもの、スープのないものなど、{様々|さまざま}なものがあります。", en: "So although it is all called \"ramen\", these days there are all kinds: ones made with Italian-style tomato sauce, ones you can eat like a salad, ones without soup, and so on." },
          { cont: true, ja: "ラーメンはしょうゆ**に{限|かぎ}る**と言う人も、一度食べてみる{価値|かち}があるのではないでしょうか。", en: "Even people who say nothing beats soy-sauce ramen might find them worth trying at least once." },
          { ja: "先日インターネットで{話題|わだい}になっているラーメン店に行ってみました。", en: "The other day I went to a ramen shop that has been the talk of the internet." },
          { cont: true, ja: "{人気店|にんきてん}**だけあって**、すごい{行列|ぎょうれつ}でした。", en: "As you would expect of a popular shop, there was a huge queue." },
          { cont: true, ja: "2時間待たされましたが、さすがにそのラーメンはスープ**にしろ**、{具|ぐ}**にしろ**、その店{独自|どくじ}の{工夫|くふう}がされていて、今までにない新しいものでした。", en: "I had to wait two hours, but true to its reputation, that ramen — whether the soup or the toppings — had the shop's own original touches, and it was something new, unlike anything I'd had before." },
      ...
      points: [
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜にほかならない」は、「〜以外のほかのものではない」ことを表す。「一番の理由・大切なこと・問題になることは〜だ」と強く言いたいときに使われる。", en: "\" 〜にほかならない \" states that something \"is nothing other than 〜\". It is used when you want to strongly say \" 〜 is the biggest reason / important / a problem.\"" },
          forms: ["[N] + にほかならない"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜にすぎない」は、「{合格率|ごうかくりつ}は8％にすぎない」のように、「ただ〜だけだ」と説明したいときに使われる。あまり{価値|かち}がないと思っているときにもよく使われる。", en: "\" 〜にすぎない \" is used when you want to explain that something is \"only 〜 \" as in \" {合格率|ごうかくりつ}は8％にすぎない \". It is also often used when you think that something does not have much value." },
          ...
          practice: [
            {
              ...
              items: [
                {
                  q: "アルバイト店員といっても、（　）。",
                  options: ["店長と同じぐらい働いています", "{給料|きゅうりょう}が安いです", "一生{懸命|けんめい}働きません"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["難しい話ばかりしていますから", "お{菓子|かし}を食べながら話し合う{気楽|きらく}な{会|かい}ですから", "会長をしていますから"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["病院へ行ってきたから", "学校を休んだから", "{熱|ねつ}はないんだから"],
                  answer: 2,
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜に{限|かぎ}る」は、「{絶対|ぜったい}〜が一番いい」という自分の考えを表す。", en: "\" 〜に{限|かぎ}る \" expresses your idea that \" 〜 is absolutely the best.\"" },
          ...
          examples: [
            ...
            { ja: "{嫌|いや}なことは忘れるに{限|かぎ}りますよ。", en: "When something unpleasant happens, the best thing is to forget it." },
          ],
        ...
        },
        {
          ...
          examples: [
            ...
            { ja: "ドイツの{高級車|こうきゅうしゃ}だけに高速道路を走ったときの安定感はすばらしい。", en: "As you'd expect of a German luxury car, its stability on the expressway is superb." },
          ],
          notes: [
            {
              ...
              items: [
                {
                  ...
                  parts: [
                    { tag: "a", options: ["やら", "にしろ"], answer: 0 },
                    { tag: "b", options: ["やら", "にしろ"], answer: 0 },
                  ],
                ...
                },
                {
                  ...
                  parts: [
                    { tag: "a", options: ["やら", "にしろ"], answer: 1 },
                    { tag: "b", options: ["やら", "にしろ"], answer: 1 },
                  ],
      ...
      check: [
        {
          ...
          items: [
            ...
            { q: "どんな{事情|じじょう}がある＿＿、{犯罪|はんざい}は{許|ゆる}されない。", answer: "にしろ", en: "Whatever the circumstances, crime cannot be excused." },
  ...
  review: [
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            options: ["ばかりでなく", "というのに", "というより", "といっても"],
            answer: 3,
          ...
          },
          {
            ...
            options: ["に{限|かぎ}る", "にすぎない", "にしても", "といっても"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["に{限|かぎ}る", "にほかならない", "にすぎない", "ばかりだ"],
            answer: 0,
    ...
    },
    {
      ...
      ex: {
        ...
        en: ["The other day, I took part in a training session run by a corporate consulting company. Right at the start of the training, candy was handed out. Admittedly, this training was related to the confectionery industry, and many of the participants were women. It was also \"snack time\", when you start to get a little hungry. However, having come to the training in a serious frame of mind, I felt a little displeased, thinking that whether candy or chocolate, these are not things adults should be eating in a setting like this.", "Looking at the other participants, not only the women but the men too were putting them in their mouths. Urged by someone from the organizers' side, I reluctantly put a candy in my mouth as well. Then my head, which had been tired and foggy, cleared up. Looking around, perhaps because the tension of meeting for the first time had eased, people who didn't know each other had started chatting amicably.", "Seeing that, I understood why \"snacks\" were being served at this training. Just as you'd expect from the training of a corporate consulting company that has been in the news lately, I thought they were making clever use of \"snacks\"."],
        items: [
          {
