  ...
  parts: [
    {
      ...
      points: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                {
                  q: "プレゼント用のラッピングは、あちらのカウンターで（　）おります。",
                  options: ["申して", "{承|うけたまわ}って"],
                  answer: 1,
                  en: "Gift wrapping is handled at the counter over there.",
                  why: { en: "承る = humble 引き受ける (accept/handle a request)." },
                },
                {
                  q: "この{資料|しりょう}をコピーして（　）ので、{少々|しょうしょう}お待ちください。",
                  options: ["まいります", "おいでになります"],
                  answer: 0,
                  en: "I'll go and copy these materials, so please wait a moment.",
                  why: { en: "The speaker is the one going → humble Vてまいる (= Vてくる)." },
                },
                {
                  q: "こちらの{商品|しょうひん}はきっとご{満足|まんぞく}いただけると（　）。",
                  options: ["{存|ぞん}じます", "ご{存|ぞん}じです"],
                  answer: 0,
                  en: "I'm sure you will be satisfied with this product.",
                  why: { en: "The speaker's own thought → humble 存じます (= 思います). ご存じ is honorific 知っている." },
                },
              ],
            },
          ],
        },
        {
          ...
          stars: 2,
          marks: ["polite"],
          usage: { ja: "「お／ご〜{願|ねが}います」は、「お／ご〜いただく／ください」と同じ意味で、ビジネス場面などで相手に{丁寧|ていねい}に{頼|たの}むときに使われる。", en: "\"お／ご〜{願|ねが}います\" is used when making a polite request to someone in a business or other similar setting and has the same meaning as \"お／ご〜いただく／ください\"." },
      ...
      check: {
        ...
        en: ["I'm Sato, a new employee. I have been assigned to Sales Department No. 2. I'd like to take this opportunity to say a few words of greeting.", "Everything is new to me, so I may cause you some trouble, but I will work hard, with your guidance, so that I can be useful to you all as soon as possible.", "I look forward to working with you."],
        blanks: [
          {
            options: ["申し伝え", "申し"],
            answer: 1,
            why: { en: "Giving your own name: 〜と申します (humble 言う). 申し伝える means to pass on a message." },
          },
          {
            options: ["いたしました", "なりました"],
            answer: 1,
            why: { en: "Being assigned is not the speaker's own decision → 〜ことになりました." },
          },
          {
            options: ["申し上げます", "願います"],
            answer: 0,
            why: { en: "The speaker gives the greeting → ごあいさつ申し上げます (#75). 願います would ask the listeners to do it." },
          },
          {
            options: ["につきまして", "にとりまして"],
            answer: 1,
            why: { en: "*For me* → にとって → にとりまして (#77)." },
          },
          {
            options: ["{存|ぞん}じます", "{存|ぞん}じ{上|あ}げます"],
            answer: 0,
            why: { en: "〜かと存じます = humble 〜かと思います. 存じ上げる is used for knowing a person." },
          },
          {
            options: ["いただいて", "うけたまわって"],
            answer: 0,
            why: { en: "The speaker receives guidance from everyone → ご指導いただいて." },
          },
          {
            options: ["まいります", "おります"],
            answer: 0,
            why: { en: "努力してまいります = humble 努力していきます (will keep working hard from now on)." },
          },
          {
            options: ["申し上げ", "申し伝え"],
            answer: 0,
            why: { en: "Fixed phrase: よろしくお願い申し上げます." },
          },
        ],
      },
    },
  ...
  review: [
    {
      ...
      ex: {
        ...
        items: [
          {
            q: "{特別展|とくべつてん}を（　）皆様は{入館|にゅうかん}前に入口の注意{事項|じこう}をお読みください。",
            options: ["ご{覧|らん}になる", "ご{覧|らん}に{入|い}れる", "{拝見|はいけん}する", "{拝見|はいけん}なさる"],
            answer: 0,
            en: "Those who will be viewing the special exhibition, please read the notes at the entrance before entering.",
            why: { en: "The visitors look → honorific ご覧になる. ご覧に入れる is humble 見せる; 拝見する is humble 見る (wrong direction); 拝見なさる mixes humble and honorific." },
          },
          {
            q: "ご{注文|ちゅうもん}を（　）。ご利用ありがとうございます。",
            options: ["いたしました", "うけたまわりました", "なさいました", "されました"],
            answer: 1,
            en: "We have received your order. Thank you for using our service.",
            why: { en: "The shop receives the order → humble 承る (うけたまわる)." },
          },
          {
            q: "先生から{貴重|きちょう}な{資料|しりょう}を（　）ことは、私の研究の大きな助けになりました。本当にありがとうございました。",
            options: ["{拝見|はいけん}できました", "{拝借|はいしゃく}できました", "お貸しになりました", "お見えになりました"],
            answer: 1,
            en: "Being able to borrow valuable materials from you was a great help to my research. Thank you very much.",
            why: { en: "先生から〜を借りる → humble 拝借する." },
          },
          {
            q: "先生は{新内閣|しんないかく}についてどう（　）か。",
            options: ["{存|ぞん}じます", "おわかりです", "お考えです", "{存|ぞん}じ{上|あ}げます"],
            answer: 2,
            en: "What do you think about the new cabinet, professor?",
            why: { en: "どう + 思う/考える of a superior → honorific お考えです. 存じる forms are humble." },
          },
          {
            q: "A：{山本|やまもと}先生、今度の日曜日はお{宅|たく}に（　）か。\nB：あいにく日曜日はちょっと…。",
            options: ["おこしになります", "おいでになります", "お見えになります", "おります"],
            answer: 1,
            en: "A: Professor Yamamoto, will you be at home this Sunday?\nB: Unfortunately, Sunday is a bit...",
            why: { en: "お宅に（いる）→ honorific おいでになる, which also covers いる. お越しになる / お見えになる are honorific for coming (来る), not for being somewhere; おります is humble, so it can't be used for the teacher." },
          },
          {
            q: "こちらの{商品|しょうひん}はセール{品|ひん}でございますので、{交換|こうかん}はご{遠慮|えんりょ}（　）。",
            options: ["願います", "{存|ぞん}じます", "いたしません", "うけたまわりません"],
            answer: 0,
            en: "This item is a sale item, so we ask you to refrain from requesting an exchange.",
            why: { en: "ご遠慮願います = please refrain (#74)." },
          },
          {
            q: "お忙しいところ{恐縮|きょうしゅく}ですが、{貴社|きしゃ}{主催|しゅさい}のツアーについて、{詳細|しょうさい}を教えて（　）と{存|ぞん}じます。どうぞよろしくお願いします。",
            options: ["さしあげて", "さしあげれば", "いただけて", "いただければ"],
            answer: 3,
            en: "I'm sorry to trouble you when you're busy, but I would be grateful if you could tell me the details of the tour your company is organizing.",
            why: { en: "〜ばと存じます (#76) with the receiving verb: 教えていただければと存じます." },
          },
        ],
      },
    },
        ...
        items: [
          {
            before: "お客様が",
            after: "ください。",
            pieces: ["2階の", "お見えになったら", "ご案内して", "{応接室|おうせつしつ}に"],
            order: [1, 0, 3, 2],
            star: 2,
            en: "When the customer arrives, please show them to the reception room on the second floor.",
          },
          {
            before: "この{機会|きかい}にぜひ",
            after: "申し上げます。",
            pieces: ["ご案内", "お{試|ため}し", "{新商品|しんしょうひん}を", "くださいますよう"],
            order: [2, 1, 3, 0],
            star: 2,
            en: "We invite you to take this opportunity to try our new products.",
          },
          {
            before: "{商品|しょうひん}が",
            after: "と思います。",
            pieces: ["{入荷|にゅうか}するまで", "いただければ", "お待ち", "しばらく"],
            order: [0, 3, 2, 1],
            star: 2,
            en: "I'd be grateful if you could wait a while until the product comes in.",
          },
        ],
      },
    },
        ...
        blanks: [
          {
            ...
            answer: 1,
            why: { en: "The company delivers (届ける) → humble お届けいたしました." },
          },
          {
            options: ["おります", "いたします", "{存|ぞん}じます", "申し上げます"],
            answer: 0,
            why: { en: "万全を期しております = humble 期しています (ongoing state)." },
          },
          {
            options: ["{存|ぞん}じましたら", "ございましたら", "ご{覧|らん}に{入|い}れましたら", "いたしましたら"],
            answer: 1,
            why: { en: "不良品などがありましたら → polite ございましたら (the clip note of #77)." },
          },
          {
            options: ["ございます", "おります", "まいります", "申し上げます"],
            answer: 3,
            why: { en: "Fixed phrase: 〜くださいますようお願い申し上げます (#75)." },
          },
        ],
      },
    },
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          {
            script: [
              { sp: "M", v: "m", ja: "では、{明日|あす}3時に{当社|とうしゃ}へお{越|こ}しください。" },
            ],
          ...
          {
            script: [
              { sp: "F", v: "f", ja: "部長、トニー{株式会社|かぶしきがいしゃ}の{山本|やまもと}様が{受付|うけつけ}にお見えです。" },
            ],
            options: ["トニー{株式会社|かぶしきがいしゃ}の部長は{山本|やまもと}さんじゃないよ。", "あ、そう。{受付|うけつけ}に見えるよ。", "あ、そう。じゃ、すぐ行くよ。"],
            answer: 2,
