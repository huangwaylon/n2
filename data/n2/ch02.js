  ...
  parts: [
    {
      ...
      points: [
        ...
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜をはじめ」は、{代表的|だいひょうてき}な例を出して、「〜だけでなくほかにもたくさん」と言いたいときに使う。", en: "Use \"〜をはじめ\" when you want to say \"not just 〜, but many others\" by giving a typical examples." },
          ...
          practice: [
            {
              ...
              left: ["この映画専門学校は、校長をはじめ、", "このスパイスはタイをはじめ、", "一人{暮|ぐ}らしには{電子|でんし}レンジをはじめ、", "ジャケットをはじめ、"],
              right: ["この春の{新作|しんさく}が{入荷|にゅうか}いたしましたので、ぜひご来店ください。", "{様々|さまざま}な電気{製品|せいひん}が{必要|ひつよう}だ。", "多くの{著名人|ちょめいじん}が{講師|こうし}をしている。", "{東南|とうなん}アジアなどで広く使われている。"],
              answer: [2, 3, 1, 0],
              en: ["At this film school, many well-known people, starting with the principal, work as instructors.", "This spice is widely used in Thailand and elsewhere in Southeast Asia.", "When living alone, you need all sorts of electrical appliances, a microwave first of all.", "This spring's new items, jackets among them, have arrived, so please do come and visit our store."],
            },
          ],
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「{教授|きょうじゅ}のもと」のように、「何か大きい{影響力|えいきょうりょく}のあるものの下で」というときや「{協力|きょうりょく}のもと」のように、「その{条件|じょうけん}や{状況|じょうきょう}の中で」と言いたいときに使う。", en: "Use this expression when you want to say that something is \"under someone with some great influence\" as in \"{教授|きょうじゅ}のもと\", or when you want to say that something is \"under certain conditions or a situation\" as in \"{協力|きょうりょく}のもと\"." },
          forms: ["[N] + のもと（で／に）"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜はもとより」は、スピーチ・プレゼンテーションなどで「〜はもちろん、〜だけでなくそのほかにも」と説明したいときに使う。", en: "Use \"〜はもとより\" when you want to explain in a speech, presentation or the like that \"〜\" is obvious, or that it is not only \"〜\" but also something more." },
          forms: ["[N] + はもとより"],
          examples: [
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "{誰|だれ}でもそう思う、{絶対|ぜったい}正しいと思っている{話者|わしゃ}の{判断|はんだん}を表す。注意や{命令|めいれい}になることもある。{偉|えら}そうな感じがするので、{目上|めうえ}の人には使わないほうがいい。親しい人との会話では、「もんだ」が使われる。", en: "This expresses the speaker's judgment that anyone would think so or that the speaker thinks it is absolutely correct. You should not use this when speaking to a higher ranking person as it can sound bossy. \"もんだ\" is used in conversation with a familiar person." },
        ...
        },
        {
          ...
          stars: 3,
          marks: ["formal"],
          usage: { ja: "「〜{上|うえ}で…」は、「〜をするとき（…が{重要|じゅうよう}だ・{必要|ひつよう}だ）」と言いたいときに使われる。", en: "\"〜{上|うえ}で…\" is used when you want to say that \"(something is important or required) when doing something\"." },
          forms: ["[V-る] + {上|うえ}で"],
          examples: [
    ...
    },
    {
      ...
      points: [
              ...
              items: [
                {
                  ...
                  why: { en: "A clause (日々、経済活動を行っている) follows, not a noun, so the linking form として is needed." },
                },
                {
                  ...
                  why: { en: "The noun グループ follows directly, so the noun-modifying とする is needed." },
                },
                {
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「きっかけ」は、何かが始まったり、変わったりしたときに、その{原因|げんいん}・理由になった{出来事|できごと}を表すときに使う。", en: "Use \"きっかけ\" to express the factor or reason for why something happened that led to a new beginning or change." },
          forms: [],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                { q: "雨はほとんどやむことなく、（　）。", options: ["5日間降り続いた", "川の水があふれた"], answer: 0, en: "The rain kept falling for five days with hardly a break." },
                {
                  ...
                  options: ["大きなけがをした", "元気に{暮|く}らしている"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["捨てられているということだ", "おなかがすいているということだ"],
                  answer: 0,
  ...
  review: [
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            options: ["くらい", "を{目的|もくてき}に", "をはじめ", "のもとで"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["を{問|と}わず", "を{通|つう}じて", "を中心として", "をもととして"],
            answer: 2,
    ...
    },
    {
      ...
      ex: {
        ...
        en: ["Everyone, thank you very much for gathering here today for us, the ABK University ekiden team.", "Our ekiden team has trained hard without taking a single day off, aiming to take part in the Hakone Ekiden. I don't think we put in less effort than the runners of other universities, but unfortunately, until now our school had never won the right to compete in the Hakone Ekiden. But this year, which for me is my last year of university life, we have finally been able to make our dream come true. I hope that, with this appearance as a springboard, the ekiden team will be able to grow a great deal.", "For the sake of everyone who has supported us so far, starting with our coach, all of us runners intend to do our very best. Everyone, we ask for your continued support.", "*箱根駅伝: Tokyo-Hakone Round-Trip College Ekiden Race\nTen runners will take turns running a relay from Tokyo to Hakone and back again in a traditional intercollegiate competition held annually on January 2nd and 3rd."],
        items: [
          {
        ...
        items: [
          {
            ...
            en: ["A woman is speaking.", "I worked for ten years in the field of welfare, at places such as nursing homes for the elderly, and received all kinds of questions from the people themselves and their families. All that time, I kept thinking it would be nice if there were something that explained welfare in an easy-to-understand way. So this time I gathered together the things you all wonder about and made this guidebook. I hope this book will be an opportunity for you all to think about welfare.", "That she has worked in the field of welfare", "That she has been asked questions by families", "Why she wrote the book", "Everyone's expectations of welfare"],
          ...
          },
          {
            ...
            en: ["A woman is speaking.", "This group is a volunteer organization formed mainly by homemakers. We aim to improve the local environment and create a town where both children and the elderly can live with peace of mind. We would like as many people as possible to take part so that, working together, we can contribute to building a pleasant town to live in. Even if you are not a homemaker, if you are interested in this activity, please do join us.", "To form a volunteer group", "To improve the local environment", "To recruit new members", "To take part in volunteer activities"],
