      ...
      points: [
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "お知らせなどで「{雨天|うてん}につき中止」のように理由を言うときに使われる。", en: "This is used to state a reason in an announcement and the like, as in “{雨天|うてん}につき中止”." },
          forms: ["[N] + につき"],
          examples: [
          ...
          practice: [
            {
              ...
              answer: [3, 2, 1, 0],
              en: ["Because of employee training on October 20, we will be temporarily closed.", "Because it is the campaign period, there is no enrollment fee.", "Because this is a perishable item, please eat it as soon as possible.", "Because the elevator is under inspection, please use the stairs."],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「だけ」という意味で、お知らせなどによく使われる。", en: "This is often used to mean “only / just” in an announcement and the like." },
        ...
        },
        {
          ...
          stars: 3,
          marks: ["formal"],
          usage: { ja: "「〜に{応|おう}じ…」は、「{希望|きぼう}・{変化|へんか}・{地域|ちいき}・{状況|じょうきょう}・{年齢|ねんれい}・{能力|のうりょく}・{経験|けいけん}などの{条件|じょうけん}に合わせて…する」と言いたいときに使う。", en: "Use “〜に{応|おう}じ…” when you want to say that something “depends on conditions such as a desire, change, location, situation, age, ability or experience.”" },
              ...
              items: [
                {
                  ...
                  options: ["に{応|おう}じて", "に{限|かぎ}って", "について"],
                  answer: 0,
                ...
                { q: "{習慣|しゅうかん}は国（　）違う。", options: ["によって", "に{応|おう}じて", "に対して"], answer: 0, en: "Customs differ from country to country." },
                {
                  ...
                  options: ["に{応|おう}じて", "に{限|かぎ}って", "{向|む}きに"],
                  answer: 0,
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜にかかわらず…」は、「{天候|てんこう}・{好|この}み・{地位|ちい}や、あるなし・するしないなどの{条件|じょうけん}に{関係|かんけい}なく…」と言いたいときに使われる。", en: "“〜にかかわらず…” is used when you want to say “regardless of conditions such as weather, preference, social position, or whether something is there or not there, done or not done, etc.”" },
          forms: ["[N] + にかかわらず", "[V-る] + [V-ない] + にかかわらず"],
          formNotes: [
            { ja: "「好き嫌い」「いい悪い」「{善悪|ぜんあく}」など、形容詞、名詞の{対立|たいりつ}する2語を合わせて使われることもある。", en: "This is also used in combination with pairs or opposite adjectives or nouns such as “好き嫌い”, “いい悪い” and “{善悪|ぜんあく}”." },
          ],
          examples: [
          ...
          practice: [
            {
              ...
              answer: [3, 0, 1, 2],
              en: ["Whether or not you understand the content, if you keep listening every day, you will definitely see results after three months.", "Regardless of the size of your baggage, we will keep it for ¥100 per item.", "Regardless of the amount, we would be grateful for any donation.", "Whether or not there is a malfunction, we recommend an inspection once a year."],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜{際|さい}」は、「〜場合」という意味で、説明書や案内などで使われる。後ろに「してください・{必要|ひつよう}です・お願いします」などの文が来ることが多い。", en: "“〜{際|さい}” is used in manuals, guides and the like to mean “if / when 〜”. Phrases such as “してください・{必要|ひつよう}です・お願いします” often come afterward." },
          ...
          plus: [
            {
              ...
              stars: 2,
              marks: ["formal"],
              usage: { ja: "「[N] + に{際|さい}して」の形もあり、注意やおわび、説明などの文に使われる。", en: "Another form is “[N] + に{際|さい}して”. It is used in sentences such as warnings, apologies, explanations and the like." },
              examples: [
          ...
          practice: [
            {
              ...
              left: ["このファイルを開ける{際|さい}は、", "{離着陸|りちゃくりく}の{際|さい}には、", "{地震|じしん}や{火災|かさい}などが{発生|はっせい}した{際|さい}には、", "{携帯|けいたい}電話のご{契約|けいやく}の{際|さい}は、", "{雨天|うてん}の{際|さい}、"],
              right: ["スポーツ大会は{屋内|おくない}で{行|おこな}います。", "パスワードを{入力|にゅうりょく}してください。", "{身分|みぶん}{証明書|しょうめいしょ}が{必要|ひつよう}です。", "シートベルトの{着用|ちゃくよう}をお願いします。", "この{非常|ひじょう}ボタンを{押|お}してください。"],
              answer: [1, 3, 4, 2, 0],
              en: ["When opening this file, please enter the password.", "During takeoff and landing, please wear your seat belt.", "In the event of an earthquake, fire or the like, please press this emergency button.", "When signing a mobile phone contract, you need identification.", "In case of rain, the sports meet will be held indoors."],
            },
          ],
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "{規則|きそく}や注意{事項|じこう}を説明するときに使う。", en: "This is often used to explain a rule or warning." },
          ...
          practice: [
            {
              type: "match",
              prompt: { ja: "", en: "Match each beginning (1–4) with the correct ending (a–d)." },
              left: ["{履歴書|りれきしょ}の{記入|きにゅう}は、", "{危険|きけん}なので、", "外出するときは、", "ごみを出すときは、"],
              right: ["プールサイドでは走らないこと。", "きちんと{分別|ぶんべつ}すること。", "黒のボールペンを使用のこと。", "{必|かなら}ずエアコンを消すこと。"],
              answer: [2, 0, 3, 1],
              en: ["Fill in your résumé using a black ballpoint pen.", "It is dangerous, so do not run by the pool.", "When you go out, be sure to turn off the air conditioner.", "When you put out the garbage, sort it properly."],
            },
          ],
        },
      ],
  ...
  review: [
        ...
        items: [
          {
            ...
            options: ["に{限|かぎ}って", "に{応|おう}じて", "にかわり", "において"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["を{問|と}わず", "の{際|さい}は", "に{限|かぎ}り", "に{応|おう}じて"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["に応じて", "に{限|かぎ}り", "にかかわらず", "につき"],
            answer: 2,
    ...
    },
    {
      ...
      ex: {
        ...
        en: ["Seeing a film in Japan usually costs about 1,800 yen, but cinemas offer special deals besides the regular price.", "On \"Movie Day,\" the 1st of every month, it is 1,000 yen for anyone, regardless of age or gender. Some cinemas also offer tickets for 1,000 yen on Wednesdays, for women only.", "Also, when either member of a married couple is 50 or older, the two of them can always get in for 2,000 yen. However, you must show ID when buying the tickets.", "In addition, inside the cinema there is also a service that lends out blankets and cushions."],
        blanks: [
        ...
        items: [
          {
            ...
            en: ["You are listening to an announcement from an international students' center.", "This is an announcement from the Yokota International Student Center. On Saturday, March 10, from 2 p.m., we will hold an event called \"Let's interact with international students in English.\" You will be divided into groups according to your level and interact with about 15 international students from various countries. Anyone aged 16 or over is welcome to take part, regardless of age or occupation. However, if there are many applicants, local residents will be given priority, so others should contact the Yokota International Student Center directly. The participation fee is 500 yen, to cover tea. Please pay when you come to the center on the day. Capacity is 40 people. The phone number is...", "Hey, this event looks interesting.", "Huh? Oh, the student center — that's the place that always runs cooking classes. Wow, English, huh.", "Yeah. You're always saying you never get a chance to speak English, right?", "That's true. It says \"according to your level,\" so maybe even I'd be OK? Well then, shall we go?", "Right. Why don't you go?", "What? You're not coming with me?", "That day's a bit difficult for me.", "OK. Well, I'll go and do my best."],
