      ...
      points: [
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「{犯行|はんこう}時間に一緒に飲んでいたことにしてくれ」のように、自分に{都合|つごう}のいいように{事実|じじつ}を変えて言うときに使われる。", en: "This is often used when you alter the facts to suit your situation as in \"{犯行|はんこう}時間にいっしょに飲んでいたことにしてくれ\"." },
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜つもり」は、{周囲|しゅうい}の{評価|ひょうか}や{事実|じじつ}はともかく、「本人は〜と思っている」と言いたいときに使う。", en: "Use \" 〜つもり \" when you want to say \"he or she is thinking 〜 \", not about what others think or the facts." },
          ...
          practice: [
            {
              ...
              left: ["レポートを出す前にちゃんとチェックしたつもりだったのに、", "{目|め}{覚|ざ}まし{時計|どけい}を7時にセットしたつもりだったが、", "{冗談|じょうだん}のつもりで言った言葉が、", "子どものときからの友達だから、何でも知っているつもりだったが、"],
              right: ["{突然|とつぜん}会社をやめて外国へ行くと言われて{驚|おどろ}いた。", "先生から漢字が間違っていると言われた。", "{鳴|な}ったのは8時で、{遅刻|ちこく}してしまった。", "相手を{傷|きず}つけることがあるので注意しましょう。"],
              answer: [1, 2, 3, 0],
              en: ["I thought I had checked my report properly before handing it in, but the teacher told me some kanji were wrong.", "I thought I had set my alarm clock for 7, but it went off at 8 and I was late.", "Words you say meaning them as a joke can sometimes hurt the other person, so be careful.", "We've been friends since we were kids, so I thought I knew everything about him, but I was surprised when he suddenly told me he was quitting his job and going abroad."],
            },
          ],
        },
        {
          ...
          stars: 2,
          marks: ["regret"],
          usage: { ja: "「〜てならない」は、「{非常|ひじょう}に〜だ」と言いたいときに使われる。", en: "\" 〜てならない \" is used when you want to say something \"is extremely 〜 \"." },
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "{現実|げんじつ}には{無理|むり}だと思っていることを強く{希望|きぼう}するときに使う。会話では「もんなら」になる。", en: "Use this when you very much want something that you actually think is impossible. It becomes \" もんなら \" in casual conversation." },
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "どうしようか{迷|まよ}っていると言いたいときに使う。", en: "Use this when you want to say you are uncertain about what to do." },
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜{末|すえ}…」は、「長い間〜をして（最後に…という{結果|けっか}になった）」と言いたいときに使う。{実際|じっさい}に長くなくても、{話者|わしゃ}にとって「長く感じられた」という場合にも使う。", en: "Use \" 〜{末|すえ}… \" when you want to say \"after doing 〜 for a long time (in the end the result was …)\" You can also use it even if it did not take a long time because it \"felt long\" to the speaker." },
      ...
      points: [
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「たとえ〜ても」は、「もし〜ても」という意味で、「どんな場合でも」と強く言いたいときに使う。", en: "Use \"たとえ〜ても\", meaning \"even if 〜\", when you want to strongly say \"no matter what situation.\"" },
          ...
          practice: [
            {
              ...
              left: ["たとえ{嫌|きら}いなものが入っていても、", "たとえどんなに難しい試験でも、", "たとえ{治療費|ちりょうひ}がいくらかかっても、", "たとえお{世辞|せじ}だとわかっていても、"],
              right: ["{命|いのち}が助かるなら、かまいません。", "あきらめないで{努力|どりょく}すべきだ。", "ほめられればうれしいものだ。", "{愛|あい}する彼女が作ったものは{残|のこ}さず食べる。"],
              answer: [3, 1, 0, 2],
              en: ["Even if it has something I dislike in it, I'll eat every last bit of anything my beloved girlfriend makes.", "No matter how difficult the exam, you should keep working hard and not give up.", "No matter how much the treatment costs, I don't mind, as long as it saves their life.", "Even when you know it's just flattery, being praised makes you happy."],
            },
          ],
        },
        {
              ...
              items: [
                {
                  ...
                  options: ["{理解|りかい}しがたい", "{理解|りかい}する{恐|おそ}れがある"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["{否定|ひてい}しがたい", "{否定|ひてい}にすぎない"],
                  answer: 0,
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜もかまわず…」は、「{普通|ふつう}は気にしたほうがいいことを、{無視|むし}して…する」と言いたいときに使う。{批判的|ひはんてき}に使うことが多い。", en: "Use \"〜もかまわず…\" when you want to say \"do … while ignoring that it is something one would normally be concerned about.\" It is often used to criticize." },
          forms: ["[N] + もかまわず"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["regret"],
          usage: { ja: "「〜あまり…」は、「{非常|ひじょう}に〜で（…の{結果|けっか}になった）」と言いたいときに使う。よくない{結果|けっか}のときに使うことが多い。", en: "Use \"〜あまり…\" when you want to say someone \"did … an extreme amount, which resulted in 〜\". It is often used when the result is not good." },
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["新しいことに{挑戦|ちょうせん}する", "何も{改革|かいかく}をしない"],
                  answer: 1,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "プラスイメージの言葉を{重|かさ}ねて「よい点が多くある」と言うときと、マイナスイメージの言葉を{重|かさ}ねて、「悪い点が多くある」と言うときに使われる。「家で食べる日もあれば外で食べる日もある」のように、「いろいろある」という意味を表すこともある。", en: "This is used with positive words to say there are many good points about something, or with negative words to say there are many bad points about something. It can also express variety as in \"家で食べる日もあれば外で食べる日もある\"." },
  ...
  review: [
        ...
        items: [
          {
            ...
            options: ["くやしいようになっている", "くやしかったつもりだ", "くやしくてならなかった", "くやしいおそれがあった"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["{失敗|しっぱい}しなければ", "{失敗|しっぱい}したくないので", "{失敗|しっぱい}しても", "{失敗|しっぱい}したのに"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["を{問|と}わず", "をきっかけに", "を{込|こ}めて", "をもとに"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["{興奮|こうふん}することなく", "{興奮|こうふん}するどころか", "{興奮|こうふん}するからには", "{興奮|こうふん}のあまり"],
            answer: 3,
    ...
    },
    {
      ...
      ex: {
        ...
        title: "",
        text: ["リリーは、{子犬|こいぬ}のころ目の病気になり、目が見えなくなった。そんなリリーのためにマディソンは「{盲導犬|もうどうけん}」を引き受けて、いつもリリーを{気遣|きづか}い[1]歩いていた。2{匹|ひき}は{散歩|さんぽ}[2]一緒なら寝るのも一緒だった。そんな2{匹|ひき}を{温|あたた}かく{見守|みまも}っていた{飼|か}い{主|ぬし}だったが、家の{事情|じじょう}で2{匹|ひき}を犬の{保護|ほご}センターに{預|あず}けなければならなくなった。「できる[3]この2{匹|ひき}をずっと一緒にいさせてやりたい」と、センターのスタッフは新しい{飼|か}い{主|ぬし}を探した。", "この話が{報道|ほうどう}されると、多くの{視聴者|しちょうしゃ}から「[4]どんなことがあっても2{匹|ひき}を{引|ひ}き{離|はな}さないで」といったコメントがいくつも{寄|よ}せられた。その中には{新|あら}たな{飼|か}い{主|ぬし}として声をあげる人もいる。2{匹|ひき}は、まもなく一生を{過|す}ごせる家を見つけ、{幸福|こうふく}な日を送るようになるだろう。"],
        en: ["When Lily was a puppy, she got an eye disease and went blind. For Lily's sake, Madison took on the role of \"guide dog\" and always walked with her while looking out for her. The two went on walks together and slept together too. Their owner had been watching over the two warmly, but because of family circumstances had to leave them at a dog shelter. \"If at all possible, we want to let these two stay together forever,\" said the shelter staff, and they looked for a new owner.", "When this story was reported, many viewers sent in comments such as \"Whatever happens, please don't separate the two.\" Some of them even came forward as new owners. The two will probably soon find a home where they can spend the rest of their lives and begin living happily."],
        blanks: [
          {
            options: ["がたく", "つつ", "ぬいて", "らしく"],
            answer: 1,
        ...
        items: [
          {
            ...
            en: ["A film director is talking on TV.", "Director, what is your new film like?", "I want to say, \"Don't give up on life.\" I hope I can convey that no matter how hard things get, if you keep trying, good things will happen too.", "I see.", "In the first half, I'd like viewers to watch while sympathizing with the main character, and from the second half on, I think they'll enjoy a fast-paced story with both mystery and action scenes.", "I see. We're looking forward to the release. Thank you very much.", "Not giving up on life", "That the main character leads a hard life", "Enjoying the search for the culprit in the mystery", "That the action has a sense of speed"],
