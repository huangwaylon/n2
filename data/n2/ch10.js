  ...
  parts: [
    {
      ...
      sample: {
        ...
        lines: [
          ...
          { cont: true, ja: "{満員|まんいん}電車にストレスを感じない人はいる**まい**。", en: "Surely there is no one who doesn't feel stressed on a packed train." },
          { cont: true, ja: "{日々|ひび}{耐|た}えている{乗客|じょうきゃく}を見る**につけ**、みんな何と{我慢強|がまんづよ}いのだろうと思う。", en: "Whenever I see the passengers enduring it day after day, I think how patient they all are." },
          { cont: true, ja: "まるで何かの{訓練|くんれん}をしているかのようだ。", en: "It's as if they were going through some kind of training." },
          { ja: "朝のホームでは、いつも同じ場所に立つ。", en: "On the platform in the morning, I always stand in the same spot." },
          { cont: true, ja: "この{路線|ろせん}にはいくつか高校があり、{階段|かいだん}の近くに止まるこの{車両|しゃりょう}には高校生がたくさん乗っている。", en: "There are several high schools along this line, and lots of high school students ride in this car, which stops near the stairs." },
          { cont: true, ja: "だからこの{車両|しゃりょう}は{混|こ}んでいる**わりに**は座れるチャンスがあるのだ。", en: "So even though this car is crowded, you have a better chance of getting a seat than you'd expect." },
          { ja: "電車がホームに入ってきた。", en: "The train pulled into the platform." },
          { cont: true, ja: "ドアが開いた。", en: "The doors opened." },
          { cont: true, ja: "押されながら乗り込み、座っている高校生の前に立つ。", en: "Getting pushed, I squeeze on and stand in front of a seated high school student." },
        ],
      },
      points: [
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜ものがある」は、「〜感じがする」と言いたいときに使う。「{具体的|ぐたいてき}に何とは言えないが、そう思われる{要素|ようそ}がある」と言うときにも使われる。", en: "Use \"〜ものがある\" when you want to say something \"seems 〜.\" This expression is used when something makes you think a certain way, but you cannot say exactly what it is." },
          forms: ["[Pl] + ものがある\n［[なA~~だ~~]な　~~[N]だ~~］\n［{現在形|げんざいけい}だけ］"],
          examples: [
              ...
              items: [
                {
                  ...
                  why: { en: "〜かねない = a bad outcome is quite possible, which follows from 正直すぎる. まい would mean it's very unlikely." },
                },
                {
                  q: "この{天候|てんこう}では、明日の{登山|とざん}は（　）。{残念|ざんねん}だがしかたがない。",
                  options: ["中止するしかあるまい", "中止するわけではない"],
                  answer: 0,
                ...
                },
                {
                  ...
                  why: { en: "〜わけではない = \"it is not that ~\" (a partial denial of an assumption); the が that follows introduces the real reason. まい is a prediction and does not fit here." },
                },
              ],
            },
          ],
        ...
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「この部屋は、広いわりに{家賃|やちん}が安い」のように「〜わりに…」の形で、「〜から{当然|とうぜん}考えられる{程度|ていど}（広ければ{家賃|やちん}が高い）と{比|くら}べれば…である（{家賃|やちん}が安い）」と言いたいときに使う。", en: "As in \"この部屋は、広いわりに{家賃|やちん}が安い\", use the \"〜わりに…\" form when you want to say that compared to what one would normally think from \" 〜 (a spacious apartment is expensive), something is less or more so (the rent is cheap).\"" },
          forms: ["[Pl] + わりに\n［[なA~~だ~~]な　[N~~だ~~]の］"],
          examples: [
          ...
          practice: [
            {
              ...
              left: ["このかばんは{値段|ねだん}が{手|て}ごろなわりに、", "{準備|じゅんび}の時間があまりなかったわりには、", "大きな{事故|じこ}だったわりに、", "この1か月忙しかったわりに、"],
              right: ["うまくスピーチができた。", "たいしたけがもせず、よかったですね。", "もうけは少なかった。", "{高級感|こうきゅうかん}があるし、使いやすそうだね。"],
              answer: [3, 0, 1, 2],
              en: ["This bag is reasonably priced, but it has a luxurious feel and looks easy to use.", "Considering I didn't have much time to prepare, I gave the speech well.", "For such a big accident, it's good that you weren't seriously hurt.", "Considering how busy it's been this past month, the profits were small."],
            },
          ],
        },
      ],
    ...
    },
    {
      ...
      points: [
        ...
        },
        {
          ...
          stars: 1,
          marks: ["casual"],
          usage: { ja: "「AやらBやら」は、「AやBなど」「AたりBたり」と同じ意味で、例をあげて、いろいろあって大変だったり{驚|おどろ}いたりした気持ちを表す。どちらかはっきりわからないことを表す場合もある。", en: "\"AやらBやら\" has the same meaning as \"AやBなど\" and \"AたりBたり\" by give examples and expresses a sense of adversity or surprise for various reasons. It is also used to express that you are not quite sure which is the reason." },
        ...
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "{状況|じょうきょう}が急に変わったことを{強調|きょうちょう}して説明するときに使う。自分のことを説明するときには使わない。", en: "Use this when you emphasize that a situation has suddenly changed. Do not use it to explain about yourself." },
        ...
        items: [
          {
            ...
            options: ["かと思ったら", "かのように", "といっても", "からといって"],
            answer: 0,
          ...
          },
          {
            ...
            options: ["かと思うと", "かのように", "{限|かぎ}り", "わりに"],
            answer: 1,
    ...
    },
    {
      ...
      ex: {
        ...
        blanks: [
          ...
          {
            options: ["まい", "ものがある", "かのようだ", "わけにはいかない"],
            answer: 0,
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          {
            script: [
              { sp: "M", v: "m", ja: "あーあ、さっき皿を{割|わ}ったかと思ったら、またやっちゃったよ。" },
            ],
            en: ["Oh no, I just broke a plate a moment ago, and now I've gone and done it again.", "What did you do this time?", "That's good.", "Well then, let's get it done."],
          ...
          {
            script: [
              { sp: "F", v: "f", ja: "昨日はテスト全部書けたって{得意|とくい}げな顔してたのに、どうしたの？" },
            ],
            en: ["Yesterday you looked so proud, saying you'd answered everything on the test. What happened?", "Yeah, I'm not good at it.", "Actually, it turned out to be a total failure.", "Yeah, it was a good result."],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "昨日駅前のカラオケに行ったんだけど、あそこにはもう二度と行くまいと思ったよ。" },
            ],
            en: ["I went to the karaoke place in front of the station yesterday, and I decided I'll never go there again.", "What? You're going again?", "What? You didn't go a second time?", "What? Did something happen?"],
