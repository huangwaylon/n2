          ...
          practice: [
            {
              ...
              left: ["みどり市では工場{誘致|ゆうち}を{喜|よろこ}ぶ市民がいる{一方|いっぽう}、", "{大都市|だいとし}で人口が{増加|ぞうか}する{一方|いっぽう}、", "{長年|ながねん}1つの仕事を続けて{成果|せいか}を上げる人がいる{一方|いっぽう}、", "彼は{俳優|はいゆう}として{活躍|かつやく}する{一方|いっぽう}、"],
              right: ["人口{減少|げんしょう}が進む{地域|ちいき}もあり、{政府|せいふ}は{対策|たいさく}を{検討|けんとう}している。", "最近は映画{監督|かんとく}としても{注目|ちゅうもく}されている。", "{環境保護|かんきょうほご}の{立場|たちば}から{慎重|しんちょう}に考えるべきだという意見もある。", "{転職|てんしょく}から多くの{経験|けいけん}を{得|え}て{才能|さいのう}を{伸|の}ばす人もいる。"],
              answer: [2, 0, 3, 1],
              en: ["In Midori City, while some residents welcome the attracting of factories, others are of the opinion that it should be considered carefully from the standpoint of environmental protection.", "While the population is growing in big cities, there are also regions where the population is steadily declining, and the government is considering countermeasures.", "While some people achieve results by continuing in one job for many years, others develop their talents by gaining a lot of experience from changing jobs.", "While he is active as an actor, he has recently also been attracting attention as a film director."],
            },
          ],
        },
        {
              ...
              items: [
                {
                  ...
                  options: ["{部下|ぶか}の意見に耳を{傾|かたむ}けることもできる人だ", "{部下|ぶか}の意見を聞かないで、自分の考えで仕事をする人だ"],
                  answer: 0,
    ...
    },
    {
      ...
      points: [
        ...
        },
        {
          ...
          stars: 3,
          marks: ["formal"],
          usage: { ja: "「〜について」と同じように、{話題|わだい}にしたり、調べたりする内容を言うときに使う。{調査|ちょうさ}や研究、{通知|つうち}などでよく使う。", en: "Just like \"〜について\", use this when you introduce a topic or say what someone is investigating. This is often used in surveys, research, notifications and the like." },
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「日本の人口は{減|へ}りつつある」のように少しずつ{変化|へんか}していると説明するときに使う。", en: "Use this to explain that something is changing little by little as in \"日本の人口は{減|へ}りつつある\"." },
          forms: ["[V-~~ます~~] + つつある"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜に{限|かぎ}らず」は、「〜だけでなく、ほかにも」と言いたいときに使う。", en: "Use \"〜に{限|かぎ}らず\" when you want to say \"not just 〜, but also something else.\"" },
          forms: ["[N] + に{限|かぎ}らず"],
          examples: [
        ...
        items: [
          {
            ...
            options: ["に{関|かん}して", "に{反|はん}して", "のみならず", "からいうと"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["から見ると", "に{関|かん}して", "にしたがって", "のみならず"],
            answer: 0,
          ...
          },
          {
            ...
            options: ["からいうと", "に{限|かぎ}る", "に{関|かん}する", "にわたる"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["に{反|はん}して", "に{比|くら}べて", "のみならず", "にもかかわらず"],
            answer: 2,
          ...
          },
          {
            ...
            options: ["{一方|いっぽう}", "{次第|しだい}", "{際|さい}", "{限|かぎ}り"],
            answer: 0,
          ...
          },
          {
            ...
            options: ["のみならず", "ことから", "にもかかわらず", "ものの"],
            answer: 1,
        ...
        items: [
          {
            ...
            en: ["The president of an electronics store is talking with an employee.", "Boss, Ace Electric across from the station is having a discount sale again. Let's have a discount sale too!", "Even if I wanted to, making things any cheaper is impossible from a business standpoint. So instead, I want to compete on service. Right now we only have a repair service...", "It'd have to be something other stores don't do, wouldn't it?", "A lot of our customers are older, right? Can't we come up with something from that angle?", "Understood. We'll all think about it.", "A price-cut sale", "The shop's financial situation", "A new service", "A repair service"],
        ...
        items: [
          {
            ...
            en: ["At a lecture, a teacher is talking about when to study.", "Recently more people are getting up early in the morning to study, but when is it actually most effective to study? Today we will hear from Professor Honda, who specializes in brain science.", "It's certainly true that concentration is higher in the morning. However, in terms of memory, we know that while we sleep, the human brain replays what it experienced that day and strengthens the memories. What it replays in particular is information from the period just before going to sleep. From this, we can say that study that requires memorization is more effective if done at night before bed. Even just getting into bed and closing your eyes helps the brain organize information.", "So this means studying before bed makes things sink in better, right? Studying for exams is at night after all. I wasn't wrong.", "But if you get up early to study, your head is clear and you can concentrate, so I like that...", "I'll keep studying the way I always have. But you don't have to force yourself to change, do you?", "I guess. I'll keep up my morning routine, and then review once more at night before going to bed. That way I'll be able to remember even more, right?", "Ms. Nakata, you're so diligent."],
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          {
            script: [
              { sp: "M", v: "m", ja: "これ、{宇宙人|うちゅうじん}の写真だって。でもあり{得|え}ない話じゃないよね。" },
            ],
