  ...
  parts: [
    {
      ...
      points: [
          ...
          practice: [
            {
              ...
              left: ["{家事|かじ}は{苦手|にがて}だが、一人{暮|ぐ}らしを始めたら、", "本校ではバイク{通学|つうがく}を{認|みと}めていましたが、{事故|じこ}が続いたため、", "彼は{肩|かた}を{痛|いた}めたことで", "{取引先|とりひきさき}から{頼|たの}まれたら、"],
              right: ["プロ野球選手になる{夢|ゆめ}をあきらめざるを{得|え}なかった。", "{無理|むり}な{注文|ちゅうもん}でも受けざるを{得|え}ない。", "全部自分でやらざるを{得|え}ない。", "{禁止|きんし}せざるを{得|え}なくなりました。"],
              answer: [2, 3, 0, 1],
              en: ["I'm bad at housework, but once I started living on my own, I had no choice but to do it all myself.", "Our school used to allow students to commute by motorbike, but because accidents kept happening, we had no choice but to ban it.", "Because he injured his shoulder, he had no choice but to give up his dream of becoming a professional baseball player.", "If a client asks us, we have no choice but to accept even an unreasonable order."],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          stars: 2,
          marks: ["regret"],
          usage: { ja: "「今の{状況|じょうきょう}から{判断|はんだん}すると、悪い{結果|けっか}が{予想|よそう}される」と言いたいときに使う。{客観的|きゃっかんてき}に見るとという{判断|はんだん}が入っていることが多い。", en: "Use this when you want to say that “judging from the current situation, a bad result is expected.” It often includes a judgment based on an objective view." },
          forms: ["[V-~~ます~~] + かねない"],
          examples: [
          ...
          practice: [
            {
              ...
              answer: [1, 0, 3, 2],
              en: ["If you suddenly do strenuous exercise without even warming up, you could get injured.", "If you're not careful with online shopping, you could fall victim to fraud.", "If you push yourself when you have a cold, it could get worse, so you'd better take the day off work.", "If you tell Ito-san a secret, she might well tell the whole class."],
            },
          ],
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「AというよりB」は、「{涼|すず}しいというより寒い」のように、「Aの言い方（{涼|すず}しい）よりB（寒い）と言ったほうが{適切|てきせつ}だ」と言いたいときに使う。", en: "As in “{涼|すず}しいというより寒い”, use “AというよりB” when you want to say “it's more appropriate to say B (it's cold) than A (it's cool).”" },
          forms: ["[Pl] + というより\n［[なA~~だ~~]　[N~~だ~~]］"],
          examples: [
              ...
              items: [
                {
                  ...
                  options: ["{頼|たよ}ってはいられない", "{頼|たよ}らざるを{得|え}ない"],
                  answer: 0,
        ...
        items: [
          {
            ...
            options: ["{壊|こわ}してしょうがない", "{壊|こわ}さないはずだ", "{壊|こわ}しっこない", "{壊|こわ}さざるを{得|え}ない"],
            answer: 3,
          ...
          },
          {
            ...
            options: ["{与|あた}えざるを{得|え}ない", "{与|あた}えかねない", "{与|あた}えないところだ", "{与|あた}えっこない"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["として", "を{問|と}わず", "をはじめ", "はもとより"],
            answer: 0,
    ...
    },
    {
      ...
      ex: {
        ...
        blanks: [
          ...
          {
            options: ["{出社|しゅっしゃ}するというものでもない", "{出社|しゅっしゃ}しないはずだ", "{出社|しゅっしゃ}せざるを{得|え}ない", "{出社|しゅっしゃ}しないということだ"],
            answer: 2,
          },
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "すみません、ちょっとインタビューに答えてもらえませんか。" },
            ],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "おい、そんなにスピード出したら、{事故|じこ}を起こしかねないぞ。" },
            ],
