N2F({
  ...
  sample: {
    ...
    lines: [
      ...
      { ja: "＊{商品|しょうひん}の案内や{接客|せっきゃく}{応対|おうたい}があるため、外国人の方は、日本語能力試験N2レベル以上の方**に{限|かぎ}り**、{応募|おうぼ}{可|か}。", en: "* Because the job involves explaining products and dealing with customers, foreign applicants may apply only if they are at JLPT N2 level or above." },
      ...
      practice: [
        {
          ...
          items: [
            { q: "来週の{国際|こくさい}{交流|こうりゅう}{会|かい}は、{国籍|こくせき}、{職業|しょくぎょう}（　）どなたでも{参加|さんか}できます。", options: ["ばかりでなく", "に対して", "を{問|と}わず"], answer: 2, en: "Anyone can take part in next week's international exchange event, regardless of nationality or occupation." },
      ...
      practice: [
        {
          ...
          items: [
            ...
            { q: "お申し込みの{時期|じき}（　）、お届け{日|び}が変わりますのでご注意ください。", options: ["に{限|かぎ}り", "によって"], answer: 1, en: "Please note that the delivery date varies depending on when you apply." },
  ...
  check: [
    ...
    },
    {
      ...
      items: [
        ...
        { q: "入学後、{引|ひ}っ{越|こ}しした場合は学生課に住所{変更|へんこう}{届|とどけ}を{提出|ていしゅつ}する＿＿。", answer: "こと", en: "If you move after enrolling, submit a change-of-address form to the Student Affairs Office." },
