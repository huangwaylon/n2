      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the correct option." },
          items: [
            { q: "GDPを見ると、データ（　）{豊|ゆた}かになってきているわが国だが、国民の生活{水準|すいじゅん}は高いとは言えず、その{向上|こうじょう}が今後の{課題|かだい}だ。", options: ["{上|じょう}は", "の{上|うえ}に"], answer: 0, en: "Looking at GDP, our country has been growing richer on paper, but the people's standard of living can't be called high, and raising it is a challenge for the future." },
      ...
      practice: [
        {
          ...
          items: [
            ...
            { q: "こちらは新しい{化粧品|けしょうひん}で、これ（　）お{肌|はだ}が美しくなります。", options: ["だけあって", "だけで", "だけ"], answer: 1, en: "This is a new cosmetic; this alone will make your skin beautiful." },
