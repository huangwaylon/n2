      ...
      points: [
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜とか言っていた」などの形で、聞いた{情報|じょうほう}を言うときに使われる。{確|たし}かな{情報|じょうほう}ではないがという気持ちで使うことが多い。「言っていた」などの言葉を{省略|しょうりゃく}することもある。", en: "This is used in forms such as \"〜とか言っていた\" when you state information you have heard. It is often used with the nuance that the information may not be solid. You can also omit words such as \"言っていた\"." },
          forms: ["[Pl] + とか"],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["まず1ページ目をご{覧|らん}ください", "ご自由にご意見をおっしゃってください"],
                  answer: 0,
        ...
        },
        {
          ...
          stars: 2,
          marks: ["praise"],
          usage: { ja: "「〜にかけては」は、「〜の{分野|ぶんや}では」と{範囲|はんい}を{限定|げんてい}して、その{分野|ぶんや}では「最高レベルだ」「{自信|じしん}がある」などと言いたいときに使われる。", en: "\"〜にかけては\" is used when you want to say that when it comes to \"the field / subject area of 〜\", you have \"the highest level,\" are \"confident\" or the like." },
          forms: ["[N] + にかけては"],
          examples: [
              ...
              items: [
                {
                  ...
                  options: ["全国トップレベルだ", "1年生のときからアドバイスしている"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["{興味|きょうみ}を持っている", "すばらしい{才能|さいのう}を持っている"],
                  answer: 1,
          ...
          practice: [
            {
              ...
              left: ["道路を{整備|せいび}しないことには、", "{予算|よさん}が取れないことには、", "みんな{無理|むり}だと言うけど、やってみないことには、", "親が{心配|しんぱい}しても、{本人|ほんにん}がやる気にならないことには、"],
              right: ["{成績|せいせき}は上がらない。", "{新商品開発|しんしょうひんかいはつ}の{企画|きかく}は進められない。", "{観光客|かんこうきゃく}はこの町まで来てくれないだろう。", "だめかどうかわからない。"],
              answer: [2, 1, 3, 0],
              en: ["Unless the roads are improved, tourists probably won't come all the way to this town.", "Unless we can secure a budget, we can't move forward with the plan for developing new products.", "Everyone says it's impossible, but unless we try it, we won't know whether it's hopeless or not.", "No matter how much the parents worry, unless the child himself gets motivated, his grades won't improve."],
            },
          ],
        },
        {
          ...
          practice: [
            {
              type: "match",
              prompt: { ja: "", en: "Match each beginning (1–4) with the correct ending (a–d)." },
              left: ["コンビニへ行くと{余計|よけい}なものまで買ってしまいがちなので、", "親は子どものすることに口を出しがちだが、", "人は水のありがたさを忘れがちだが、", "{外食|がいしょく}では{栄養|えいよう}が{偏|かたよ}りがちなので、"],
              right: ["私は{砂漠|さばく}へ行って、{改|あらた}めてその大切さに気づいた。", "1回の買い物は500円までと決めています。", "最近{健康|けんこう}のことを考えて{自炊|じすい}する人が増えている。", "それでは子どもが{自立|じりつ}できない。"],
              answer: [1, 3, 0, 2],
              en: ["Since I tend to end up buying unnecessary things when I go to a convenience store, I've decided to limit each shopping trip to 500 yen.", "Parents tend to interfere in what their children do, but then the children can't become independent.", "People tend to forget how precious water is, but when I went to the desert, I realized anew how important it is.", "Since meals eaten out tend to be nutritionally unbalanced, more and more people these days are cooking for themselves with their health in mind."],
            },
          ],
        },
        {
      ...
      points: [
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜としたら…」は、「〜だと考えれば…」という意味で、自分の意見や{予想|よそう}を言いたいときに使う。", en: "Use \"〜としたら…\", meaning \"imagine if 〜, …,\" when you want to state a personal opinion or prediction." },
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「{忘年会|ぼうねんかい}は{予算次第|よさんしだい}で5つのコースから選べる」のように、「〜（{予算|よさん}）」によって決まることを表す。", en: "As in \"{忘年会|ぼうねんかい}は{予算次第|よさんしだい}で5つのコースから選べる\", this states that something is decided according to \"〜 (the budget).\"" },
          forms: ["[N] + {次第|しだい}"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["regret"],
          usage: { ja: "「〜{一方|いっぽう}」は、「{景気|けいき}が悪くなる{一方|いっぽう}だ」のように「〜の{状態|じょうたい}がどんどん進んでいく」と言いたいときに使う。", en: "Use \"〜{一方|いっぽう}\" when you want to say that \"situation 〜 is going to continue\" as in \"{景気|けいき}が悪くなる{一方|いっぽう}だ\"." },
          forms: ["[V-る] + {一方|いっぽう}"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜に{先立|さきだ}って」は、「〜の前に、何かが{行|おこな}われる」と言いたいときに使われる。", en: "\"〜に{先立|さきだ}って\" is used when you want to say \"something will be done before 〜\"." },
        ...
        },
        {
          ...
          stars: 3,
          marks: ["formal"],
          usage: { ja: "「〜{上|うえ}で」は、「〜してから」と同じ意味で使う。ただし、{日常的|にちじょうてき}な{話題|わだい}には使わない。", en: "\"〜{上|うえ}で\" has the same meaning as \"〜してから\". But do not use it to talk about a familiar topic." },
  ...
  review: [
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            options: ["売ってみる", "売ってみない", "使ってみる", "使ってみない"],
            answer: 3,
          ...
          },
          {
            ...
            options: ["において", "に{先立|さきだ}って", "にわたって", "につけ"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["にともなって", "に{先立|さきだ}って", "にしたがって", "にかけては"],
            answer: 3,
    ...
    },
    {
      ...
      ex: {
        ...
        en: ["Recently, \"selective eating disorder\", in which people eat only foods and nutritional supplements said to be good for their health, has been increasing rapidly. A characteristic is that the people themselves think they are eating things that are good for them, so they have no sense of danger at all. They tend to think that because vegetable juice and natto are \"good for the body\", as long as they eat those they can live healthily. But if you believe something is \"good for the body\" and eat only that, that is a big mistake.", "The fact that all sorts of nutritional supplements are being sold in response to the needs of health-conscious people may be one of the causes, but let's make sure to eat meals that are truly good for the body, after considering nutritional balance."],
        blanks: [
          {
            options: ["きり", "げ", "がち", "かけ"],
            answer: 2,
          ...
          {
            options: ["としたら", "{次第|しだい}で", "{上|うえ}で", "かと思うと"],
            answer: 2,
        ...
        items: [
          {
            ...
            en: ["At a university, a teacher is talking to students.", "Recently, not only in Japan but also in Europe, America and elsewhere, people have come to eat fish a lot. Unfortunately, however, it tends to be limited to certain fish such as tuna and salmon. In Japan, people have long eaten big fish, small fish, all kinds of fish, and that is necessary in order not to destroy the ecosystem of sea creatures. We can say that eating many different kinds of fish in a balanced way is kinder to nature. So that is what I'd like to ask of you all.", "Why is eating in a balanced way kind to nature?", "You know that tuna are rapidly decreasing, right?", "Yeah. They've gotten expensive. And people are saying we might soon not be able to eat them at all.", "Right, right. And so the small fish that tuna feed on are increasing too much, and the balance of sea life is being thrown off.", "So that's why he's saying we should eat small fish too, to keep the balance in the sea."],
        ...
        items: [
          {
            ...
            en: ["A company president is being interviewed.", "Today we'll be talking with President Fujikawa, known for his unique management policy. I hear that Fujikawa Industries is world-class when it comes to metalworking technology...", "Thank you. That we receive such praise is thanks to our employees' skills. People tend to think that making things is work anyone can do easily, but those very skills are the company's assets, so at our company we have always valued highly skilled employees regardless of age, experience or nationality.", "Specifically?", "It means that, depending on their ability, they can receive a salary on par with an executive. We actually have employees like that. By being recognized, everyone has become confident in their own skills, and we've become able to make products we wouldn't be ashamed to show anywhere.", "That the technology is world-class", "That making things tends to be thought of as easy", "That they hire a variety of employees", "That evaluating employees by ability has led to the company's growth"],
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          {
            script: [
              { sp: "M", v: "m", ja: "いい{選手|せんしゅ}になれるかどうかは{君|きみ}の{努力次第|どりょくしだい}だよ。" },
            ],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "{日程|にってい}が決まらないことには{切符|きっぷ}が取れないよ。" },
            ],
