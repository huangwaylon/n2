N2F({
  ...
  sample: {
    ...
    lines: [
      ...
      { cont: true, ja: "そのクレームが{正当|せいとう}なものかどうか**はともかく**として、お客様は{不快|ふかい}な気持ちになっていらっしゃるので、{対応|たいおう}を{間違|まちが}えるとホテルへの{信頼|しんらい}を{失|うしな}い**かねません**。", en: "Whether or not the complaint is justified, the guest is feeling unhappy, so if you handle it wrongly, the hotel could well lose their trust." },
