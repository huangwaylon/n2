      ...
      practice: [
        {
          ...
          items: [
            { q: "GDPを見ると、データ（　）{豊|ゆた}かになってきているわが国だが、国民の生活{水準|すいじゅん}は高いとは言えず、その{向上|こうじょう}が今後の{課題|かだい}だ。", options: ["{上|じょう}は", "の{上|うえ}に"], answer: 0, en: "Looking at GDP, our country is becoming richer according to the data, but the people's standard of living can't be called high, and raising it is a challenge for the future." },
