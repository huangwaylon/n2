N2F({
  ...
  sample: {
    ...
    lines: [
      ...
      { cont: true, ja: "ラーメンはめんやスープの作り方に{工夫|くふう}ができる**{上|うえ}**に、めんにのせる{具|ぐ}にもバリエーションがつけやすいのです。", en: "Not only can you be creative with how the noodles and soup are made, it is also easy to vary the toppings you put on the noodles." },
      { cont: true, ja: "そのため、ラーメン**といっても**、最近はイタリア料理のトマトソースを使ったもの、サラダ{感覚|かんかく}で食べられるもの、スープのないものなど、{様々|さまざま}なものがあります。", en: "For that reason, although we say \"ramen\", these days there are all kinds: ones made with Italian-style tomato sauce, ones you can eat like a salad, ones without soup, and so on." },
      { cont: true, ja: "ラーメンはしょうゆ**に{限|かぎ}る**と言う人も、一度食べてみる{価値|かち}があるのではないでしょうか。", en: "Even people who say soy-sauce ramen is the best might find them worth trying once." },
      ...
      { cont: true, ja: "2時間待たされましたが、さすがにそのラーメンはスープ**にしろ**、{具|ぐ}**にしろ**、その店{独自|どくじ}の{工夫|くふう}がされていて、今までにない新しいものでした。", en: "I had to wait two hours, but true to its reputation, that ramen — whether the soup or the toppings — had the shop's own original touches, and it was something new, unlike anything before." },
