N2F({
  ...
  points: [
    ...
    },
    {
      ...
      deepDive:
        "**Vや否や** means *the moment ~, no sooner had ~ than …*. The second event follows the first **immediately**, almost at the same time. 否 (いな) means *no*, so literally *whether it was ~ or not*, i.e. before one could even tell. The short form **Vや** means the same and is even more literary.\n\n" +
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the option that correctly completes each sentence." },
          items: [
            { q: "こんな問題ごとき、（　）。", options: ["小学生でも解ける", "小学生では解けない"], answer: 0, en: "A problem like this — even an elementary school student could solve it." },
            { q: "アリごときに、高い{殺虫剤|さっちゅうざい}を使うのは（　）と思う。", options: ["当たり前だ", "もったいない"], answer: 1, en: "I think it's a waste to use expensive insecticide on mere ants." },
            { q: "風邪ごときで、大切な試合を休む（　）。", options: ["のはやむを得ない", "わけにはいかない"], answer: 1, en: "I can't miss an important match over something like a cold." },
            { q: "{私|わたくし}ごときにこのような{大役|たいやく}をお{任|まか}せいただき、大変（　）。", options: ["{光栄|こうえい}です", "残念です"], answer: 0, en: "I am deeply honored that you would entrust such an important role to someone as humble as me." },
          ],
        },
      ],
    },
    {
      ...
      deepDive:
        "**〜（か）と思いきや** means *I thought ~, but (contrary to expectation)…; just when you'd expect ~, …*. 思いきや is the classical 思う + き (past auxiliary) + や (question/exclamation), roughly *one would have thought*. The first half is the expectation; the second half is **what actually happened**, which is surprising.\n\n" +
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the option that correctly completes each sentence." },
          items: [
            { q: "全部の問題を解き終わったと思いきや、終了5分前に（　）。", options: ["{提出|ていしゅつ}して帰ってしまった", "問題の続きがもう1ページあるのに気付いた"], answer: 1, en: "I thought I had finished all the questions, but five minutes before the end I noticed there was one more page of questions." },
            { q: "（　）ので、ジュースだと思いきや、なんと酒だった。", options: ["子どもがおいしそうに飲んでいる", "大人が{先|さき}を{争|あらそ}って飲んでいる"], answer: 0, en: "A child was drinking it with such relish that I assumed it was juice, but it was actually alcohol!" },
            { q: "被害者だと思いきや、（　）。", options: ["実は彼女が犯人だった", "みんな彼女に{同情|どうじょう}した"], answer: 0, en: "I thought she was the victim, but in fact she was the culprit." },
          ],
        },
      ],
    },
      ...
      practice: [
        {
          ...
          left: [
            "彼女は昨年{彗星|すいせい}のごとく現れ、",
            "{老|お}いて{後|のち}も健康に暮らし、{安|やす}らかに眠るがごとく",
            "その黒い{人影|ひとかげ}は猫のごとく",
            "{騒|さわ}ぎの後、人々は{何事|なにごと}もなかったかのごとく",
          ],
          right: [
            "一生を終えることこそ、幸福だと言えよう。",
            "わずか1年で世界中の多くのファンを{魅了|みりょう}する大スターとなった。",
            "{平然|へいぜん}と食事を続けた。",
            "{足音|あしおと}も立てずに{塀|へい}を{越|こ}えて{闇|やみ}の中に消えていった。",
          ],
          answer: [1, 0, 3, 2],
          en: [
            "She appeared like a comet last year and, in just one year, became a big star who has captivated many fans around the world.",
            "It could be said that true happiness lies in living healthily even in old age and ending one's life as if peacefully falling asleep.",
            "The dark figure, like a cat, went over the wall without a sound and vanished into the darkness.",
            "After the commotion, people went on eating calmly as if nothing had happened.",
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      deepDive:
        "**Vるだに** means *just ~ing (is enough to…), even to ~*. だに is a classical particle close to さえ / だけでも: 考えるだに恐ろしい = 考えるだけでも恐ろしい *it's frightening even to think about it*. The point is that you don't need to experience the thing itself — merely imagining, hearing or seeing it produces the feeling.\n\n" +
    ...
    },
    {
      ...
      deepDive:
        "**Nを限りに / N限りで** means *as of N, with N as the last (time)*: something that has continued up to now stops after N. 今日を限りにたばこをやめる = *I'm giving up smoking as of today — today is the last day*.\n\n" +
      ...
      practice: [
        {
          ...
          items: [
            { q: "{長年|ながねん}通ったこの学校とも今日を限りにお別れです。", options: ["明日も学校へ行く。", "明日からは学校へ行かない。"], answer: 1, en: "Today is the day I say goodbye to this school I attended for so many years." },
            { q: "彼女への{想|おも}いは今日を限りにきれいさっぱり捨ててしまおう。", options: ["今までずっと彼女への{想|おも}いを心に{抱|いだ}いていた。", "彼女への{想|おも}いは今日{芽生|めば}えたばかりだ。"], answer: 0, en: "As of today, I'll throw away my feelings for her completely." },
            { q: "20年続いたお祭りでしたが、今回限りで{休止|きゅうし}することになりました。", options: ["お祭りは今回は行われない。", "お祭りは{次回|じかい}は行われない。"], answer: 1, en: "The festival had continued for 20 years, but it has been decided that it will be suspended after this one." },
          ],
        },
      ],
    },
