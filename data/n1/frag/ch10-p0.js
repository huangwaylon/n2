N2F({
  ...
  points: [
    // ───────── 111
    {
      ...
      forms: ["[V-る] + べからず"],
      formNotes: [
        { ja: "＊「〜べからざる + [N]」の形もある。", en: "The form “〜べからざる + N” also exists." },
      ],
      examples: [
      ...
      see: [90, 122],
      index: ["Vべからず", "Vべからざる N", "〜べからず", "〜べからざる", "べからず", "べからざる"],
    },
    // ───────── 112
    {
      no: 112,
    ...
    // ───────── 113
    {
      ...
      formNotes: [
        { ja: "＊「[なA] な／[N]（の） + ゆえ」の形も使われる。", en: "The forms “なA + な + ゆえ” and “N + (の) + ゆえ” are also used." },
        { ja: "＊「だから」という意味で、{接続詞|せつぞくし}としても使われる。", en: "It is also used as a conjunction, meaning “therefore.”" },
      ],
      examples: [
    ...
    // ───────── 114
    {
      ...
      deepDive:
        "**相まって（相俟って）** comes from 相俟つ *to wait on each other / to work together*. **A と B が相まって** or **A が B と相まって** = *A and B combine (to produce a greater effect)*. The point is **synergy**: two or more factors reinforce each other and the result is stronger, better (or worse) than either alone.\n\n" +
        "Patterns:\n" +
      ...
      see: [],
      index: ["Nが相まって", "Nと相まって", "〜と相まって", "〜が相まって", "相まって"],
    },
    // ───────── 115
    {
      no: 115,
      ...
      forms: ["［[N]　[V-る]］ + にかたくない"],
      formNotes: [
        { ja: "＊「想像・予想・{推測|すいそく}・{察|さっ}する」などの言葉と一緒に使われる。", en: "Used with words such as 想像 (imagine), 予想 (predict), 推測 (guess) and 察する (sense, infer)." },
      ],
      examples: [
        { ja: "突然の停電でエレベーターに閉じ込められた人の不安と恐怖は想像にかたくない。", en: "It is easy to imagine the anxiety and fear of the people trapped in the elevator by the sudden power cut." },
        { ja: "新しいタイプの芸術に対して、評価が分かれるのは{推測|すいそく}にかたくない。", en: "One can readily guess that opinions will be divided about a new type of art." },
        { ja: "{副作用|ふくさよう}の可能性を考えれば、{新薬|しんやく}の使用に{慎重|しんちょう}にならざるを得ないのは想像にかたくない。", en: "Considering the possibility of side effects, it is easy to imagine that one has no choice but to be cautious about using a new drug." },
        { ja: "リーダーたるもの、苦しい{決断|けつだん}を{迫|せま}られるであろうことは予想にかたくない。", en: "It is easy to predict that anyone who is a leader will be pressed to make painful decisions." },
        { ja: "これらのコレクションを見れば、{大原氏|おおはらし}が{美術品|びじゅつひん}に{造詣|ぞうけい}が深かったことは{察|さっ}するにかたくない。", en: "Looking at these collections, one can easily infer that Mr. Ohara had a deep knowledge of works of art." },
      ],
      deepDive:
        "**かたくない** is the negative of **かたい（難い）** *difficult* — the same 難い as in 〜がたい (忘れがたい). So **〜にかたくない** = literally *it is not difficult to ~*: **one can easily ~**. 衝撃は想像にかたくない = *the shock is easy to imagine*.\n\n" +
      ...
      see: [41, 122],
      index: ["〜にかたくない", "想像にかたくない", "Nにかたくない", "V-るにかたくない"],
    },
    // ───────── 116
    {
      no: 116,
      ...
      see: [3, 70],
      index: ["N₁としてあるまじきN₂", "N₁にあるまじきN₂", "VまじきN", "〜としてあるまじき", "〜にあるまじき", "あるまじき", "許すまじき"],
    },
    // ───────── 117
    {
      no: 117,
    ...
    // ───────── 118
    {
      ...
      deepDive:
        "**N + でなくてなんだろう** is a **rhetorical question**: *if it is not N, what (else) is it?* → *it is nothing other than N, it is truly N*. The writer is moved and asserts N with great force: これが愛情でなくてなんだろう *if this isn't love, what is?*\n\n" +
        "Forms:\n" +
    ...
    // ───────── 119
    {
      ...
      plus: [
        {
          ...
          forms: ["[N] + の + {極|きわ}み"],
          formNotes: [
            { ja: "＊「{感激|かんげき}・{贅沢|ぜいたく}・美・{痛恨|つうこん}」などの言葉と一緒に使われる。", en: "Used with words such as 感激 (deep emotion), 贅沢 (luxury), 美 (beauty) and 痛恨 (bitter regret)." },
          ],
          examples: [
      ...
      deepDive:
        "**極まる（きわまる）** means *to reach the limit*. **なA-stem + 極まりない** and **なA-stem + 極まる** both mean **extremely ~, ~ in the extreme**. Although one looks negative, they mean the same: 極まりない = *has no limit* (極まり + ない), 極まる = *reaches the limit*. 失礼極まりない = 失礼極まる = *extremely rude*.\n\n" +
    ...
    // ───────── 120
    {
      ...
      forms: ["[N] + を禁じえない"],
      formNotes: [
        { ja: "＊「{怒|いか}り・悲しみ・{同情|どうじょう}・とまどい」など感情を表す名詞と一緒に使われる。", en: "Used with nouns expressing emotions, such as 怒り (anger), 悲しみ (sadness), 同情 (sympathy) and とまどい (bewilderment)." },
      ],
      examples: [
      ...
      see: [9],
      index: ["Nを禁じえない", "〜を禁じえない", "禁じえない", "禁じ得ない"],
    },
    // ───────── 121
    {
      no: 121,
      ...
      forms: ["［[V-る]　[N₁]］ + にたる + [N₂]"],
      examples: [
        { ja: "ホームドクターに、信頼にたる{眼科|がんか}の専門医を紹介してもらった。", en: "I had my family doctor introduce me to a trustworthy eye specialist." },
      ...
      practice: [
        {
          type: "fill",
          prompt: { ja: "", en: "Choose the word from the box that fills each blank." },
          bank: ["{任|まか}せる", "{証明|しょうめい}する", "呼ぶ", "発表する"],
          items: [
    ...
    // ───────── 122
    {
      ...
      forms: ["[V-る] + べくもない"],
      formNotes: [
        { ja: "＊「疑う・比べる・望む・知る」などの言葉と一緒に使われる。", en: "Used with words such as 疑う (doubt), 比べる (compare), 望む (hope for) and 知る (know)." },
      ],
      examples: [
      ...
      deepDive:
        "**べく** is the continuative form of classical **べし** (*can / should*). **V-る + べくもない** = *there is no way to ~, ~ is out of the question*. It says that, **given the situation, the action is impossible or unthinkable**.\n\n" +
      ...
      see: [41, 90, 111],
      index: ["Vべくもない", "〜べくもない", "疑うべくもない", "望むべくもない", "べくもない"],
    },
    // ───────── 123
    {
      no: 123,
      ...
      plus: [
        {
          ...
          examples: [
            { ja: "今の{選挙|せんきょ}制度では、{選挙|せんきょ}運動をすることなく国会議員に{当選|とうせん}するなどあり得ないと言われている。", en: "It is said that under the current electoral system it is impossible to be elected to the Diet without campaigning." },
            { ja: "本人の{同意|どうい}を{得|え}ることなく、個人情報を第三者に伝えることはできない。", en: "Personal information cannot be passed on to a third party without obtaining the person's consent." },
            { ja: "責任を取ることなしに自由を求めることはできない。", en: "You cannot demand freedom without taking responsibility." },
            { ja: "予算変更は議会の{承認|しょうにん}を{得|え}ることなしには行えない。", en: "Changes to the budget cannot be made without the approval of the assembly." },
          ],
        },
      ],
      deepDive:
        "**なくして** is the literary te-form of ない (*without*). **A なくして（は）B ない** = *without A, B is impossible* → **A is indispensable for B**. 固定観念からの解放なくして芸術は生まれない = *without liberation from fixed ideas, art cannot be born*.\n\n" +
        "Connection:\n" +
  ...
  check: [
    {
      ...
      bank: ["のみ", "なくして", "ゆえに", "{相|あい}まって"],
      items: [
        { q: "医者としての{信念|しんねん}＿＿、彼は助かる{見込|みこ}みのない{我|わ}が{子|こ}の{治療|ちりょう}より、助かる可能性のある{患者|かんじゃ}の手術を{優先|ゆうせん}した。", answer: "ゆえに", en: "Because of his convictions as a doctor, he gave priority to operating on a patient who could be saved over treating his own child, who had no hope of survival." },
        { q: "犯人の不幸な{生|お}い{立|た}ちを知ること＿＿この事件の{真相|しんそう}は理解できない。", answer: "なくして", en: "Without knowing the culprit's unhappy upbringing, you cannot understand the truth of this case." },
        { q: "{生前|せいぜん}のゴッホの芸術を理解し、認めていたのは弟のテオ＿＿だった。", answer: "のみ", en: "The only person who understood and recognized Van Gogh's art during his lifetime was his younger brother Theo." },
        { q: "この歌はピアノの{音色|ねいろ}と少年の{澄|す}んだ{歌声|うたごえ}が＿＿、いつまでも聞いていたくなるほど{心地|ここち}いい曲だ。", answer: "{相|あい}まって", en: "In this song, the tone of the piano and the boy's clear singing voice combine to make a piece so pleasant that you want to keep listening forever." },
      ],
    },
    {
      type: "fill",
      prompt: { ja: "", en: "Choose the expression from the box that fills each blank." },
      bank: ["にあるまじき", "べくもない", "にたる"],
      items: [
        { q: "車を買ったとはいっても、社長の高級車とは比べる＿＿中古の{軽自動車|けいじどうしゃ}だ。", answer: "べくもない", en: "I may have bought a car, but it's a used compact car that can't begin to compare with the president's luxury car." },
        { q: "{天文学|てんもんがく}は一生を{捧|ささ}げる＿＿学問だと私は考えています。", answer: "にたる", en: "I believe astronomy is a field of study worth devoting one's whole life to." },
        { q: "{業者|ぎょうしゃ}から{賄賂|わいろ}をもらうとは、{公務員|こうむいん}＿＿恥ずかしい{行為|こうい}ですよ。", answer: "にあるまじき", en: "Taking bribes from contractors is a shameful act unworthy of a public servant." },
      ],
    },
    {
      type: "fill",
      prompt: { ja: "", en: "Choose the expression from the box that fills each blank." },
      bank: ["禁じえない", "ずにはすまない", "でなくてなんだろう", "にかたくない", "{極|きわ}まりない", "べからず"],
      items: [
