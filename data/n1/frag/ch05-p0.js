N2F({
  ...
  sample: {
    ...
    lines: [
      ...
      { sp: "{刑事|けいじ}", v: "m", ja: "「まあ、被害者の方にこんなこと言うのも{酷|こく}だけど、これは起こる**べくして**起こった事件と言ってもいい。{業種|ぎょうしゅ}**が**{業種|ぎょうしゅ}な**だけに**、これからマスコミも{騒|さわ}ぎ出すでしょう。あなたも{覚悟|かくご}しないと……。」", en: "\"Well, it's harsh to say this to the victim, but you could say this incident was bound to happen, and it did. Given the kind of business you're in, the media are going to start making a fuss. You'd better brace yourself…\"" },
