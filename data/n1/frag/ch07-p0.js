N2F({
  ...
  part: 0,
  head: {
    genre: { ja: "社内で話す", en: "Talking at the Office" },
    title: { ja: "さすが{本田|ほんだ}君", en: "That's Our Honda!" },
    canDo: [
      {
  ...
  sample: {
    ...
    lines: [
      ...
      { sp: "{本田|ほんだ}", v: "m", ja: "はあ。でも、あちらの担当者**ときたら**、価格のことしか言わないんです。だから説明し**たところで**{無駄|むだ}だと思ったんですよ。", en: "Well… But their person in charge — honestly, all he talks about is price. So I figured that even if I explained, it would be pointless." },
      ...
      { sp: "{本田|ほんだ}", v: "m", ja: "でも、部長。「毎年新製品が出るんだから、今年は新製品でも来年は古くなる。だから1年ごとにリース料を10%ずつ安くしろ。」と言われたんです。こちらが{赤字|あかじ}にな**ろうが**なる**まいが**、自分の会社さえよければいいんですよ。安くしてほしい**なら**ほしい**で**、{納得|なっとく}できる条件を{提示|ていじ}すべきですよね。", en: "But sir, he told me: “New products come out every year, so even if it's new this year, it'll be old next year. So lower the lease fee by 10% every year.” Whether we end up in the red or not, all he cares about is his own company. If he wants it cheaper, fine, but then he should offer terms we can accept." },
      ...
      { sp: "{本田|ほんだ}", v: "m", ja: "はい。", en: "Yes, sir." },
    ],
  },
  points: [
    // ───────── 72
    {
      ...
      examples: [
        ...
        { ja: "A：減るもんじゃあるまいし、貸してくれてもいいでしょう。\nB：{嫌|いや}だよ。大切なMP3なんだから。", en: "A: It's not like it'll get used up. You could lend it to me.\nB: No way. It's my precious MP3 player." },
        ...
        { ja: "{厳|きび}しいと言っても、社長も{鬼|おに}ではあるまいし、ちゃんと話せばわかってもらえるはずだよ。", en: "He may be strict, but the president isn't a monster. If you explain properly, he should understand." },
      ],
      deepDive:
        "**〜じゃあるまいし** literally means *it's surely not that it is ~* (ある + the negative-conjecture auxiliary まい), followed by し giving a reason. The speaker names an extreme or obviously false situation (a child, a beginner, a trip to the South Pole) and uses it as the reason for criticism, advice or a request: *you're not X, so (do / don't do) Y*.\n\n" +
      ...
      practice: [
        {
          ...
          items: [
            { q: "ドラマじゃあるまいし、（　）。", options: ["大金持ちでかっこよくて性格もいい人が現れるわけがないでしょう", "この店にはかっこいい人ばかりが集まっているでしょう", "アニメのほうが好きな人が多いでしょう"], answer: 0, en: "This isn't a TV drama. There's no way someone rich, good-looking and with a great personality is going to show up." },
            { q: "{猿|さる}じゃあるまいし、（　）", options: ["ペットはやっぱり犬や猫がいいよ。", "そんなにバナナばかり食べて、{飽|あ}きないの？", "あれはたぶん子どもだろう。"], answer: 1, en: "You're not a monkey. Don't you get sick of eating nothing but bananas like that?" },
            { q: "子どもが書いたんじゃあるまいし、（　）。", options: ["大学生にしてはレベルが高い{履歴書|りれきしょ}と言えるね", "とても立派でどこに出しても恥ずかしくない{履歴書|りれきしょ}だね", "こんな{履歴書|りれきしょ}じゃどこにも採用してもらえないよ"], answer: 2, en: "It's not as if a child wrote this. With a résumé like this, nobody will hire you." },
          ],
        },
      ],
    },
      ...
      notes: [
        {
          ...
          examples: [
            ...
            { ja: "食べ{放題|ほうだい}なのだから食べないと損だとばかりに、皿に山ほど料理を取ってきた。", en: "It was all-you-can-eat, so, as if not eating would be a waste of money, he came back with a mountain of food on his plate." },
            { ja: "商品の{入|い}れ{替|か}えで{全品|ぜんぴん}半額だったので、このときとばかりにたくさん買い込んだ。", en: "Everything was half price because they were changing their stock, so I seized the moment and stocked up." },
          ],
        },
      ],
      deepDive:
        "**〜んばかり** comes from the classical negative ぬ (→ ん) + ばかり: *all but ~ / on the verge of ~*. Nothing actually happens — the verb describes what something **looks as if it is about to do**, which makes the description vivid and exaggerated: 折れんばかりに揺れる (swaying so hard they look about to snap), 泣き出さんばかりの顔 (a face on the verge of tears).\n\n" +
      ...
      practice: [
        {
          ...
          items: [
            { q: "うちの犬は{誰|だれ}か来ると、（　）んばかりに{吠|ほ}えるので、困っている。", options: ["{噛|か}みつか", "散歩せ"], answer: 0, en: "Whenever anyone comes, our dog barks as if it's about to bite them, which is a problem." },
            { q: "最後のランナーは（　）んばかりの{状態|じょうたい}でやっとゴールインした。", options: ["倒れ", "走ら"], answer: 0, en: "The last runner finally crossed the finish line looking ready to collapse." },
            { q: "絶対に許さないと（　）んばかりの顔でにらんでいる。", options: ["思わ", "言わ"], answer: 1, en: "He's glaring with a look that says, “I'll never forgive you.”" },
          ],
        },
      ],
    },
    // ───────── 74
    {
      ...
      examples: [
        ...
        { ja: "{新型|しんがた}の{医療機器|いりょうきき}をそろえても、使いこなせる技術者がいなければそれまでだ。", en: "Even if you equip yourself with the latest medical equipment, it's useless without technicians who can operate it." },
        { ja: "あきらめたらそれまでだ。努力し続ければ夢は必ずかなう。", en: "If you give up, it's over. If you keep making the effort, your dream will surely come true." },
      ],
      deepDive:
        "**〜たら／〜ば それまでだ** says *if ~ happens, that's the end of it — everything so far is wasted / nothing more can be done*. それまで = *up to that point*: the condition marks the point where everything stops.\n\n" +
      ...
      see: [82, 93],
      index: ["Vたらそれまでだ", "Vばそれまでだ"],
      practice: [
        {
          type: "choice",
          labels: "abc",
          prompt: { ja: "", en: "Choose the sentence closest in meaning." },
          items: [
            { q: "{携帯|けいたい}電話は便利だが、バッテリーが切れればそれまでだ。", options: ["バッテリーが切れたら使えない。", "バッテリーが切れるまで使おう。", "バッテリーが切れるから{無駄|むだ}だ。"], answer: 0, en: "Cell phones are convenient, but once the battery dies, that's it. (a. If the battery dies, you can't use it. b. Let's use it until the battery dies. c. It's a waste because the battery dies.)" },
            { q: "今度の大会はトーナメントなので、1回戦で負けたらそれまでだ。", options: ["1回戦で負けたら、2回戦も負けるだろう。", "1回戦で負けたら、2回戦に期待しよう。", "1回戦で負けたら、2回戦には出られない。"], answer: 2, en: "This tournament is single-elimination, so if we lose in the first round, it's over. (a. If we lose the first round, we'll probably lose the second too. b. If we lose the first round, let's hope for the second. c. If we lose the first round, we can't play in the second.)" },
          ],
        },
      ],
    },
    // ───────── 75
    {
      ...
      deepDive:
        "**〜ものを** is a literary relative of **〜のに** (*and yet / if only*). It expresses dissatisfaction, reproach or regret that something **didn't turn out as it could have**. The classic pattern is **Aば／Aたら B ものを**: *if A had been done, B would have resulted — but it wasn't*. (早く来れば空いていたものを).\n\n" +
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the sentence closest in meaning." },
          items: [
            { q: "もっと早く知らせてくれればよかったものを……。", options: ["知らせてくれたからよかった。", "知らせてくれなかったので困った。", "今すぐ知らせてほしい。"], answer: 1, en: "You should have told me sooner… (a. It was good that you told me. b. You didn't tell me, so I was in trouble. c. I want you to tell me right now.)" },
            { q: "すぐ{謝|あやま}ればすんだものを、問題がこじれてしまったじゃないか。", options: ["すぐ{謝|あやま}ってもしょうがない。", "すぐ{謝|あやま}ってはいけない。", "すぐ{謝|あやま}るべきだった。"], answer: 2, en: "If you'd apologized right away that would have been the end of it — now the problem has got complicated! (a. There's no point apologizing right away. b. You mustn't apologize right away. c. You should have apologized right away.)" },
          ],
        },
      ],
    },
    // ───────── 76
    {
      ...
      forms: ["[N] + ときたら"],
      examples: [
        { ja: "うちの子ときたら、いつもゲームばかりやっていて、声をかけても返事もしない。", en: "My kid, honestly — he's always playing games and doesn't even answer when I call him." },
      ...
      deepDive:
        "**Nときたら** picks out a topic (a person or thing close to the speaker) in order to **complain about it**: *as for ~ (honestly) …*. It works like は but brings an exasperated tone, and the rest of the sentence is a complaint or negative evaluation.\n\n" +
      ...
      practice: [
        {
          ...
          left: ["あの店ときたら、", "今年の夏ときたら、", "このパソコンときたら、", "うちの犬ときたら、"],
          right: [
    ...
    // ───────── 77
    {
      ...
      examples: [
        ...
        { ja: "国内のコンクールで優勝したところで、海外でも通用するとは限らないさ。", en: "Even if you win a domestic competition, it doesn't mean you'll be good enough abroad." },
        { ja: "私が言ったところで、彼の気持ちは変わらないだろう。", en: "Even if I tell him, he probably won't change his mind." },
        { ja: "国のトップが変わったところで、国民の政治{不信|ふしん}は簡単には解決できない。", en: "Even if the country's leader changes, the public's distrust of politics can't be easily resolved." },
      ],
      deepDive:
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the phrase that best completes each sentence." },
          items: [
            { q: "どんなに頼んだところで、（　）。", options: ["どうせ断られるに決まっているよ", "やっと許可をもらうことができたんだ", "いつか理解してもらえるかもしれないね"], answer: 0, en: "No matter how much you ask, you're sure to be turned down anyway." },
            { q: "今から予約をキャンセルしたところで、（　）。", options: ["お金は戻ってこないよ", "少しはお金が戻ってくるかもしれないね", "お金が戻ってくるに違いない"], answer: 0, en: "Even if you cancel the reservation now, you won't get your money back." },
            { q: "地位や{名誉|めいよ}を得たところで、（　）。", options: ["財産も得られたら{嬉|うれ}しいよね", "健康を害したら何にもならないよ", "家族も喜んでくれるに違いないね"], answer: 1, en: "Even if you gain status and honor, it's worthless if you ruin your health." },
          ],
        },
      ],
    },
    // ───────── 78
    {
      ...
      deepDive:
        "**V-（よ）うが / V-（よ）うと** is a strong, somewhat literary *no matter (what/how) ~ / even if ~*. It uses the volitional form (行こう, しよう, 言おう, かかろう) + が or と, and the main clause states a determination that won't change or an unchangeable fact.\n\n" +
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the sentence closest in meaning." },
          items: [
            { q: "いくらお金を{積|つ}もうが、人の心は買えるものではないよ。", options: ["お金を払えば、人の心は買えるものだ。", "いくらお金を払えば、人の心が買えるかわからない。", "お金を払っても人の心は絶対に買えない。"], answer: 2, en: "However much money you pile up, you can't buy a person's heart. (a. If you pay, you can buy a person's heart. b. I don't know how much you'd have to pay to buy a heart. c. Even if you pay, you can never buy a person's heart.)" },
            { q: "何があろうと、{僕|ぼく}の愛は変わらない。", options: ["どんなことが起こっても愛し続ける。", "何もなければ愛し続ける。", "何かあれば愛し続ける。"], answer: 0, en: "Whatever happens, my love won't change. (a. I'll keep loving you whatever happens. b. I'll keep loving you if nothing happens. c. I'll keep loving you if something happens.)" },
          ],
        },
      ],
    },
    // ───────── 79
    {
      ...
      forms: ["[V-よう] + が + [V-る] + まいが", "[V-よう] + と + [V-る] + まいと"],
      ...
      examples: [
        ...
        { ja: "警官が見ていようがいるまいが、交通ルールは守るべきだ。", en: "Whether or not a police officer is watching, you should obey the traffic rules." },
        { ja: "お客が来ようと来るまいと、部屋はいつも片付けておけ。", en: "Whether guests are coming or not, keep your room tidy at all times." },
      ],
      notes: [
        {
      ...
      deepDive:
        "**Vようが Vまいが / Vようと Vまいと** = *whether one ~s or not*. It sets up an affirmative and negative alternative with the same verb and says the main clause holds either way. The main clause is a firm intention (私は行くつもりだ), a norm (守るべきだ, 片付けておけ) or a statement of fact (これは本当にあった話です).\n\n" +
      ...
      see: [78, 38],
      index: ["VようがVまいが", "VようとVまいと", "V₁ようがV₂ようが", "V₁ようとV₂ようと", "A₁かろうが A₂かろうが", "A₁かろうと A₂かろうと", "〜だろうが…だろうが", "〜だろうと…だろうと"],
      practice: [
        {
          type: "match",
          labels: "abc",
    ...
    // ───────── 80
    {
      ...
      deepDive:
        "**AならAで** repeats the same word: 辞めるなら辞めるで, 嫌なら嫌で, 病気なら病気で. It accepts someone's situation A (*if that's how it is, fine*) and then says **what they should do given A** — so the second half is advice, a demand, or a complaint that they didn't act accordingly (〜ばよかったのに).\n\n" +
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the phrase that best completes each sentence." },
          items: [
            { q: "新しいパソコンを買うなら買うで、（　）。", options: ["相談してくれればもっと安く買えたのに……", "相談したから安く買えてよかった"], answer: 0, en: "If you were going to buy a new computer, you should have asked me — you could have got it cheaper…" },
            { q: "注文を受けるなら受けるで、（　）。", options: ["相手の名前も{用件|ようけん}も忘れていました", "ちゃんとその{数|かず}をメモしておかないとだめじゃないか"], answer: 1, en: "If you're going to take an order, you have to write down the quantity properly!" },
            { q: "帰国するなら帰国するで、（　）。", options: ["お世話になった皆さんにきちんと{挨拶|あいさつ}してから帰りなさい", "お世話になった皆さんに{挨拶|あいさつ}できてよかった"], answer: 0, en: "If you're going back to your country, make sure you say a proper goodbye to everyone who looked after you before you leave." },
          ],
        },
      ],
    },
    // ───────── 81
    {
      ...
      deepDive:
        "**Nにすれば / Nにしたら / Nにしても / Nにしてみれば** = *from N's point of view / for N*. The speaker puts themself in someone else's shoes (usually a person or group other than the speaker) and describes how things look or feel **to them**: 相手にすれば、経費は安ければ安いほどいい.\n\n" +
      ...
      practice: [
        {
          ...
          items: [
            { q: "最近ペットに服を着せるのが{流行|はや}っているが、ペットにしたら（　）。", options: ["{迷惑|めいわく}なのではないだろうか", "私はとてもかわいいと思う"], answer: 0, en: "Dressing pets in clothes is popular these days, but from the pet's point of view, isn't it a nuisance?" },
            { q: "母親はよく古い雑誌やおもちゃなどを捨てろというが、子どもにすれば（　）。", options: ["二度と手に入らない宝物なのだ", "いくらで売れるか{検討|けんとう}してみよう"], answer: 0, en: "Mothers often say to throw out old magazines and toys, but to a child they're treasures that can never be replaced." },
            { q: "最近は字を書くことが少なくなったので、外国人だけでなく、日本人にしても（　）。", options: ["漢字はたくさん書いて覚えてください", "漢字を書くのは難しいんです"], answer: 1, en: "These days we write by hand so rarely that writing kanji is hard not only for foreigners but even for Japanese people." },
          ],
        },
      ],
    },
    // ───────── 82
    {
      ...
      examples: [
        ...
        { ja: "ホテルが見つからなければ、ネットカフェかカラオケで{一晩|ひとばん}過ごすまでのことだ。", en: "If I can't find a hotel, I'll simply spend the night in an internet café or a karaoke box." },
        { ja: "息子も娘も{継|つ}ぐ気がないなら、工場は閉めるまでだ。", en: "If neither my son nor my daughter wants to take over, I'll just close the factory." },
      ],
      deepDive:
        "**V-るまでのことだ / V-るまでだ** = *(if so,) I'll simply ~; there's nothing for it but ~*. Usually preceded by a condition (〜たら, 〜なら, 〜なければ): the speaker states a fallback action and presents it as no big deal. まで = *that far and no further* — the only thing left to do.\n\n" +
      ...
      practice: [
        {
          ...
          prompt: { ja: "", en: "Choose the sentence closest in meaning." },
          items: [
            { q: "貸したお金を返してくれなければ、{裁判|さいばん}に{訴|うった}えるまでのことだ。", options: ["返してくれなくても、{裁判|さいばん}に{訴|うった}えることはない。", "返してくれなければ、{裁判|さいばん}に{訴|うった}えればいい。", "返してくれても、{裁判|さいばん}に{訴|うった}えるつもりだ。"], answer: 1, en: "If he doesn't pay back the money I lent him, I'll simply take him to court. (a. Even if he doesn't pay it back, there's no need to sue. b. If he doesn't pay it back, I can just sue. c. Even if he pays it back, I intend to sue.)" },
            { q: "{壊|こわ}れているなら、新しいのを買うまでだ。", options: ["{壊|こわ}れていても、買えばいいから困らない。", "{壊|こわ}れているかどうか、とても心配している。", "{壊|こわ}れているが、新しいのを買うまで{我慢|がまん}する。"], answer: 0, en: "If it's broken, I'll just buy a new one. (a. Even if it's broken, I can just buy one, so it's no problem. b. I'm very worried about whether it's broken. c. It's broken, but I'll put up with it until I buy a new one.)" },
          ],
        },
      ],
    },
  ...
  check: [
    {
      type: "fill",
      prompt: { ja: "1", en: "1. Choose the expression from the box that fills each blank. (Item 4 has a picture of a panicking man with a fire extinguisher next to a fire.)" },
      bank: ["ものを", "までのことだ", "ときたら", "じゃあるまいし", "それまでだ", "にすれば"],
      items: [
        { q: "{高橋|たかはし}君＿＿、新婚旅行先で結婚指輪をなくしちゃったんだって。", answer: "ときたら", en: "Takahashi, honestly — I heard he lost his wedding ring on his honeymoon." },
        { q: "歴史学者＿＿、こんな専門的な問題が大学の受験生にわかるわけないじゃないか。", answer: "じゃあるまいし", en: "They're not historians. How could university applicants be expected to answer such a specialized question?" },
        ...
        { q: "さっき買えばよかった＿＿、他の店のと比べてからなんて言うから、売り切れちゃったじゃないか。", answer: "ものを", en: "We should have bought it earlier, but you said you wanted to compare it with other shops first — and now it's sold out!" },
      ],
    },
    {
      type: "choice",
