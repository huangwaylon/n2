  ...
  points: [
    // ───────── 61
    {
      ...
      deepDive:
        ...
        "Nuance and register: written or formal speech. The first half states an admitted fact; the second half is typically the speaker's judgment, warning, or a reality check (〜わけではない, 〜てはならない, まだ〜, 〜だろう). The B clause can be an opinion or an admonition, which is less natural with 〜ものの.\n\n" +
        "Compare:\n" +
