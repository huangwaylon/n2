N2F({
  ...
  sample: {
    ...
    lines: [
      ...
      { ja: "あなたからも、ぜひ周囲の人に積極的に働きかけて、お互いを理解するきっかけをつかんでください。", en: "Do take the initiative yourself and reach out to the people around you, and seize the chance to understand one another." },
    ],
  },
  points: [
    // ───────── 41
    {
      ...
      examples: [
        ...
        { ja: "環境{保護|ほご}の必要性は、改めて{世論|よろん}に問うまでもないことだ。", en: "The need to protect the environment is not something we need to ask the public about all over again." },
      ...
      practice: [
        {
          ...
          items: [
            ...
            { q: "今さら__言うまでもなく__、タバコは「{百害|ひゃくがい}あって{一利|いちり}なし」です。", options: ["言う必要もないが", "言ってもしかたがないが", "言わなければならないが"], answer: 0, en: "It hardly needs saying at this point, but cigarettes do nothing but harm (“a hundred harms and not a single benefit”)." },
          ],
        },
      ],
    },
    ...
    // ───────── 43
    {
      ...
      examples: [
        ...
        { ja: "リハビリを続けて、走れないまでも何とか歩けるようになった。", en: "By keeping up my rehab I've managed to get to the point where I can walk, even if I can't run yet." },
      ],
      deepDive:
      ...
      practice: [
        {
          ...
          items: [
            { q: "金メダルとは言わないまでも、せめて銅メダルはとってほしい。", options: ["金メダルがだめでも最低、銅メダルはとってほしい。", "金メダルはほしくないが、銅メダルは必ずとってほしい。", "金メダルはほしいが、銅メダルはいらない。"], answer: 0, en: "I won't say it has to be gold, but I'd like them to win at least a bronze." },
            { q: "お{腹|なか}を冷やすと__病気には{至|いた}らないまでも体に悪い{影響|えいきょう}を与える__らしい。", options: ["病気にはならない場合も体に悪い{影響|えいきょう}がある", "病気になって体に悪い{影響|えいきょう}がある", "病気にならなければ体に悪い{影響|えいきょう}はない"], answer: 0, en: "Apparently, letting your stomach get cold is bad for your body, even if it doesn't go as far as making you ill." },
    ...
    // ───────── 44
    {
      ...
      forms: ["[N₁] + といい + [N₂] + といい"],
      examples: [
        { ja: "{濃厚|のうこう}なスープといい、{麺|めん}のほどよい{硬|かた}さといい、さすが日本一のラーメンだね。", en: "The rich broth, the perfectly firm noodles — this really is Japan's best ramen, isn't it?" },
        ...
        { ja: "このホテルは全く期待はずれだった。サービスといい、料理といい、ひどいものだ。", en: "This hotel was a real letdown. The service, the food — it's all dreadful." },
      ],
      deepDive:
  ...
  check: {
    ...
    items: [
      ...
      { q: "レシピ通りに作れば、プロのようには作れ＿＿、家族に喜んでもらえる程度には作れますよ。", answer: "ないまでも", en: "If you follow the recipe, you may not be able to cook it like a professional, but you can at least make it well enough to please your family." },
      ...
      { q: "昔の犬の名前は、ポチやシロ＿＿だったが、最近はクッキーやショコラなど食べ物の名前が人気のようだ。", answer: "といったところ", en: "Dogs used to be called things like Pochi and Shiro, but these days food names like Cookie and Chocolat seem to be popular." },
      { q: "ファンティエットは美しい{砂浜|すなはま}＿＿、すてきな{街並|まちな}み＿＿、新婚旅行にもおすすめのリゾート地です。", answer: ["といい", "といい"], en: "With its beautiful beaches and lovely streets, Phan Thiet is a resort that's also perfect for a honeymoon.", why: { en: "Two good features of one place (its beaches and its streets) lead to an overall positive verdict (おすすめのリゾート地), so といい…といい. (The book's picture shows a map of Vietnam with Phan Thiet's palm-lined beach.)" } },
    ],
  },
});
