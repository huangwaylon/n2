N2F({
  ...
  label: "(2)",
  canDo: [
    { ja: "{昔話|むかしばなし}の表現を楽しみながら、登場する人物の行動や出来事の{経緯|けいい}などが理解できる。", en: "Enjoy the expressions typical of folktales while understanding what the characters do and how events came about." },
  ],
  sample: {
    kind: "story",
    vertical: true,
    lines: [
      { ja: "あるとき、{嫁|よめ}が「お{前様|まえさま}がいるとゆっくり掃除ができません。昼間は外で遊んできてください。」と言うので、男は久しぶりに外へ出た。", en: "One day, his wife said, \"With you around, I can't take my time over the cleaning. Please go out and enjoy yourself during the day,\" so the man went out for the first time in ages." },
  ...
  points: [
    {
      ...
      usage: {
        ...
        en: "As in お見舞いかたがた会いに行く (go to see someone, which is also a get-well visit), AかたがたB means 'do B (go to see them) while also having A (the get-well visit) as a purpose'. Verbs related to movement, such as 伺う・行く・訪ねる・来る, are often used for B.",
      },
      forms: ["[N] + かたがた"],
      formNotes: [
        { ja: "＊「{挨拶|あいさつ}・お見舞い・報告・お礼・お祝い・おわび」などの言葉と一緒に使われることが多い。", en: "Often used with words such as 挨拶 (greeting), お見舞い (sick visit), 報告 (report), お礼 (thanks), お祝い (congratulations) and おわび (apology)." },
      ],
      examples: [
        { ja: "お世話になった{先輩|せんぱい}のお宅へ、お礼かたがた新年のご{挨拶|あいさつ}に{伺|うかが}った。", en: "I called at the home of a senior colleague who had done a lot for me, to pay my New Year's respects and at the same time to thank him." },
        { ja: "上司が入院したので、お見舞いかたがた仕事の進め方について相談に行った。", en: "My boss was in the hospital, so I went to consult him about how to proceed with the work, combining it with a get-well visit." },
      ...
      plus: [
        {
          ...
          usage: {
            ...
            en: "AがてらB is used when you want to say 'take the opportunity of A to do B as well'. Words related to movement are often used for A and B.",
          },
          forms: ["[N]／[V-~~ます~~] + がてら"],
          examples: [
            { ja: "合格{祈願|きがん}のお参りがてら、{早咲|はやざ}きの{梅|うめ}を見に行きませんか。", en: "While we're visiting the shrine to pray for success in the exams, why don't we go and see the early plum blossoms too?" },
            { ja: "散歩がてら、コンビニで牛乳買ってきたよ。", en: "I bought some milk at the convenience store while I was out for a walk." },
            { ja: "{出産|しゅっさん}した友達に、お祝いを届けがてら、会いに行った。", en: "I went to see a friend who'd had a baby, taking the chance to deliver a congratulatory gift." },
          ],
        },
      ],
      deepDive:
        "**AかたがたB** = *doing B, and at the same time A (as an additional purpose)*. A is a noun of social courtesy — お礼, お見舞い, ご挨拶, ご報告, お詫び, お祝い — and B is usually a verb of going/visiting: 伺う, 参る, 行く, 訪ねる, 来る. The whole expression is formal, typical of letters, business e-mail and polite speech (the 'no casual talk' icon): 近況報告かたがた、ご挨拶申し上げます.\n\n" +
        ...
        "- **〜かたわら** (#95, 本業のかたわら): *alongside (a main occupation)* — long-term parallel activities, not one trip.\n" +
      ...
      see: [95],
      index: ["Nかたがた", "〜かたがた", "〜がてら", "Nがてら", "Vがてら"],
    },
    {
      no: 27,
      pattern: "〜とは",
      ...
      formNotes: [
        { ja: "＊「〜とは。」と、後ろを省略することもある。", en: "What follows can also be left out, ending the sentence with 〜とは。" },
      ],
      examples: [
        { ja: "有名なコーヒーショップだと聞いてはいたが、コーヒー1杯2,000円とは{驚|おどろ}いたよ。", en: "I'd heard it was a famous coffee shop, but 2,000 yen for one cup of coffee — that amazed me." },
        ...
        { ja: "まさか君たちが結婚するとはねえ。学生時代はけんかばかりしていたじゃないか。", en: "Who'd have thought you two would get married! You did nothing but fight when you were students, didn't you?" },
        { ja: "あの優しそうな老人が、{強盗|ごうとう}事件の犯人だったとは。", en: "To think that kind-looking old man was the culprit in the robbery!" },
      ],
      deepDive:
        "**〜とは** (the quoting と + topic は) presents an unexpected fact as the topic and follows it with the speaker's emotional reaction: *to think that ~! / I can't believe ~*. The reaction is surprise (驚いた, 思わなかった, 信じられない), admiration (さすがだ), or exasperation/criticism (あきれた, ひどい).\n\n" +
    ...
    },
    {
      ...
      forms: ["[V-る] + なり"],
      examples: [
        { ja: "{警部|けいぶ}は{受話器|じゅわき}を置くなり、コートを{片手|かたて}に飛び出していった。", en: "The moment the inspector put down the receiver, he grabbed his coat and rushed out." },
      ...
      deepDive:
        "**V-る＋なり** = *as soon as / the moment (someone) did V, (something unexpected) followed*. It narrates a past sequence in which the second action comes instantly and usually surprisingly: 家に帰るなり寝てしまった.\n\n" +
        "Key constraints:\n" +
      ...
      practice: [
        {
          ...
          items: [
            { q: "警官は「{伏|ふ}せろ！」と叫ぶなり、犯人に向かって（　）。", options: ["{発砲|はっぽう}した", "話しかけた"], answer: 0, en: "The moment the police officer shouted \"Get down!\" he fired at the criminal.", why: { en: "なり is followed by a sudden action coming right after the first one; shouting 'Get down!' and immediately opening fire fits." } },
            { q: "社長は料理を口にするなり、（　）。", options: ["苦しんでいた", "苦しみ出した"], answer: 1, en: "The instant the president put the food in his mouth, he began to writhe in pain.", why: { en: "The second half must be a sudden new action right after the first; 苦しんでいた describes an ongoing state." } },
            { q: "彼は、名人が作った{器|うつわ}を手に取るなり、（　）。", options: ["同じ作品を作った", "{素晴|すば}らしいと言った"], answer: 1, en: "The moment he picked up the bowl made by the master, he said it was magnificent.", why: { en: "Making the same piece could not happen instantly; an immediate exclamation fits なり." } },
          ],
        },
      ],
    },
    {
      ...
      usage: {
        ...
        en: "AわBわ is used when listing the reasons or circumstances that leave one troubled or delighted.",
      },
      forms: ["[Pl₁] + わ + [Pl₂] + わ\n［現在形のみ］　［現在形のみ］"],
      examples: [
        { ja: "雨には降られるわ、上司には{叱|しか}られるわ、ついていない1日だった。", en: "What with getting caught in the rain and getting told off by my boss, it was one unlucky day." },
        { ja: "最近、{中村|なかむら}くん、どうしたんだろう。遅刻はするわ、宿題は忘れるわ……。", en: "I wonder what's up with Nakamura lately. He comes late, he forgets his homework..." },
        { ja: "例文は{難解|なんかい}だわ、字は小さいわ、こんな辞書、買う人いるのかな。", en: "The example sentences are hard to understand, the print is tiny — I wonder if anyone would actually buy a dictionary like this." },
        { ja: "料理はうまいわ、{眺|なが}めはいいわ、あの旅館は最高だったね。", en: "The food was delicious, the view was wonderful — that inn was the best, wasn't it?" },
      ],
      deepDive:
        "**AわBわ** lists two (or more) things piled one on another, usually with a feeling of *what with A and B…*: exasperation (雨には降られるわ、叱られるわ), sometimes delight (料理はうまいわ、眺めはいいわ). The emphatic particle わ is repeated after each item, and the sentence often ends with an evaluation (ついていない1日だった, 最高だった) or trails off (……).\n\n" +
    ...
    },
    {
      ...
      usage: {
        ...
        en: "Like 〜なり, 〜が早いか… is used when you want to say that … happens right after ~, almost at the same moment. It is often used when speaking with surprise about how very short the time was before … happened.",
      },
      forms: ["[V-る]／[V-た] + が早いか"],
      examples: [
      ...
      practice: [
        {
          type: "choice",
          labels: "ab",
          prompt: { ja: "", en: "Choose the sentence with the same meaning." },
          items: [
            { q: "12時の{鐘|かね}が鳴るが早いか、美しい{馬車|ばしゃ}はあっという間にカボチャに戻った。", options: ["12時の{鐘|かね}がなるとすぐ、{馬車|ばしゃ}はカボチャに戻った。", "12時の{鐘|かね}が鳴るより早く、{馬車|ばしゃ}はカボチャに戻った。"], answer: 0, en: "The instant the clock struck twelve, the beautiful carriage turned back into a pumpkin in the blink of an eye.", why: { en: "〜が早いか = right after, almost simultaneously (鳴るとすぐ) — not 'before it struck'." } },
            { q: "受付時間になるが早いか、{待|ま}ち{構|かま}えていたように電話が鳴り出した。", options: ["受付時間になるのを待っている間に、電話がかかってきた。", "受付時間になるかならないかのうちに、電話がかかってきた。"], answer: 1, en: "The moment reception hours began, the phone started ringing, as if people had been lying in wait.", why: { en: "が早いか means the call came almost the instant the hours began (なるかならないかのうちに), not while waiting for them." } },
            { q: "母親が出かけるが早いか、子どもたちはゲームを始めた。", options: ["子どもたちは母親がいる間はゲームをしなかった。", "子どもたちは母親が早い時間に出かけたので、ゲームをした。"], answer: 0, en: "No sooner had their mother gone out than the children started playing video games.", why: { en: "They started the instant she left, which implies they weren't playing while she was there. 早い here is not about the time of day." } },
          ],
        },
      ],
    },
    {
      ...
      usage: {
        ...
        en: "AそばからB is used when you want to say that B is done right after A. It is often used to describe the two actions A and B being repeated over and over, or when you want to say 'I worked hard to do A, but B follows right away, so the effort goes to waste'.",
      },
      forms: ["[V-る]／[V-た] + そばから"],
      examples: [
        { ja: "今日は{大雪|おおゆき}で、{帽子|ぼうし}にも肩にも払うそばから雪が降り{積|つ}もってしまう。", en: "It's snowing heavily today; no sooner do I brush the snow off my hat and shoulders than it piles up again." },
        { ja: "工場では新しい製品が完成するそばから{箱詰|はこづ}めされて{出荷|しゅっか}されていく。", en: "At the factory, new products are boxed and shipped out as fast as they're finished." },
        { ja: "父は肉が焼けるそばから私たちの皿にどんどん{載|の}せてくれた。", en: "As fast as the meat was cooked, my father kept piling it onto our plates." },
        { ja: "ゴミを片付けたそばからカラスが散らかすので、道が汚れて困る。", en: "No sooner is the garbage cleared up than the crows scatter it again, so the street gets dirty — it's a real nuisance." },
      ],
      deepDive:
        "**AそばからB** (そば = *right beside*) = *no sooner is A done than B (again)*. Its hallmark is **repetition**: A and B happen again and again in a cycle (作るそばから食べる, 払うそばから積もる, 完成するそばから出荷される). Very often B undoes A, so the effort is wasted and the speaker is frustrated: 片付けたそばから散らかす, 覚えるそばから忘れる.\n\n" +
    ...
    },
    {
      ...
      usage: {
        ...
        en: "〜ずにはおかない expresses the speaker's strong determination: 'I won't give up until I've done ~ / I will definitely do ~'.",
      },
      forms: ["[V-~~ない~~] + ずにはおかない", "[V-~~ない~~] + ないではおかない"],
      examples: [
        { ja: "「今度こそ犯人を捕まえずにはおかないぞ」と{警部|けいぶ}は心に{誓|ちか}った。", en: "\"This time I'll catch the culprit, no matter what,\" the inspector vowed to himself." },
        { ja: "当時の大統領は、自分の意見に反対する者を{排除|はいじょ}せずにはおかない人間だった。", en: "The president at that time was a man who would not rest until he had eliminated anyone who opposed his views." },
        { ja: "彼の{過失|かしつ}となれば、会社は損害{賠償|ばいしょう}を{請求|せいきゅう}しないではおかないだろう。", en: "If it turns out to be his fault, the company will surely demand compensation for damages." },
      ],
      notes: [
        {
          ja: "「〜ずにはおかない」は「自然に〜の感情が起こる／〜の状況になる」と言いたいときにもよく使われる。",
          en: "〜ずにはおかない is also often used when you want to say that a feeling of ~ arises naturally, or that the situation ~ comes about as a matter of course.",
          stars: 1,
          examples: [
            { ja: "{盲目|もうもく}のピアニストが{奏|かな}でる美しい調べは、{聴衆|ちょうしゅう}の心を{震|ふる}わせずにはおかなかった。", en: "The beautiful melody played by the blind pianist could not fail to move the hearts of the audience." },
            { ja: "{大手|おおて}の自動車メーカーが{倒産|とうさん}するようなことがあれば、多くの{中小企業|ちゅうしょうきぎょう}の経営{危機|きき}を引き起こさずにはおかないだろう。", en: "If a major automaker were ever to go bankrupt, it would inevitably trigger a business crisis for many small and medium-sized companies." },
            { ja: "{地球外生命体|ちきゅうがいせいめいたい}の{異様|いよう}な{映像|えいぞう}は、見る人に{衝撃|しょうげき}を与えずにはおかないだろう。", en: "The bizarre footage of an extraterrestrial life form is bound to shock anyone who sees it." },
          ],
        },
      ],
      deepDive:
        ...
        "- **〜ずにはすまない** (#117): *won't be settled without ~ / will have to ~* — social necessity or obligation (謝らずにはすまない).\n" +
      ...
      see: [117],
      index: ["Vずにはおかない", "Vないではおかない", "〜ずにはおかない"],
    },
    {
      no: 33,
      pattern: "〜たが最後",
      ...
      usage: {
        ...
        en: "〜たが最後… means 'if ~ happens, it will inevitably end in …'. The … part contains words describing a state the speaker would not want.",
      },
      forms: ["[V-た] + が最後"],
      formNotes: [
        { ja: "＊話し言葉では「〜たら最後」がよく使われる。", en: "In spoken language, 〜たら最後 is often used." },
      ],
      examples: [
    ...
    },
    {
      ...
      usage: {
        ...
        en: "〜てやる expresses doing ~ out of a strong feeling such as anger or dissatisfaction.",
      },
      forms: ["[V-て] + やる"],
      examples: [
        { ja: "もう{我慢|がまん}できない。こんな会社辞めてやる。", en: "I can't take it anymore. I'm quitting this damn company." },
        { ja: "今度こそ、絶対頂上まで登ってやる。", en: "This time I'm going to make it to the summit, no matter what." },
        { ja: "営業成績を伸ばして、来月は一番になってやる。", en: "I'm going to push up my sales figures and be number one next month — just watch me." },
  ...
  check: [
    ...
    },
    {
      ...
      items: [
        { q: "お前、{無駄遣|むだづか}いはやめると言った＿＿、新しいかばんを2つも買うなんて、どういうことだ。", answer: "そばから", en: "You said you'd stop wasting money, and right after that you buy two new bags? What's the meaning of this?" },
