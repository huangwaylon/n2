N2F({
  ...
  points: [
    // ───────── 65
    {
      ...
      see: [77],
      index: ["〜ところ（を）", "〜べきところ（を）", "いAところを", "Nのところを", "お忙しいところ"],
      practice: [
        {
          type: "choice",
          labels: "ab",
    ...
    // ───────── 66
    {
      ...
      see: [69, 71, 119],
      index: ["Nの至り", "〜の至り", "光栄の至り", "感激の至り", "若気の至り"],
      practice: [],
    },
    // ───────── 67
    {
      ...
      see: [13, 106],
      xref: "☞ 13. ご指導**をもって**",
      index: ["Nをもって②", "Nをもって", "Nをもちまして", "これをもちまして", "以上をもちまして"],
      practice: [
        {
          type: "choice",
          labels: "ab",
          prompt: { ja: "", en: "Choose the correct option." },
          items: [
            { q: "このプロジェクトチームは{本日|ほんじつ}をもって（　）。", options: ["解散いたします", "3週間続いています"], answer: 0, en: "This project team will be disbanded as of today." },
            { q: "{当社|とうしゃ}は10月1日をもって（　）。", options: ["社名を変更いたします", "営業中です"], answer: 0, en: "Our company will change its name as of October 1." },
            { q: "{本日|ほんじつ}夜の部をもちまして、この{公演|こうえん}の日程は全て（　）。ご{観覧|かんらん}{誠|まこと}にありがとうございました。", options: ["売り切れました", "終了いたしました"], answer: 1, en: "With tonight's evening performance, all the dates of this production have come to an end. Thank you very much for attending." },
          ],
        },
      ],
    },
    // ───────── 68
    {
      ...
      formNotes: [
        { ja: "＊{動詞|どうし}の{否定形|ひていけい}は「〜ぬ」になることもある。", en: "The negative form of the verb can also be 〜ぬ (e.g. 知らぬこととて)." },
      ],
      examples: [
    ...
    // ───────── 71
    {
      ...
      deepDive:
        "**〜限りだ** uses 限り *limit*: the feeling has reached its limit, i.e. *nothing but ~ / extremely ~*. It is attached to an adjective of feeling and states the **speaker's own emotion** at the moment: うれしい限りだ *I'm so happy*, 心細い限りだ *I feel so helpless*.\n\n" +
        "Connection:\n" +
      ...
      see: [66, 69, 106],
      index: ["〜限りだ", "いA限りだ", "なAな限りだ", "うれしい限りです"],
      practice: [
        {
          type: "fill",
