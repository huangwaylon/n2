      ...
      points: [
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜ともなると…」は「〜の条件や立場ならば当然…になる」と言いたいときに使われる。", en: "“〜ともなると…” is used when you want to say “under the condition of 〜, or in the position of 〜, … naturally follows.”" },
          forms: ["[N] + ともなると", "[N] + ともなれば"],
          formNotes: [
            { ja: "＊{動詞|どうし}も使われることがある。", en: "Verbs are sometimes used too." },
          ],
          examples: [
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜にひきかえ…」は「一方は〜のに、{他方|たほう}は…だ」と2つの{事柄|ことがら}を比べて、対照的だという意味を表す。", en: "“〜にひきかえ…” compares two things — “one is 〜, whereas the other is …” — and expresses that they are in sharp contrast." },
          forms: ["[Pl] + の + にひきかえ\n［[なA~~だ~~]な］"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜もさることながら…」は「この車はデザインもさることながら、性能もいい」のように「〜だけでなく…も」と言いたいときに使われる。「車選びはデザインもさることながら、安全性を{重視|じゅうし}すべきだ」のように「〜も大切だが…はもっと重要だ」と言いたいときにも使う。", en: "“〜もさることながら…” is used when you want to say “not only 〜 but also …”, as in “この車はデザインもさることながら、性能もいい” (This car has a great design, and good performance too). It is also used when you want to say “〜 is important too, but … is even more important”, as in “車選びはデザインもさることながら、安全性を重視すべきだ” (When choosing a car, design matters, of course, but safety should come first)." },
          forms: ["[N] + もさることながら"],
          examples: [
              ...
              items: [
                {
                  ...
                  options: ["専門知識もさることながら、コミュニケーション能力も必要だ。", "コミュニケーション能力もさることながら、専門知識も必要だ。"],
                  answer: 0,
                  en: "Specialist knowledge is of course necessary, but communication skills are even more necessary.",
                  why: { en: "The item that is acknowledged first (専門知識) goes before もさることながら; the one being emphasized comes after." },
                },
                {
                  q: "健康のためにはもちろん{治療|ちりょう}も大切だが、それ以上に病気予防に努力する必要がある。",
                  options: ["健康のためには予防もさることながら、{治療|ちりょう}に努力すべきだ。", "健康のためには{治療|ちりょう}もさることながら、予防に努力すべきだ。"],
                  answer: 1,
                  en: "For your health, treatment is of course important, but you need to put even more effort into preventing illness.",
                  why: { en: "The sentence puts more weight on 予防, so 治療 (the point acknowledged first) goes before もさることながら and 予防 comes after it." },
                },
              ],
            },
          ],
        },
        {
          ...
          marks: [],
          notesFirst: false,
          usage: { ja: "「AであれBであれ…」は「AでもBでも」と例をあげて、「どんなものでも同じように…だ」と言いたいときに使われる。", en: "“AであれBであれ…” is used when you give examples — “whether A or B” — and want to say “whatever it is, … all the same.”" },
          forms: ["[N₁] + であれ + [N₂] + であれ"],
          formNotes: [
            { ja: "＊[N₂]には{疑問詞|ぎもんし}も使われる。", en: "A question word can also be used for N₂." },
          ],
          examples: [
              ...
              items: [
                {
                  ...
                  parts: [
                    { tag: "1", options: ["であれ", "だし"], answer: 0 },
                    { tag: "2", options: ["であれ", "だし"], answer: 0 },
                  ],
                ...
                },
                {
                  ...
                  parts: [
                    { tag: "1", options: ["であれ", "だし"], answer: 1 },
                    { tag: "2", options: ["であれ", "だし"], answer: 1 },
                  ],
                ...
                },
                {
                  ...
                  parts: [
                    { tag: "1", options: ["であれ", "やら"], answer: 1 },
                    { tag: "2", options: ["であれ", "やら"], answer: 1 },
                  ],
                ...
                },
                {
                  ...
                  parts: [
                    { tag: "1", options: ["であれ", "とか"], answer: 0 },
                    { tag: "2", options: ["であれ", "とか"], answer: 0 },
                  ],
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜に{即|そく}して」は「ある状況や経験、規則に合わせて、何かの行動をする」と言いたいときに使われる。法律や規則の場合、漢字は「{則|そく}して」を使う。", en: "“〜に即して” is used when you want to say “to take some action in line with a certain situation, experience or rule.” For laws and rules, the kanji 「則して」 is used." },
          forms: ["[N₁] + にそくして", "[N₁] + にそくした + [N₂]"],
          formNotes: [
            { ja: "＊状況・経験・規則などを表す{名詞|めいし}と一緒に使われる。", en: "Used with nouns that express a situation, experience, rule and so on." },
          ],
          examples: [
        ...
        },
        {
          ...
          marks: ["praise"],
          notesFirst: false,
          usage: { ja: "「〜をおいて他にない」は「〜だけだ／〜以外ない」と言いたいときに使われる。「比べてみて〜が一番だ」と高い評価をしているときに使われることが多い。", en: "“〜をおいて他にない” is used when you want to say “it is only 〜 / there is nothing but 〜.” It is often used when giving high praise: “compared with the others, 〜 is the best.”" },
          forms: ["[N] + をおいて他にない"],
          formNotes: [
      ...
      points: [
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜までもなく」は「すでにわかっていることや当然のことなので、〜する必要がない」と言いたいときに使う。", en: "Use “〜までもなく” when you want to say “it is already known, or it goes without saying, so there is no need to 〜.”" },
              ...
              items: [
                {
                  ...
                  options: ["{決算書|けっさんしょ}を見ればわかることだ", "{決算書|けっさんしょ}を見なくてもわかることだ", "{決算書|けっさんしょ}を見なければわからないことだ"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["言う必要もないが", "言ってもしかたがないが", "言わなければならないが"],
                  answer: 0,
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜いかん」は「{検査|けんさ}の結果いかんで、手術することになるかもしれない」のように「〜（{検査|けんさ}の結果）がどのような内容・{状態|じょうたい}かによって、どうなるかが決まる」と言いたいときに使われる。", en: "“〜いかん” is used when you want to say “what happens is decided by what 〜 (the test results) turns out to be — its content or state”, as in “検査の結果いかんで、手術することになるかもしれない” (Depending on the test results, you may end up having surgery)." },
          forms: ["[N] + （の） + いかん"],
          examples: [
          ...
          plus: [
            {
              ...
              stars: 1,
              marks: [],
              usage: { ja: "「いかんせん〜／いかんともしがたい」は「{残念|ざんねん}だが、どうにもならない／どうすることもできない」という意味で使われる。", en: "“いかんせん〜／いかんともしがたい” is used to mean “it is a pity, but there is no way around it / nothing can be done about it.”" },
              examples: [
          ...
          practice: [
            {
              ...
              answer: [2, 3, 0, 1],
              en: ["Depending on how the new product sells, bonuses may go up.", "Who receives a scholarship is decided by the test results.", "Depending on the typhoon's future course, flights may be cancelled.", "Depending on the number of applicants, the next term's class may not be held."],
            },
          ],
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「AないまでもB」は「Aほど高いレベルではなくてもB程度は」と言いたいときに使う。", en: "Use “AないまでもB” when you want to say “even if it is not at a level as high as A, it is at least at the level of B.”" },
          forms: ["[V-~~ない~~] + ないまでも"],
          examples: [
              ...
              items: [
                {
                  ...
                  options: ["金メダルがだめでも最低、銅メダルはとってほしい。", "金メダルはほしくないが、銅メダルは必ずとってほしい。", "金メダルはほしいが、銅メダルはいらない。"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["病気にはならない場合も体に悪い{影響|えいきょう}がある", "病気になって体に悪い{影響|えいきょう}がある", "病気にならなければ体に悪い{影響|えいきょう}はない"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["法律違反で警察に捕まって、客に信用されなくなる", "法律について考えないで商売をすると、客に信用されなくなる", "法律には違反しないが、客に信用されなくなる"],
                  answer: 2,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「AといいBといい…」は、A・B2つの例をあげて「全体的に…だ」と言いたいときに使う。すばらしいと思ったり、ひどいと思ったりした自分の気持ちを言うときに使う。", en: "Use “AといいBといい…” when you give two examples, A and B, and want to say “taken as a whole, it is ….” It is used to express your own feelings — that you think something is wonderful, or that you think it is terrible." },
          forms: ["[N₁] + といい + [N₂] + といい"],
          examples: [
              ...
              items: [
                {
                  ...
                  parts: [
                    { tag: "1", options: ["といい", "なり"], answer: 0 },
                    { tag: "2", options: ["といい", "なり"], answer: 0 },
                  ],
                ...
                },
                {
                  ...
                  parts: [
                    { tag: "1", options: ["といい", "であれ"], answer: 1 },
                    { tag: "2", options: ["といい", "であれ"], answer: 1 },
                  ],
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜といったところだ」は、相手がわかりやすいように、違う言葉に言い{換|か}えたり、例を{挙|あ}げたりするときに使う。", en: "Use “〜といったところだ” when you put something another way, or give an example, so that the other person can understand it easily." },
          forms: ["[N] + といったところだ"],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["ストレッチやウォーキング", "マラソンやボクシング"],
                  answer: 0,
      ...
      check: {
        ...
        items: [
          ...
          { q: "昔の犬の名前は、ポチやシロ＿＿だったが、最近はクッキーやショコラなど食べ物の名前が人気のようだ。", answer: "といったところ", en: "Dogs used to be called things like Pochi and Shiro, but these days food names like Cookie and Chocolat seem to be popular." },
          {
            ...
            why: { en: "Two good features of one place (its beaches and its streets) lead to an overall positive verdict (おすすめのリゾート地), so といい…といい. (The book's picture shows a map of Vietnam with Phan Thiet's palm-lined beach.)" },
          },
        ],
      },
    },
        ...
        items: [
          {
            ...
            options: ["はずもない", "おそれがない", "までもない", "に違いない"],
            answer: 2,
            ...
            why: { en: "The injury was minor, so telling you was unnecessary: V-る + までもない." },
          },
          {
            q: "{担保|たんぽ}がなくても、経営{状態|じょうたい}（　）、{融資|ゆうし}が受けられる場合もあるらしいよ。",
            options: ["いかんによらず", "いかんにかかわらず", "いかんによって", "いかんせん"],
            answer: 2,
            en: "Apparently, even without collateral, you can sometimes get a loan, depending on the state of your business.",
            why: { en: "Whether you get the loan changes with the state of the business, so いかんによって (depending on). いかんによらず／いかんにかかわらず mean the opposite (regardless of), and いかんせん means unfortunately." },
          },
          {
            q: "出張でも観光でも目的は何（　）、海外に行くときは{保険|ほけん}をかけたほうがいいよ。",
            options: ["とか", "であれ", "やら", "といい"],
            answer: 1,
            en: "Whether it's for business or sightseeing — whatever the purpose — you should take out insurance when you go abroad.",
            why: { en: "Question word + であれ = no matter what. The sentence ends with advice that holds regardless of the purpose." },
          },
          {
            ...
            why: { en: "それをおいてない = there is nothing but that (〜をおいて他にない without 他に)." },
          },
          {
            q: "{我|わ}が{校|こう}は医学部の研究設備が{充実|じゅうじつ}しているの（　）、{工学|こうがく}部は実験{装置|そうち}さえ満足に整っていない。",
            options: ["にひきかえ", "をぬきにして", "もさることながら", "に限らず"],
            answer: 0,
            ...
            why: { en: "Two faculties of the same university are contrasted, one favorably and one unfavorably: plain form + の + にひきかえ." },
          },
          {
            q: "道路交通法を現状（　）{改正|かいせい}してほしい。",
            options: ["をよそに", "に{即|そく}して", "をおいて", "であれ"],
            answer: 1,
            en: "I want the Road Traffic Act to be revised in line with the current situation.",
            why: { en: "現状に即して = in a way that matches the actual situation." },
          },
          {
            q: "窓ガラスを{交換|こうかん}すれば、この{騒音|そうおん}が（　）、だいぶ静かにはなりますよ。",
            options: ["なくならないうちに", "なくならないことには", "なくならないまでも", "なくならないかぎりは"],
            answer: 2,
            en: "If you replace the window glass, the noise may not go away altogether, but it will get a lot quieter.",
            why: { en: "ないまでも: the higher level (the noise disappearing) is not reached, but a lower level (much quieter) is." },
          },
          {
            q: "{勤続|きんぞく}20年のベテラン（　）、音を聞いただけで機械の{故障|こしょう}がわかるという。",
            options: ["ともなれば", "はおろか", "といった", "といえども"],
            answer: 0,
            ...
            why: { en: "A status well above the ordinary (a 20-year veteran) + the ability naturally expected at that level → ともなれば." },
          },
        ],
      },
    },
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            why: { en: "納入された入学金は、理由のいかんにかかわらず返還いたしません: the topic 入学金は comes first, then 理由の + いかんにかかわらず, then 返還 before いたしません." },
          },
          {
            ...
            why: { en: "機能面もさることながら、ペットのようなかわいい動きで: N + も + さることながら acknowledges the functionality, and ペットの + ような modifies かわいい動き. (The book's picture shows a woman delighted by a robot vacuum cleaner.)" },
          },
        ],
      },
    },
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          {
            script: [
              { sp: "F", v: "f", ja: "高級ホテルともなると紅茶の味まで違うね。" },
            ],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "次のキャプテン、{田中|たなか}をおいて他にはいないだろう？" },
            ],
