TRY.registerChapter({
  ...
  canDo: [
    { ja: "仕事上の話題について、批判的な意見を{交|まじ}えて社内で話ができる。", en: "Talk about work matters at the office, mixing in critical opinions." },
  ],
  parts: [
    {
      label: "(1)",
      ...
      points: [
        {
          ...
          stars: 3,
          marks: ["casual"],
          usage: { ja: "「〜じゃあるまいし」は「〜なら仕方がないが、そうではないのだから」と、相手に対する批判や意見を言いたいときに使う。", en: "“〜じゃあるまいし” is used when you want to criticize the other person or tell them what you think, with the sense “if it were 〜, that would be understandable, but it isn't, so…”." },
          ...
          practice: [
            {
              ...
              items: [
                {
                  q: "ドラマじゃあるまいし、（　）。",
                  options: ["大金持ちでかっこよくて性格もいい人が現れるわけがないでしょう", "この店にはかっこいい人ばかりが集まっているでしょう", "アニメのほうが好きな人が多いでしょう"],
                  answer: 0,
                  en: "This isn't a TV drama. There's no way someone rich, good-looking and with a great personality is going to show up.",
                },
                {
                  q: "{猿|さる}じゃあるまいし、（　）",
                  options: ["ペットはやっぱり犬や猫がいいよ。", "そんなにバナナばかり食べて、{飽|あ}きないの？", "あれはたぶん子どもだろう。"],
                  answer: 1,
                  en: "You're not a monkey. Don't you get sick of eating nothing but bananas like that?",
                },
                {
                  q: "子どもが書いたんじゃあるまいし、（　）。",
                  options: ["大学生にしてはレベルが高い{履歴書|りれきしょ}と言えるね", "とても立派でどこに出しても恥ずかしくない{履歴書|りれきしょ}だね", "こんな{履歴書|りれきしょ}じゃどこにも採用してもらえないよ"],
                  answer: 2,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜んばかり」は「{壊|こわ}さんばかりにドアをたたく」のように「今にも〜しそうな様子だ」という意味で、程度が非常に高いと感じたときに使われる。", en: "“〜んばかり” means “looking as if it is about to 〜 at any moment”, as in “{壊|こわ}さんばかりにドアをたたく” (pounding on the door as if to break it down). It is used when you feel that the degree of something is extremely high." },
          forms: ["[V-~~ない~~] + んばかり"],
          formNotes: [
            { ja: "＊「する」は「せんばかり」になる。", en: "する becomes せんばかり." },
          ],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜たら／ば　それまでだ」は「もし〜したら、今までの努力や苦労や費用が全て{無駄|むだ}になる」と言いたいときに使われる。", en: "“〜たら／ば　それまでだ” is used when you want to say “if 〜 happens, all the effort, hardship and expense up to now will be wasted.”" },
              ...
              items: [
                {
                  ...
                  options: ["バッテリーが切れたら使えない。", "バッテリーが切れるまで使おう。", "バッテリーが切れるから{無駄|むだ}だ。"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["1回戦で負けたら、2回戦も負けるだろう。", "1回戦で負けたら、2回戦に期待しよう。", "1回戦で負けたら、2回戦には出られない。"],
                  answer: 2,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜ものを」は「〜のに」と、相手を非難するときに使われる。「急げば間に合ったものを」のように「AばBものを」の形で「Aしなかったので（急がなかったので）、Bと反対の悪い結果になった（間に合わなかった）。なぜAしなかったのか」と言いたいときに使われることが多い。", en: "“〜ものを” means much the same as “〜のに” and is used to reproach someone. It is often used in the form “AばBものを”, as in “急げば間に合ったものを” (if you'd hurried, you'd have made it), to say “because you didn't do A (didn't hurry), the bad result opposite to B happened (you didn't make it) — why didn't you do A?”" },
          forms: ["[Pl] + ものを\n［[なA~~だ~~]な　[N~~だ~~]な］"],
          formNotes: [
            { ja: "＊「〜ものを……。」と、後ろを省略することもある。", en: "The rest of the sentence may be left out, as in “〜ものを……。”" },
          ],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["すぐ{謝|あやま}ってもしょうがない。", "すぐ{謝|あやま}ってはいけない。", "すぐ{謝|あやま}るべきだった。"],
                  answer: 2,
        ...
        },
        {
          ...
          stars: 2,
          marks: ["regret", "casual"],
          usage: { ja: "「〜ときたら」は「〜は本当に困る／ひどすぎる／だめだ」などの気持ちで相手や物を非難するときに使われる。", en: "“〜ときたら” is used when criticizing a person or thing with feelings such as “〜 is really a pain / too awful / hopeless.”" },
          forms: ["[N] + ときたら"],
          examples: [
          ...
          practice: [
            {
              ...
              right: ["{連日|れんじつ}最高気温が37度だの38度だの、本当に{嫌|いや}になるよね。", "すぐフリーズするから全然仕事にならないよ。", "{誰|だれ}を見てもしっぽを{振|ふ}って、留守番の役にも立たないんだから。", "「遅い・高い・まずい」で、もう二度と行くものか。"],
              answer: [3, 0, 1, 2],
              en: ["That restaurant — slow, expensive and awful. I'm never going there again.", "This summer — day after day the high is 37 or 38 degrees. It's really unbearable.", "This computer — it freezes all the time, so I can't get any work done.", "Our dog — it wags its tail at anyone it sees, so it's useless as a guard."],
            },
          ],
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜たところで」は「たとえ〜ても」という意味で、「〜をしても{無駄|むだ}だ／期待通りの結果は得られない」と言いたいときに使う。", en: "“〜たところで” means “even if 〜”, and is used when you want to say “doing 〜 is pointless / you won't get the result you hope for.”" },
          forms: ["[V-た] + ところで"],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                {
                  q: "どんなに頼んだところで、（　）。",
                  options: ["どうせ断られるに決まっているよ", "やっと許可をもらうことができたんだ", "いつか理解してもらえるかもしれないね"],
                  answer: 0,
                  en: "No matter how much you ask, you're sure to be turned down anyway.",
                },
                {
                  q: "今から予約をキャンセルしたところで、（　）。",
                  options: ["お金は戻ってこないよ", "少しはお金が戻ってくるかもしれないね", "お金が戻ってくるに違いない"],
                  answer: 0,
                  en: "Even if you cancel the reservation now, you won't get your money back.",
                },
                {
                  q: "地位や{名誉|めいよ}を得たところで、（　）。",
                  options: ["財産も得られたら{嬉|うれ}しいよね", "健康を害したら何にもならないよ", "家族も喜んでくれるに違いないね"],
                  answer: 1,
              ...
              items: [
                {
                  ...
                  options: ["お金を払えば、人の心は買えるものだ。", "いくらお金を払えば、人の心が買えるかわからない。", "お金を払っても人の心は絶対に買えない。"],
                  answer: 2,
                ...
                },
                {
                  ...
                  options: ["どんなことが起こっても愛し続ける。", "何もなければ愛し続ける。", "何かあれば愛し続ける。"],
                  answer: 0,
          ...
          practice: [
            {
              ...
              answer: [2, 3, 0, 1],
              en: ["Whether or not anyone was listening, every Sunday he kept singing in front of the station with his guitar.", "Whether or not you hold a position of responsibility, you must do your own work sincerely.", "Whether the cherry blossoms are out or not, this Saturday we're all going flower viewing.", "Whether you use them or not, you have to pay the basic charges for water and electricity."],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜にすれば」は「〜の立場で考えれば」という意味で、他の人の考えを想像して言うときに使うことが多い。", en: "“〜にすれば” means “if you think from 〜's standpoint”, and is often used when imagining what someone else thinks." },
              ...
              items: [
                {
                  ...
                  options: ["{迷惑|めいわく}なのではないだろうか", "私はとてもかわいいと思う"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["二度と手に入らない宝物なのだ", "いくらで売れるか{検討|けんとう}してみよう"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["漢字はたくさん書いて覚えてください", "漢字を書くのは難しいんです"],
                  answer: 1,
              ...
              items: [
                {
                  ...
                  options: ["返してくれなくても、{裁判|さいばん}に{訴|うった}えることはない。", "返してくれなければ、{裁判|さいばん}に{訴|うった}えればいい。", "返してくれても、{裁判|さいばん}に{訴|うった}えるつもりだ。"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["{壊|こわ}れていても、買えばいいから困らない。", "{壊|こわ}れているかどうか、とても心配している。", "{壊|こわ}れているが、新しいのを買うまで{我慢|がまん}する。"],
                  answer: 0,
    ...
    },
    {
      label: "(2)",
      canDo: [
        { ja: "仕事の結果について、{振|ふ}り返りながら社内で話ができる。", en: "Talk at the office about the results of your work, looking back on how things went." },
      ],
      sample: {
        kind: "dialogue",
        rings: false,
      ...
      points: [
        {
          ...
          stars: 2,
          marks: ["casual"],
          usage: { ja: "「〜といったらない／ありゃしない」は「言葉では言えないほど非常に〜だ」と強調して言いたいときに使われる。「ない」「ありゃしない」の部分は省略されることもある。", en: "“〜といったらない／ありゃしない” is used to say emphatically “it is so extremely 〜 that words can't describe it.” The ない / ありゃしない part is sometimes omitted." },
          forms: ["[いA]／[なA]（だ）／[N]（だ）／[V-る] + といったらない／ったらない", "[いA]／[なA]（だ）／[N]（だ）／[V-る] + といったらありゃしない／ったらありゃしない", "[いA]／[なA] な + こと + といったらない／ったらない", "[いA]／[なA] な + こと + といったらありゃしない／ったらありゃしない"],
          formNotes: [
              ...
              items: [
                {
                  ...
                  options: ["たいして感動するほどではなかった。", "まったく感動できなかった。", "非常に感動した。"],
                  answer: 2,
                ...
                },
                {
                  ...
                  options: ["{紅葉|こうよう}は美しいに決まっている。", "{紅葉|こうよう}が言葉で言い表せないほど美しい。", "{紅葉|こうよう}といっても美しいとは限らない。"],
                  answer: 1,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「A（よ）うにもAない」は「Aしたいが、ある事情のためにAできない」と言いたいときに使う。", en: "“A（よ）うにもAない” is used when you want to say “I want to do A, but because of some circumstance I can't do A.”" },
          ...
          practice: [
            {
              ...
              items: [
                ...
                {
                  q: "（　）、話そうにも話せる状況ではなかった。",
                  options: ["メールで{済|す}むことなので", "{騒音|そうおん}がひどくて"],
                  answer: 1,
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜まくる」は、ある行動や動作を深く考えずに、すごい勢いで何回も{繰|く}り{返|かえ}してする様子を表す。", en: "“〜まくる” describes doing some action or movement over and over with great vigor, without thinking deeply about it." },
          forms: ["[V-~~ます~~] + まくる"],
          examples: [
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜てみせる」は「（自分を認めてもらうために）{頑張|がんば}って〜しよう」という強い{決意|けつい}を表す。", en: "“〜てみせる” expresses a strong determination: “(in order to earn recognition) I will work hard and do 〜.”" },
          forms: ["[V-て] + みせる"],
          examples: [
        ...
        items: [
          {
            ...
            options: ["したところへ", "したところで", "にしたところで", "にしたら"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["見ようと見るまいと", "見るなり聞くなり", "見れば見るほど", "見るやら聞くやら"],
            answer: 0,
          ...
          },
          {
            ...
            options: ["わけにはいかないのに", "わりには", "わけもなかったのに", "わけじゃあるまいし"],
            answer: 3,
          ...
          },
          {
            ...
            options: ["にすれば", "にしたところで", "ときたら", "といっても"],
            answer: 2,
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "この雪じゃ会社へ行こうにも行けないよ。" },
            ],
