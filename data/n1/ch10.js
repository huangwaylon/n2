      ...
      points: [
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜べからず」は「〜してはいけない」と強く禁止することを表す。看板や{掲示|けいじ}によく使われる。", en: "“〜べからず” expresses a strong prohibition, meaning “you must not 〜.” It is often used on signs and notices." },
          forms: ["[V-る] + べからず"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「（ただ）〜のみ」は「本当に〜だけだ」と強く言いたいときに使われる。", en: "“（ただ）〜のみ” is used when you want to stress strongly that it is “really only 〜.”" },
          forms: ["（ただ） + ［[V-る]　[N]］ + のみ"],
          examples: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["始まって1{カ|か}月", "1{カ|か}月を残す"],
                  answer: 1,
        ...
        },
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜がゆえ」は「〜ため／〜から」と同じように原因や理由を表す。", en: "“〜がゆえ” expresses a cause or reason, in the same way as “〜ため／〜から.”" },
        ...
        },
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜にかたくない」は「すぐに〜できる／十分〜できる」という意味を表す。", en: "“〜にかたくない” means “one can readily 〜 / one can well 〜.”" },
          forms: ["［[N]　[V-る]］ + にかたくない"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜ずにはすまない」は「現状や常識から考えて、〜という望ましくない{事態|じたい}になる」という予想や、「〜しなければならない{事態|じたい}だ」ということを表す。", en: "“〜ずにはすまない” expresses the prediction that “judging from the present situation or common sense, the undesirable outcome 〜 will come about,” or that “the situation is one in which 〜 has to be done.”" },
        ...
        },
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜でなくてなんだろう」は「本当に〜である」と強く言いたい気持ちを表す。", en: "“〜でなくてなんだろう” expresses the feeling of wanting to say forcefully “this truly is 〜.”" },
          ...
          plus: [
            {
              ...
              stars: 1,
              marks: [],
              usage: { ja: "「〜の{極|きわ}み」は「非常に／最高に〜」という意味を表す。", en: "“〜の極み” means “extremely / supremely 〜.”" },
              forms: ["[N] + の + {極|きわ}み"],
              formNotes: [
        ...
        },
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜を禁じえない」は「自分の感情（〜）を{抑|おさ}えられないくらいに強く感じる」ことを表す。", en: "“〜を禁じえない” expresses “feeling one's emotion (〜) so strongly that one cannot hold it back.”" },
          forms: ["[N] + を禁じえない"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜にたる」は「〜する条件や価値を十分{満|み}たしている」と言いたいときに使われる。", en: "“〜にたる” is used when you want to say that something “fully meets the conditions for, or has the value to deserve, 〜.”" },
          forms: ["［[V-る]　[N₁]］ + にたる + [N₂]"],
          examples: [
        ...
        },
        {
          ...
          stars: 1,
          marks: ["formal"],
          usage: { ja: "「〜べくもない」は「状況から考えて〜できない／〜はずがない」という気持ちを表す。", en: "“〜べくもない” expresses the feeling that “judging from the situation, 〜 is impossible / 〜 cannot be.”" },
          forms: ["[V-る] + べくもない"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜なくして（は）…ない」は「何かをするなら、〜が絶対に必要だ」と言いたいときに使われる。", en: "“〜なくして（は）…ない” is used when you want to say “if you are going to do something, 〜 is absolutely necessary.”" },
          ...
          plus: [
            {
              ...
              stars: 1,
              marks: [],
              usage: { ja: "「[V-る] ＋ ことなく／ことなしに」も同じ意味で使われる。", en: "“V-る + ことなく／ことなしに” is also used with the same meaning." },
              examples: [
          ...
          practice: [
            {
              ...
              left: ["{著作権者|ちょさくけんしゃ}の許可なくして", "家族の{同意|どうい}なくして", "リスクを{負|お}うことなくして", "社長の{承認|しょうにん}なくして"],
              right: ["手術は行えないことになっている。", "プロジェクトを進めることはできない。", "作品を勝手に変えることは法律で禁止されている。", "大きい利益は望めない。"],
              answer: [2, 0, 3, 1],
              en: ["Altering a work at will without the copyright holder's permission is prohibited by law.", "The rule is that surgery cannot be performed without the family's consent.", "Without taking risks, you cannot hope for big profits.", "The project cannot go ahead without the president's approval."],
            },
          ],
        },
      ],
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            why: { en: "N さえ〜なければ = *if only N weren't there*: さえ with a negative condition singles out the one thing that spoiled everything. こそ, のみ and なり don't fit this conditional frame." },
          },
          {
            q: "デザインの分野では{独創性|どくそうせい}を重んじる（　）、伝統を{古臭|ふるくさ}いと否定する傾向がある。",
            options: ["とはいえ", "がゆえに", "どころか", "おかげで"],
            answer: 1,
            ...
            why: { en: "がゆえに (#113) gives the reason: *precisely because* originality is valued, tradition is dismissed. とはいえ and どころか are contrastive, and おかげで implies a welcome result." },
          },
          {
            q: "二日{酔|よ}いで{欠勤|けっきん}するなんて、教師（　）ことだね。",
            options: ["ならではの", "なりの", "にあるまじき", "にかたくない"],
            answer: 2,
            en: "Missing work because of a hangover is behavior unworthy of a teacher.",
            why: { en: "N₁にあるまじきN₂ (#116): conduct unacceptable for someone in that role (a teacher). ならではの is praise, なりの means *in one's own way*, and にかたくない needs a verb of guessing (想像など)." },
          },
          {
            q: "皆様の温かい{支援|しえん}なくしては、この映画は（　）ことでしょう。",
            options: ["完成しなかった", "感動を与えた", "高く評価される", "{拍手|はくしゅ}が鳴りやまない"],
            answer: 0,
            en: "Without everyone's warm support, this film would probably never have been completed.",
            why: { en: "〜なくしては (#123) must be followed by a negative or impossible outcome: without the support, the film would not have been completed. The other options are all positive." },
          },
          {
            q: "バランスのとれた食事が健康の基本であることは、改めて説明する（　）だろう。",
            options: ["べからざる", "にすぎない", "までもない", "わけがない"],
            answer: 2,
            en: "It hardly needs explaining again that a balanced diet is the foundation of good health.",
            why: { en: "V-るまでもない (#41): *there's no need to ~* because it is obvious. べからざる would need a following noun, and にすぎない / わけがない don't fit the sense." },
          },
          {
            q: "校長の{退屈|たいくつ}{極|きわ}まりないスピーチは30分も続き、（　）。",
            options: ["笑い疲れてしまった", "眠くて仕方がなかった", "夢中になって聞いていた", "感動{極|きわ}まった"],
            answer: 1,
          ...
          },
          {
            ...
            options: ["とはいうものの", "が{相|あい}まって", "にしたところで", "にかたくなく"],
            answer: 1,
            en: "The beauty of the materials combined with the craftsman's skill to produce a splendid piece of craftwork.",
            why: { en: "AにBが相まって (#114): two elements (the beauty of the materials and the craftsman's skill) combine to produce a splendid result." },
          },
        ],
      },
    },
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            why: { en: "受けた modifies 彼, and 彼の感激は is the topic of 想像にかたくない (#115)." },
          },
          {
            ...
            why: { en: "すべての顧客を満足させる + にたる (#121) + サービス: *a service worthy of / sufficient to satisfy every customer*; は marks the contrasted topic before できなかった." },
          },
        ],
      },
    },
        ...
        items: [
          {
            ...
            en: ["A writer is answering questions in a radio interview.", "To get straight to it, I'd like to ask you a number of things about your latest book, “Worry the Right Way”...", "Sure.", "First of all, this title, “Worry the Right Way”...", "In a word, it means “Thou shalt not leave it to others and rest easy.”", "Leave it to others...?", "In the information society, there's quite a lot of information that has been conveniently manipulated. So actually getting hold of correct information is difficult.", "I see...", "Those who receive information have a responsibility too. To rest easy simply on the strength of the information you are given is extremely dangerous.", "That's certainly true.", "We should manipulate it to put people at ease.", "We should send it out responsibly.", "We shouldn't believe it too easily.", "We shouldn't just worry blindly."],
