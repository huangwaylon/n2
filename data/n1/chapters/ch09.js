// Generated by tools/merge.js from data/n1/frag/ch09-*.js — edit the fragments, not this file.
N2.register({
  "id": 9,
  "genre": {
    "ja": "講演を聞く",
    "en": "Listening to a Lecture"
  },
  "title": {
    "ja": "トリアージ",
    "en": "Triage"
  ...
  "canDo": [
    {
      "ja": "やや専門的な説明を聞いて、その内容や{発話者|はつわしゃ}の意見が理解できる。",
      "zh": "听一段有点儿专业的解释，理解其内容及发言人的观点。",
      "en": "Listen to a somewhat specialized explanation and understand its content and the speaker's opinion."
    }
  ],
  "parts": [
    {
        ...
        "lines": [
          {
            "sp": "司会者",
            "v": "f",
            "ja": "{本日|ほんじつ}は「トリアージ」について、{救命救急|きゅうめいきゅうきゅう}がご専門の医師の{森|もり}先生にお話を{伺|うかが}います。{森|もり}先生、よろしくお願いします。",
      ...
      "points": [
          ...
          "notes": [
            {
              ...
              "examples": [
                ...
                },
                {
                  ...
                  "en": "Partly because so few of these stamps were issued, I hear they now fetch as much as 500,000 yen apiece."
                }
              ]
            }
          ],
        ...
        },
        {
          ...
          "examples": [
            {
              "ja": "家庭での教育は子どもの発達や人間{形成|けいせい}にかかわる大きな問題だ。",
              "en": "Education at home is a major issue that affects children's development and the formation of their character."
            },
            {
              "ja": "政府は、国民の安全にかかわる情報はすぐに公表すべきだ。",
              "en": "The government should immediately make public any information that concerns the safety of the people."
            },
            {
              "ja": "{少子高齢|しょうしこうれい}社会にどう対応するかは、国の将来にかかわる問題だ。",
              "en": "How to deal with a society with a falling birthrate and an aging population is a question that bears on the nation's future."
            },
            {
              "ja": "日本に留学して、将来貿易にかかわる仕事に{就|つ}きたいと思っています。",
          ...
          "practice": [
            {
              ...
              "items": [
                {
                  "q": "小さな{医療|いりょう}ミスでも、{患者|かんじゃ}の＿＿にかかわる{事態|じたい}を引き起こす場合もある。",
                  "answer": "命",
                  "en": "Even a small medical error can sometimes cause a situation that endangers a patient's life."
                },
                {
                  "q": "警察は、ついに事件の＿＿にかかわる人物を{特定|とくてい}した。",
                  "answer": "{真相|しんそう}",
                  "en": "The police have finally identified a person connected with the truth behind the case."
                },
                {
                  "q": "データは{厳重|げんじゅう}に管理すべきだ。もし{流出|りゅうしゅつ}すれば、{企業|きぎょう}の＿＿にかかわる{大|だい}問題になる。",
                  "answer": "{存続|そんぞく}",
                  "en": "Data should be managed strictly. If it leaked, it would become a major problem threatening the company's survival."
                },
                {
                  "q": "今後{高齢者|こうれいしゃ}が増え、＿＿にかかわる仕事の{需要|じゅよう}がますます高まっていくだろう。",
                  "answer": "{福祉|ふくし}",
                  "en": "As the number of elderly people grows, demand for work related to welfare will probably keep rising."
                }
              ]
            }
          ]
        },
        {
          ...
          "examples": [
            {
              "ja": "{火災|かさい}などの{非常時|ひじょうじ}にあっては、落ち着いて行動することがまず大事だ。",
              "en": "In an emergency such as a fire, the first important thing is to act calmly."
            },
            {
              "ja": "当時は高度経済成長期にあって、政府は高速道路の整備に力を入れていた。",
              "en": "At the time, in the midst of the period of rapid economic growth, the government was putting great effort into building expressways."
            },
            {
              "ja": "{不況下|ふきょうか}にあっても順調に{業績|ぎょうせき}を伸ばしている{企業|きぎょう}がある。",
              "en": "There are companies that are steadily improving their results even in a recession."
            }
          ],
        ...
        },
        {
          ...
          "examples": [
            ...
            },
            {
              ...
              "en": "If the explanation is insufficient, then depending on how people take it, it could cause misunderstandings."
            },
            {
        ...
        "items": [
          {
            ...
            "options": [
              "{平常時|へいじょうじ}に{発揮|はっき}される{特殊|とくしゅ}な力",
              "{非常時|ひじょうじ}に{発揮|はっき}される{特殊|とくしゅ}な力",
              "{平常時|へいじょうじ}に出すと非難される{特殊|とくしゅ}な力",
          ...
          },
          {
            "q": "筆者が最も言いたいことは何か。",
            "options": [
              "経営者は労働者に常に{平常時|へいじょうじ}の「全力」以上の力を求めるべきではない。",
              "経営者は労働者に常に{平常時|へいじょうじ}の「全力」以上の力を出させるべきだ。",
              "経営者は労働者に短期的な生産性を上げさせるべきだ。",
              "経営者は労働者に{非常時|ひじょうじ}の生産性を上げさせるべきだ。"
            ],
            "answer": 0,
        ...
        "items": [
          {
            ...
            "script": [
              {
                "sp": "",
                "ja": "テレビで、ある科学者がエネルギー問題について話しています。"
              },
              {
                "sp": "M1",
                "v": "m",
                "ja": "エネルギーの{確保|かくほ}は、{我々|われわれ}の将来にかかわる重要な{課題|かだい}です。石油に代わるエネルギーが求められる時代にあって、新しいエネルギーの開発が急がれております。\n日本でも、ヨーロッパにならって、{太陽光|たいようこう}発電や{風力|ふうりょく}発電などが{導入|どうにゅう}されていますが、気候も{地形|ちけい}も異なる日本では限界があります。\n日本に合ったエネルギーということで、今私が最も注目しているのはメタンハイドレートです。これは「燃える氷」と呼ばれていて、その量は日本で使われる天然ガスの約96年分からあるんです。これを利用しない手はないでしょう。"
              },
              {
                "sp": "F",
                "v": "f",
                "ja": "「燃える氷」かあ……。いいよね。{上手|うま}くいけば、石油なんていらないんじゃない？"
              },
              {
                "sp": "M2",
                "v": "m",
                "ja": "うーん。でも、それって{上手|うま}くいけばの話だよね？　実際はどうなんだろう？"
              },
              {
                "sp": "F",
                "v": "f",
              ...
              },
              {
                "sp": "M2",
                "v": "m",
                "ja": "まあ、そうかもしれないけど、こういう問題は、なかなか難しいよね。"
              }
            ],
            "en": [
          ...
          },
          {
            ...
            "options": [
              "{女|おんな}の{人|ひと}も{男|おとこ}の{人|ひと}も{賛成|さんせい}している。",
              "{女|おんな}の{人|ひと}は{賛成|さんせい}だが、{男|おとこ}の{人|ひと}は{賛成|さんせい}しかねている。",
              "{女|おんな}の{人|ひと}は{賛成|さんせい}しかねているが、{男|おとこ}の{人|ひと}は{賛成|さんせい}だ。",
              "{女|おんな}の{人|ひと}も{男|おとこ}の{人|ひと}も{賛成|さんせい}しかねている。"
            ],
            "answer": 1,
            "why": {
