  ...
  parts: [
    {
      ...
      points: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["{無謀|むぼう}な{行為|こうい}としか思えない", "禁止されている"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["やっぱりこれが一番いいよね", "あんまり買う気になれないな"],
                  answer: 1,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜のをいいことに」は「〜の状況を都合よく利用して、良くないことをする」と批判的な気持ちで言いたいときに使われる。", en: "\"〜のをいいことに\" is used when you want to say critically that someone \"conveniently takes advantage of the situation 〜 to do something bad\"." },
          forms: ["[Pl] + の + をいいことに\n［[なA~~だ~~]な　[N~~だ~~]な］"],
          formNotes: [
          ...
          practice: [
            {
              ...
              left: ["{小川|おがわ}さんったら店員が見ていないのをいいことに、", "社長の{甥|おい}であるのをいいことに、", "{誰|だれ}にも疑われていないのをいいことに、", "親が{叱|しか}らないのをいいことに、"],
              right: ["上司に{反抗|はんこう}したり仕事をさぼったりと、彼は好き勝手なことばかりしている。", "彼は会社の金を使い続けた。", "子どもは電車の中を走り回っている。", "{試食|ししょく}のチョコレートを3つも食べたんだよ。"],
              answer: [3, 0, 1, 2],
              en: ["Honestly, Ogawa took advantage of the shop assistant not looking and ate three of the chocolate samples!", "Taking advantage of being the president's nephew, he does whatever he likes, defying his boss and skipping work.", "Taking advantage of the fact that no one suspected him, he kept on using the company's money.", "Taking advantage of their parents not scolding them, the children are running around the train."],
            },
          ],
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜か」は「こんな少しで足りるか！　もっとくれ」のように、質問の形だが、「違う！　絶対に〜ない（足りない）」と強く否定する気持ちを表す。", en: "As in \"こんな少しで足りるか！　もっとくれ\" (How is this little bit going to be enough? Give me more!), \"〜か\" has the form of a question, but expresses a strong denial: \"No! It's absolutely not 〜 (enough).\"" },
          forms: ["[文] + か"],
          examples: [
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜にもほどがある」は「あまりにも〜すぎる」と、良くない状況を強調して言いたいときに使う。", en: "Use \"〜にもほどがある\" when you want to emphasize a bad situation, saying it is \"far too 〜\"." },
          forms: ["[Pl] + にもほどがある\n［現在形のみ］［[なA~~だ~~]　[N~~だ~~]］"],
          examples: [
          ...
          practice: [
            {
              ...
              labels: "abc",
              prompt: { ja: "", en: "Match each beginning (1–4) with the correct ending (a–d)." },
              left: ["入社式に親がついて行くとは、", "借りた金を返さずに、また借りに来るとは、", "買いすぎて食べる前に{腐|くさ}らせちゃうなんて、", "泥棒に{同情|どうじょう}してお金をあげるなんて、"],
              right: ["{図々|ずうずう}しいにもほどがある。", "もったいないにもほどがあるよ。", "人がいいにもほどがある。", "{過保護|かほご}にもほどがある。"],
              answer: [3, 0, 1, 2],
              en: ["Parents going along to their child's company entrance ceremony — that's overprotective beyond belief.", "Coming back to borrow more without repaying what he borrowed — the nerve of it!", "Buying too much and letting it go bad before you eat it — what a terrible waste!", "Feeling sorry for a thief and giving him money — that's being far too good-natured."],
            },
          ],
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「AならまだしもB」は「Aなら何とか受け入れてもいいと思うが、Bは受け入れられない／変だ」と言いたいときに使われる。", en: "\"AならまだしもB\" is used when you want to say \"A could somehow be accepted, but B cannot be accepted / is strange\"." },
          forms: ["[Pl] + ならまだしも\n［[なA~~だ~~]　[N~~だ~~]］"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜以前」は「〜よりもっと前の基本的な段階だ」と言って、状況を批判するときに使われる。", en: "\"〜以前\" is used to criticize a situation by saying \"this is a basic stage that comes well before 〜\"." },
          forms: ["[N] + 以前"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["formal"],
          usage: { ja: "「〜べくして」は「状況からわかるように、当然の結果として〜になった」と言いたいときに使う。", en: "Use \"〜べくして\" when you want to say \"as the situation shows, 〜 happened as a natural result\"." },
          forms: ["[V₁-る] + べくして + [V₂-た]"],
          formNotes: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["{無名|むめい}のマンガで{声優|せいゆう}も{新人|しんじん}", "{大人気|だいにんき}のマンガで{声優|せいゆう}も一流"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["たまたま運が良かった", "それだけの{実績|じっせき}をあげている"],
                  answer: 1,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「AがAだけに」は「他の場合と違って、特別なAだから」と言いたいときに使う。", en: "Use \"AがAだけに\" when you want to say \"because it is a special A, unlike other cases\"." },
          forms: ["[N₁] + が + [N₂]（な） + だけに"],
          formNotes: [
      ...
      points: [
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「AといわずBといわず」は「AでもBでも何でもすべて」という意味を表す。", en: "\"AといわずBといわず\" means \"A, B, anything — all of it\"." },
          forms: ["[N₁] + といわず + [N₂] + といわず"],
          examples: [
          ...
          practice: [
            {
              ...
              labels: "abc",
              prompt: { ja: "", en: "Match each beginning (1–4) with the correct ending (a–d)." },
              left: ["料理をしてと頼めば手を切るし、", "深いプールでの事故は想像しやすいが、", "学生時代は{学費|がくひ}だ{合宿|がっしゅく}だとお金がかかり、", "{終電|しゅうでん}に乗れなかったら乗れなかったで、"],
              right: ["{就職|しゅうしょく}したらしたで給料だけで生活できず、親に頼ってしまい{申|もう}し{訳|わけ}ない。", "引っ{越|こ}しを手伝ってもらったらもらったで腰が痛いなんて言われるし、もうあの人に頼むのはよそう。", "友達のうちに泊まるから{大丈夫|だいじょうぶ}だよ。", "浅かったら浅かったで飛び込みなどによる事故の心配がある。"],
              answer: [1, 3, 0, 2],
              en: ["If I ask him to cook, he cuts his hand, and when he does help me move house, he tells me his back hurts — I'm not going to ask that man for anything anymore.", "Accidents in a deep pool are easy to imagine, but if it's shallow, there's the danger of accidents from diving and so on.", "As a student, money went on tuition, training camps and so on, and now that I've got a job, I still can't live on my salary alone; I feel bad relying on my parents.", "If I miss the last train, so be it — I'll stay at a friend's place, so it's fine."],
            },
          ],
          plus: [
            {
        ...
        },
        {
          ...
          stars: 1,
          marks: ["regret"],
          usage: { ja: "「〜にたえない」は「状況がひどすぎて、見たり聞いたりするのがつらい／{我慢|がまん}できない」という意味を表す。", en: "\"〜にたえない\" means \"the situation is so terrible that it is painful / unbearable to look at or listen to\"." },
          forms: ["［[V-る]　[N]］ + にたえない"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["regret"],
          usage: { ja: "「〜（よ）うものなら」は「もし〜したらよくない結果になる」と言いたいときに使われる。「大変なことになる／大きな{影響|えいきょう}がある」と言うときに使われることが多い。", en: "\"〜（よ）うものなら\" is used when you want to say \"if 〜 happens, it will lead to a bad result\". It is often used to say that \"something terrible will happen / there will be a big effect\"." },
          forms: ["[V-よう] + ものなら"],
          formNotes: [
          ...
          practice: [
            {
              ...
              labels: "abc",
              prompt: { ja: "", en: "Match each beginning (1–4) with the correct ending (a–d)." },
              left: ["この町は道を1本間違えようものなら、", "あそこの店、ちょっと立ち止まって見ていようものなら、", "こんな日に舟で海に出ようものなら、", "卒業論文の{提出|ていしゅつ}が1秒でも遅れようものなら、"],
              right: ["店員が寄ってきて、あれこれ言うから、うるさいんだ。", "あっという間に{転覆|てんぷく}してしまうぞ。", "{留年|りゅうねん}を{余儀|よぎ}なくされるんだから、みんな必死だよ。", "全然知らない場所に出てしまう。"],
              answer: [3, 0, 1, 2],
              en: ["In this town, if you take even one wrong turn, you end up somewhere you don't know at all.", "At that shop, if you so much as stop and look for a moment, a clerk comes over and goes on about this and that — it's so annoying.", "If you go out to sea in a boat on a day like this, you'll capsize in no time!", "If you're even one second late handing in your graduation thesis, you're forced to repeat the year, so everyone is desperate."],
            },
          ],
        },
        {
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「〜ないものか」は「何とか〜したい／〜をしてほしい」という気持ちや、「難しいとわかっていることだが、それでも実現させたい／実現してほしい」と願う気持ちを表す。", en: "\"〜ないものか\" expresses the feeling \"I want to 〜 somehow / I want someone to do 〜\", or the wish \"I know it is difficult, but even so I want to make it happen / want it to happen\"." },
          forms: ["[V-~~ない~~] + ないものか"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「〜に{越|こ}したことはない」は「できれば〜のほうがいい」と、一般的にいいと思われることを言うときに使う。", en: "Use \"〜に{越|こ}したことはない\" when you say something that is generally thought to be good: \"if possible, 〜 is better\"." },
              ...
              items: [
                {
                  ...
                  options: ["メモを見てはいけないことになっている", "メモぐらいは持っていてもいいだろう"],
                  answer: 1,
                ...
                },
                {
                  ...
                  options: ["うちには3日分の{非常食|ひじょうしょく}が置いてあります", "とても不安で、夜も寝られません"],
                  answer: 0,
                ...
                },
                {
                  ...
                  options: ["★の数にかかわらず、全部やってみようと思っています", "時間がなければ、★が多いものから勉強したほうがいいですよ"],
                  answer: 1,
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              options: ["MP3と言えば言ったで", "MP3といわずフィギュアといわず"],
              answer: 1,
      ...
      points: [
        {
          ...
          stars: 3,
          marks: [],
          usage: { ja: "「AとはいえB」は「春とはいえ、今日はまだ寒い」のように「確かにA（今は春）だが、それから予想や期待されること（暖かい）とは違うBだ（まだ寒い）」と言いたいときに使われる。", en: "\"AとはいえB\" is used when you want to say \"it's certainly A (it is spring now), but B differs from what you would predict or expect from that (warmth) (it's still cold)\", as in \"春とはいえ、今日はまだ寒い\" (It may be spring, but it's still cold today)." },
          forms: ["[Pl] + とはいえ\n［[なA]（だ）　[N]（だ）］"],
          formNotes: [
          ...
          practice: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  options: ["{従|したが}えないこともある", "{従|したが}えないでもない"],
                  answer: 0,
                ...
                {
                  q: "生産ラインの機械化が進んだとはいえ、（　）。",
                  options: ["まだ全てを機械に{任|まか}せることはできない", "{人件費|じんけんひ}が{大幅|おおはば}に{削減|さくげん}できた"],
                  answer: 0,
        ...
        },
        {
          ...
          stars: 2,
          marks: [],
          usage: { ja: "「〜といったところだ」は「程度や{数量|すうりょう}がだいたいそのくらいだ」と言いたいときに使われる。十分ではないという気持ちを表すことが多い。「せいぜい・やっと・なんとか」などの言葉と一緒に使われることが多い。", en: "\"〜といったところだ\" is used when you want to say \"the degree or amount is roughly about that much\". It often expresses the feeling that this is not enough. It is often used together with words such as せいぜい (at most), やっと (barely) and なんとか (somehow)." },
        ...
        },
        {
          ...
          stars: 1,
          marks: [],
          usage: { ja: "「AにAない」は「理由や事情があって、AしたくてもAできない」という強い気持ちを表す。", en: "\"AにAない\" expresses the strong feeling that \"for some reason or circumstance, even though I want to do A, I can't do A\"." },
          forms: ["[V-る] + に + [V-できない]"],
          formNotes: [
        ...
        },
        {
          ...
          stars: 2,
          marks: ["regret"],
          usage: { ja: "「AにかこつけてB」は「AをBするための{口実|こうじつ}にする」と言いたいときに使われる。他の人を批判するときに使われることが多い。", en: "\"AにかこつけてB\" is used when you want to say \"use A as a pretext for doing B\". It is often used when criticizing other people." },
          forms: ["[N] + にかこつけて"],
          examples: [
  ...
  review: [
      ...
      ex: {
        ...
        items: [
          ...
          },
          {
            ...
            options: ["見るにもほどがあった", "見るに{越|こ}したことはなかった", "見てはいられなかった", "見たが最後だった"],
            answer: 2,
    ...
    },
    {
      ...
      ex: {
        ...
        en: ["Oh man, I've finally set off. The island is getting smaller and smaller. Sigh... I know it's my job, but am I really going all that way just to fetch sand and soil and stuff? And going with a companion would be one thing, but all on my own...", "Well, I can't just sit here grumbling. The distance being what it is, it can't be just anyone. So, going by ability, it was only natural that I, the most capable of all, was chosen.", "Right, time to check my course and my engines. Both normal.", "My senior, Hayabusa, was so cool too. At the end he became a shooting star. I'm going to make this asteroid mission a success too — just you watch."],
        blanks: [
          {
          ...
          {
            options: ["1人", "仲間と一緒", "砂や土", "{金|きん}やダイヤモンド"],
            answer: 1,
          ...
          {
            options: ["というわけだ", "というわけにはいかない", "に決まっている", "に{越|こ}したことはない"],
            answer: 1,
    ...
    },
    {
      ...
      ex: {
        ...
        title: "",
        text: ["特に、大きい{組織|そしき}においては、「{事|こと}なかれ主義」が広がるおそれがある。事なかれ主義とは、トラブルがないことを第一に考える消極的な{態度|たいど}である。", "新しいことをやって、失敗でもしようものなら、自分や周囲の人が責任を{負|お}わなければならない。それで、リスクを{避|さ}けたい、責任を{逃|のが}れたいといった気持ちが働く。すると、例えば、{前例|ぜんれい}のないことや指示がないことはしないということが起きる。", "{前例|ぜんれい}がないからと言って、__部下のアイデアを全然認めないという上司__がいれば、トラブルも起きないが、成長も望めない。トラブルはないに{越|こ}したことはないが、それ以前に、リスクを取らないこと{自体|じたい}が{組織|そしき}にとってのリスクなのである。"],
        en: ["Particularly in large organizations, there is a danger that a “don't rock the boat” mentality will spread. This mentality is a passive attitude that puts the absence of trouble above everything else.", "If you try something new and then, heaven forbid, fail, you and the people around you have to take responsibility. So feelings like wanting to avoid risk and wanting to escape responsibility come into play. As a result, for example, people stop doing anything that has no precedent or that they haven't been instructed to do.", "If there is a boss who refuses to accept any of his subordinates' ideas because there is no precedent for them, there will be no trouble, but no growth can be expected either. Of course it is best to have no trouble, but more fundamentally, not taking risks is in itself a risk for an organization."],
        items: [
          {
    ...
    },
    {
      ...
      ex: {
        ...
        items: [
          {
            script: [
              { sp: "M", v: "m", ja: "その{企画書|きかくしょ}、早く完成させるに{越|こ}したことはないけど、もう10時だよ。" },
            ],
          ...
          {
            script: [
              { sp: "F", v: "f", ja: "忙しさにかこつけて、家事の{分担|ぶんたん}、さぼらないでよ。" },
            ],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "あ〜、下手だなあ。見ちゃいられない。それ、ちょっと貸して。" },
            ],
          ...
          {
            script: [
              { sp: "M", v: "m", ja: "ここの{桜|さくら}、{満開|まんかい}まであと1週間といったところかな。" },
            ],
