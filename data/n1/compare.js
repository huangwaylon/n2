  ...
  },
  {
    ...
    items: [
      ...
      { pattern: "〜からあるN", level: "N1", no: 107,
        ex: { ja: "小さな子どもが、10kgからある旅行かばんを{一生懸命|いっしょうけんめい}運ぼうとしている。", en: "A small child is trying with all his might to carry a suitcase that weighs as much as 10 kg." },
      ...
      { pattern: "〜からするN", level: "N1", no: 107,
        ex: { ja: "2,000万円からする宝石が{何者|なにもの}かに盗まれて、{大騒|おおさわ}ぎになっている。", en: "A jewel worth as much as 20 million yen has been stolen, and it's causing a huge commotion." },
  ...
  },
  {
    ...
    items: [
      ...
      { pattern: "Vないものでもない", level: "N1", no: 19,
        ex: { ja: "君がそんなに頼むんだったら、今回だけ特別に認めないものでもないんだけどね。", en: "If you're asking me that earnestly, I suppose I might make a special exception and allow it, just this once." },
